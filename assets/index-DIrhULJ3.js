...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Nn,depthTest:!1,depthWrite:!1})}function hc(){return new kn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:po(),fragmentShader:`
		...
		`,blending:Nn,depthTest:!1,depthWrite:!1})}function uc(){return new kn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:po(),fragmentShader:`
...
#define LOW_PRECISION`),t}function Cm(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===sl?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===rl?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===xn&&(t="SHADOWMAP_TYPE_VSM"),t}function Pm(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Fi:case zi:t="ENVMAP_TYPE_CUBE";break;case or:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Lm(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case zi:t="ENVMAP_MODE_REFRACTION";break}return t}function Dm(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case al:t="ENVMAP_BLENDING_MULTIPLY";break;case Ih:t="ENVMAP_BLENDING_MIX";break;case Uh:t="ENVMAP_BLENDING_ADD";break}return t}function Im(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function Um(i,t,e,n){const s=i.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const c=Cm(e),l=Pm(e),h=Lm(e),u=Dm(e),f=Im(e),p=ym(e),_=Sm(r),v=s.createProgram();let m,d,T=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+d);const S=T+m+a,E=T+d+o,P=xc(s,s.VERTEX_SHADER,S),b=xc(s,s.FRAGMENT_SHADER,E);s.attachShader(v,P),s.attachShader(v,b),e.index0AttributeName!==void 0?s.bindAttribLocation(v,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function w(y){if(i.debug.checkShaderErrors){const O=s.getProgramInfoLog(v).trim(),F=s.getShaderInfoLog(P).trim(),k=s.getShaderInfoLog(b).trim();let Z=!0,H=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(Z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,P,b);else{const J=Mc(s,P,"vertex"),V=Mc(s,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
}`;class cg{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,n){if(this.texture===null){const s=new Re,r=t.properties.get(s);r.__webglTexture=e.texture,(e.depthNear!=n.depthNear||e.depthFar!=n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new kn({vertexShader:ag,fragmentShader:og,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new Ot(new In(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class lg extends Gi{constructor(t,e){super();const n=this;let s=null,r=1,a=null,o="local-floor",c=1,l=null,h=null,u=null,f=null,p=null,_=null;const v=new cg,m=e.getContextAttributes();let d=null,T=null;const S=[],E=[],P=new at;let b=null;const w=new Fe;w.layers.enable(1),w.viewport=new te;const U=new Fe;U.layers.enable(2),U.viewport=new te;const Y=[w,U],g=new sg;g.layers.enable(1),g.layers.enable(2);let y=null,O=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(N){let X=S[N];return X===void 0&&(X=new Kr,S[N]=X),X.getTargetRaySpace()},this.getControllerGrip=function(N){let X=S[N];return X===void 0&&(X=new Kr,S[N]=X),X.getGripSpace()},this.getHand=function(N){let X=S[N];return X===void 0&&(X=new Kr,S[N]=X),X.getHandSpace()};function F(N){const X=E.indexOf(N.inputSource);if(X===-1)return;const et=S[X];et!==void 0&&(et.update(N.inputSource,N.frame,l||a),et.dispatchEvent({type:N.type,data:N.inputSource}))}function k(){s.removeEventListener("select",F),s.removeEventListener("selectstart",F),s.removeEventListener("selectend",F),s.removeEventListener("squeeze",F),s.removeEventListener("squeezestart",F),s.removeEventListener("squeezeend",F),s.removeEventListener("end",k),s.removeEventListener("inputsourceschange",Z);for(let N=0;N<S.length;N++){const X=E[N];X!==null&&(E[N]=null,S[N].disconnect(X))}y=null,O=null,v.reset(),t.setRenderTarget(d),p=null,f=null,u=null,s=null,T=null,Xt.stop(),n.isPresenting=!1,t.setPixelRatio(b),t.setSize(P.width,P.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(N){r=N,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(N){o=N,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(N){l=N},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return u},this.getFrame=function(){return _},this.getSession=function(){return s},this.setSession=async function(N){if(s=N,s!==null){if(d=t.getRenderTarget(),s.addEventListener("select",F),s.addEventListener("selectstart",F),s.addEventListener("selectend",F),s.addEventListener("squeeze",F),s.addEventListener("squeezestart",F),s.addEventListener("squeezeend",F),s.addEventListener("end",k),s.addEventListener("inputsourceschange",Z),m.xrCompatible!==!0&&await e.makeXRCompatible(),b=t.getPixelRatio(),t.getSize(P),s.renderState.layers===void 0){const X={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:r};p=new XRWebGLLayer(s,e,X),s.updateRenderState({baseLayer:p}),t.setPixelRatio(1),t.setSize(p.framebufferWidth,p.framebufferHeight,!1),T=new ai(p.framebufferWidth,p.framebufferHeight,{format:tn,type:En,colorSpace:t.outputColorSpace,stencilBuffer:m.stencil})}else{let X=null,et=null,Q=null;m.depth&&(Q=m.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,X=m.stencil?ki:Ii,et=m.stencil?Bi:ri);const _t={colorFormat:e.RGBA8,depthFormat:Q,scaleFactor:r};u=new XRWebGLBinding(s,e),f=u.createProjectionLayer(_t),s.updateRenderState({layers:[f]}),t.setPixelRatio(1),t.setSize(f.textureWidth,f.textureHeight,!1),T=new ai(f.textureWidth,f.textureHeight,{format:tn,type:En,depthTexture:new Il(f.textureWidth,f.textureHeight,et,void 0,void 0,void 0,void 0,void 0,void 0,X),stencilBuffer:m.stencil,colorSpace:t.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1})}T.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await s.requestReferenceSpace(o),Xt.setContext(s),Xt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return v.getDepthTexture()};function Z(N){for(let X=0;X<N.removed.length;X++){const et=N.removed[X],Q=E.indexOf(et);Q>=0&&(E[Q]=null,S[Q].disconnect(et))}for(let X=0;X<N.added.length;X++){const et=N.added[X];let Q=E.indexOf(et);if(Q===-1){for(let Mt=0;Mt<S.length;Mt++)if(Mt>=E.length){E.push(et),Q=Mt;break}else if(E[Mt]===null){E[Mt]=et,Q=Mt;break}if(Q===-1)break}const _t=S[Q];_t&&_t.connect(et)}}const H=new R,J=new R;function V(N,X,et){H.setFromMatrixPosition(X.matrixWorld),J.setFromMatrixPosition(et.matrixWorld);const Q=H.distanceTo(J),_t=X.projectionMatrix.elements,Mt=et.projectionMatrix.elements,bt=_t[14]/(_t[10]-1),Yt=_t[14]/(_t[10]+1),zt=(_t[9]+1)/_t[5],C=(_t[9]-1)/_t[5],Ce=(_t[8]-1)/_t[0],It=(Mt[8]+1)/Mt[0],Bt=bt*Ce,At=bt*It,ie=Q/(-Ce+It),Lt=ie*-Ce;if(X.matrixWorld.decompose(N.position,N.quaternion,N.scale),N.translateX(Lt),N.translateZ(ie),N.matrixWorld.compose(N.position,N.quaternion,N.scale),N.matrixWorldInverse.copy(N.matrixWorld).invert(),_t[10]===-1)N.projectionMatrix.copy(X.projectionMatrix),N.projectionMatrixInverse.copy(X.projectionMatrixInverse);else{const A=bt+ie,x=Yt+ie,z=Bt-Lt,$=At+(Q-Lt),tt=zt*Yt/x*A,K=C*Yt/x*A;N.projectionMatrix.makePerspective(z,$,tt,K,A,x),N.projectionMatrixInverse.copy(N.projectionMatrix).invert()}}function lt(N,X){X===null?N.matrixWorld.copy(N.matrix):N.matrixWorld.multiplyMatrices(X.matrixWorld,N.matrix),N.matrixWorldInverse.copy(N.matrixWorld).invert()}this.updateCamera=function(N){if(s===null)return;let X=N.near,et=N.far;v.texture!==null&&(v.depthNear>0&&(X=v.depthNear),v.depthFar>0&&(et=v.depthFar)),g.near=U.near=w.near=X,g.far=U.far=w.far=et,(y!==g.near||O!==g.far)&&(s.updateRenderState({depthNear:g.near,depthFar:g.far}),y=g.near,O=g.far);const Q=N.parent,_t=g.cameras;lt(g,Q);for(let Mt=0;Mt<_t.length;Mt++)lt(_t[Mt],Q);_t.length===2?V(g,w,U):g.projectionMatrix.copy(w.projectionMatrix),ht(N,g,Q)};function ht(N,X,et){et===null?N.matrix.copy(X.matrixWorld):(N.matrix.copy(et.matrixWorld),N.matrix.invert(),N.matrix.multiply(X.matrixWorld)),N.matrix.decompose(N.position,N.quaternion,N.scale),N.updateMatrixWorld(!0),N.projectionMatrix.copy(X.projectionMatrix),N.projectionMatrixInverse.copy(X.projectionMatrixInverse),N.isPerspectiveCamera&&(N.fov=Za*2*Math.atan(1/N.projectionMatrix.elements[5]),N.zoom=1)}this.getCamera=function(){return g},this.getFoveation=function(){if(!(f===null&&p===null))return c},this.setFoveation=function(N){c=N,f!==null&&(f.fixedFoveation=N),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=N)},this.hasDepthSensing=function(){return v.texture!==null},this.getDepthSensingMesh=function(){return v.getMesh(g)};let gt=null;function Gt(N,X){if(h=X.getViewerPose(l||a),_=X,h!==null){const et=h.views;p!==null&&(t.setRenderTargetFramebuffer(T,p.framebuffer),t.setRenderTarget(T));let Q=!1;et.length!==g.cameras.length&&(g.cameras.length=0,Q=!0);for(let Mt=0;Mt<et.length;Mt++){const bt=et[Mt];let Yt=null;if(p!==null)Yt=p.getViewport(bt);else{const C=u.getViewSubImage(f,bt);Yt=C.viewport,Mt===0&&(t.setRenderTargetTextures(T,C.colorTexture,f.ignoreDepthValues?void 0:C.depthStencilTexture),t.setRenderTarget(T))}let zt=Y[Mt];zt===void 0&&(zt=new Fe,zt.layers.enable(Mt),zt.viewport=new te,Y[Mt]=zt),zt.matrix.fromArray(bt.transform.matrix),zt.matrix.decompose(zt.position,zt.quaternion,zt.scale),zt.projectionMatrix.fromArray(bt.projectionMatrix),zt.projectionMatrixInverse.copy(zt.projectionMatrix).invert(),zt.viewport.set(Yt.x,Yt.y,Yt.width,Yt.height),Mt===0&&(g.matrix.copy(zt.matrix),g.matrix.decompose(g.position,g.quaternion,g.scale)),Q===!0&&g.cameras.push(zt)}const _t=s.enabledFeatures;if(_t&&_t.includes("depth-sensing")){const Mt=u.getDepthInformation(et[0]);Mt&&Mt.isValid&&Mt.texture&&v.init(t,Mt,s.renderState)}}for(let et=0;et<S.length;et++){const Q=E[et],_t=S[et];Q!==null&&_t!==void 0&&_t.update(Q,X,l||a)}gt&&gt(N,X),X.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:X}),_=null}const Xt=new Ll;Xt.setAnimationLoop(Gt),this.setAnimationLoop=function(N){gt=N},this.dispose=function(){}}}const Zn=new un,hg=new ne;function ug(i,t){function e(m,d){m.matrixAutoUpdate===!0&&m.updateMatrix(),d.value.copy(m.matrix)}function n(m,d){d.color.getRGB(m.fogColor.value,Rl(i)),d.isFog?(m.fogNear.value=d.near,m.fogFar.value=d.far):d.isFogExp2&&(m.fogDensity.value=d.density)}function s(m,d,T,S,E){d.isMeshBasicMaterial||d.isMeshLambertMaterial?r(m,d):d.isMeshToonMaterial?(r(m,d),u(m,d)):d.isMeshPhongMaterial?(r(m,d),h(m,d)):d.isMeshStandardMaterial?(r(m,d),f(m,d),d.isMeshPhysicalMaterial&&p(m,d,E)):d.isMeshMatcapMaterial?(r(m,d),_(m,d)):d.isMeshDepthMaterial?r(m,d):d.isMeshDistanceMaterial?(r(m,d),v(m,d)):d.isMeshNormalMaterial?r(m,d):d.isLineBasicMaterial?(a(m,d),d.isLineDashedMaterial&&o(m,d)):d.isPointsMaterial?c(m,d,T,S):d.isSpriteMaterial?l(m,d):d.isShadowMaterial?(m.color.value.copy(d.color),m.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function r(m,d){m.opacity.value=d.opacity,d.color&&m.diffuse.value.copy(d.color),d.emissive&&m.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(m.map.value=d.map,e(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.bumpMap&&(m.bumpMap.value=d.bumpMap,e(d.bumpMap,m.bumpMapTransform),m.bumpScale.value=d.bumpScale,d.side===De&&(m.bumpScale.value*=-1)),d.normalMap&&(m.normalMap.value=d.normalMap,e(d.normalMap,m.normalMapTransform),m.normalScale.value.copy(d.normalScale),d.side===De&&m.normalScale.value.negate()),d.displacementMap&&(m.displacementMap.value=d.displacementMap,e(d.displacementMap,m.displacementMapTransform),m.displacementScale.value=d.displacementScale,m.displacementBias.value=d.displacementBias),d.emissiveMap&&(m.emissiveMap.value=d.emissiveMap,e(d.emissiveMap,m.emissiveMapTransform)),d.specularMap&&(m.specularMap.value=d.specularMap,e(d.specularMap,m.specularMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest);const T=t.get(d),S=T.envMap,E=T.envMapRotation;S&&(m.envMap.value=S,Zn.copy(E),Zn.x*=-1,Zn.y*=-1,Zn.z*=-1,S.isCubeTexture&&S.isRenderTargetTexture===!1&&(Zn.y*=-1,Zn.z*=-1),m.envMapRotation.value.setFromMatrix4(hg.makeRotationFromEuler(Zn)),m.flipEnvMap.value=S.isCubeTexture&&S.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=d.reflectivity,m.ior.value=d.ior,m.refractionRatio.value=d.refractionRatio),d.lightMap&&(m.lightMap.value=d.lightMap,m.lightMapIntensity.value=d.lightMapIntensity,e(d.lightMap,m.lightMapTransform)),d.aoMap&&(m.aoMap.value=d.aoMap,m.aoMapIntensity.value=d.aoMapIntensity,e(d.aoMap,m.aoMapTransform))}function a(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,d.map&&(m.map.value=d.map,e(d.map,m.mapTransform))}function o(m,d){m.dashSize.value=d.dashSize,m.totalSize.value=d.dashSize+d.gapSize,m.scale.value=d.scale}function c(m,d,T,S){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.size.value=d.size*T,m.scale.value=S*.5,d.map&&(m.map.value=d.map,e(d.map,m.uvTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function l(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.rotation.value=d.rotation,d.map&&(m.map.value=d.map,e(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function h(m,d){m.specular.value.copy(d.specular),m.shininess.value=Math.max(d.shininess,1e-4)}function u(m,d){d.gradientMap&&(m.gradientMap.value=d.gradientMap)}function f(m,d){m.metalness.value=d.metalness,d.metalnessMap&&(m.metalnessMap.value=d.metalnessMap,e(d.metalnessMap,m.metalnessMapTransform)),m.roughness.value=d.roughness,d.roughnessMap&&(m.roughnessMap.value=d.roughnessMap,e(d.roughnessMap,m.roughnessMapTransform)),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)}function p(m,d,T){m.ior.value=d.ior,d.sheen>0&&(m.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),m.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(m.sheenColorMap.value=d.sheenColorMap,e(d.sheenColorMap,m.sheenColorMapTransform)),d.sheenRoughnessMap&&(m.sheenRoughnessMap.value=d.sheenRoughnessMap,e(d.sheenRoughnessMap,m.sheenRoughnessMapTransform))),d.clearcoat>0&&(m.clearcoat.value=d.clearcoat,m.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(m.clearcoatMap.value=d.clearcoatMap,e(d.clearcoatMap,m.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,e(d.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(m.clearcoatNormalMap.value=d.clearcoatNormalMap,e(d.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===De&&m.clearcoatNormalScale.value.negate())),d.dispersion>0&&(m.dispersion.value=d.dispersion),d.iridescence>0&&(m.iridescence.value=d.iridescence,m.iridescenceIOR.value=d.iridescenceIOR,m.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(m.iridescenceMap.value=d.iridescenceMap,e(d.iridescenceMap,m.iridescenceMapTransform)),d.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=d.iridescenceThicknessMap,e(d.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),d.transmission>0&&(m.transmission.value=d.transmission,m.transmissionSamplerMap.value=T.texture,m.transmissionSamplerSize.value.set(T.width,T.height),d.transmissionMap&&(m.transmissionMap.value=d.transmissionMap,e(d.transmissionMap,m.transmissionMapTransform)),m.thickness.value=d.thickness,d.thicknessMap&&(m.thicknessMap.value=d.thicknessMap,e(d.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=d.attenuationDistance,m.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(m.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(m.anisotropyMap.value=d.anisotropyMap,e(d.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=d.specularIntensity,m.specularColor.value.copy(d.specularColor),d.specularColorMap&&(m.specularColorMap.value=d.specularColorMap,e(d.specularColorMap,m.specularColorMapTransform)),d.specularIntensityMap&&(m.specularIntensityMap.value=d.specularIntensityMap,e(d.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,d){d.matcap&&(m.matcap.value=d.matcap)}function v(m,d){const T=t.get(d).light;m.referencePosition.value.setFromMatrixPosition(T.matrixWorld),m.nearDistance.value=T.shadow.camera.near,m.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function fg(i,t,e,n){let s={},r={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(T,S){const E=S.program;n.uniformBlockBinding(T,E)}function l(T,S){let E=s[T.id];E===void 0&&(_(T),E=h(T),s[T.id]=E,T.addEventListener("dispose",m));const P=S.program;n.updateUBOMapping(T,P);const b=t.render.frame;r[T.id]!==b&&(f(T),r[T.id]=b)}function h(T){const S=u();T.__bindingPointIndex=S;const E=i.createBuffer(),P=T.__size,b=T.usage;return i.bindBuffer(i.UNIFORM_BUFFER,E),i.bufferData(i.UNIFORM_BUFFER,P,b),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,S,E),E}function u(){for(let T=0;T<o;T++)if(a.indexOf(T)===-1)return a.push(T),T;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(T){const S=s[T.id],E=T.uniforms,P=T.__cache;i.bindBuffer(i.UNIFORM_BUFFER,S);for(let b=0,w=E.length;b<w;b++){const U=Array.isArray(E[b])?E[b]:[E[b]];for(let Y=0,g=U.length;Y<g;Y++){const y=U[Y];if(p(y,b,Y,P)===!0){const O=y.__offset,F=Array.isArray(y.value)?y.value:[y.value];let k=0;for(let Z=0;Z<F.length;Z++){const H=F[Z],J=v(H);typeof H=="number"||typeof H=="boolean"?(y.__data[0]=H,i.bufferSubData(i.UNIFORM_BUFFER,O+k,y.__data)):H.isMatrix3?(y.__data[0]=H.elements[0],y.__data[1]=H.elements[1],y.__data[2]=H.elements[2],y.__data[3]=0,y.__data[4]=H.elements[3],y.__data[5]=H.elements[4],y.__data[6]=H.elements[5],y.__data[7]=0,y.__data[8]=H.elements[6],y.__data[9]=H.elements[7],y.__data[10]=H.elements[8],y.__data[11]=0):(H.toArray(y.__data,k),k+=J.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,O,y.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(T,S,E,P){const b=T.value,w=S+"_"+E;if(P[w]===void 0)return typeof b=="number"||typeof b=="boolean"?P[w]=b:P[w]=b.clone(),!0;{const U=P[w];if(typeof b=="number"||typeof b=="boolean"){if(U!==b)return P[w]=b,!0}else if(U.equals(b)===!1)return U.copy(b),!0}return!1}function _(T){const S=T.uniforms;let E=0;const P=16;for(let w=0,U=S.length;w<U;w++){const Y=Array.isArray(S[w])?S[w]:[S[w]];for(let g=0,y=Y.length;g<y;g++){const O=Y[g],F=Array.isArray(O.value)?O.value:[O.value];for(let k=0,Z=F.length;k<Z;k++){const H=F[k],J=v(H),V=E%P,lt=V%J.boundary,ht=V+lt;E+=lt,ht!==0&&P-ht<J.storage&&(E+=P-ht),O.__data=new Float32Array(J.storage/Float32Array.BYTES_PER_ELEMENT),O.__offset=E,E+=J.storage}}}const b=E%P;return b>0&&(E+=P-b),T.__size=E,T.__cache={},this}function v(T){const S={boundary:0,storage:0};return typeof T=="number"||typeof T=="boolean"?(S.boundary=4,S.storage=4):T.isVector2?(S.boundary=8,S.storage=8):T.isVector3||T.isColor?(S.boundary=16,S.storage=12):T.isVector4?(S.boundary=16,S.storage=16):T.isMatrix3?(S.boundary=48,S.storage=48):T.isMatrix4?(S.boundary=64,S.storage=64):T.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",T),S}function m(T){const S=T.target;S.removeEventListener("dispose",m);const E=a.indexOf(S.__bindingPointIndex);a.splice(E,1),i.deleteBuffer(s[S.id]),delete s[S.id],delete r[S.id]}function d(){for(const T in s)i.deleteBuffer(s[T]);a=[],s={},r={}}return{bind:c,update:l,dispose:d}}class dg{constructor(t={}){const{canvas:e=Qh(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1}=t;this.isWebGLRenderer=!0;let f;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");f=n.getContextAttributes().alpha}else f=a;const p=new Uint32Array(4),_=new Int32Array(4);let v=null,m=null;const d=[],T=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=He,this.toneMapping=On,this.toneMappingExposure=1;const S=this;let E=!1,P=0,b=0,w=null,U=-1,Y=null;const g=new te,y=new te;let O=null;const F=new Ft(0);let k=0,Z=e.width,H=e.height,J=1,V=null,lt=null;const ht=new te(0,0,Z,H),gt=new te(0,0,Z,H);let Gt=!1;const Xt=new fo;let N=!1,X=!1;const et=new ne,Q=new ne,_t=new R,Mt=new te,bt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Yt=!1;function zt(){return w===null?J:1}let C=n;function Ce(M,D){return e.getContext(M,D)}try{const M={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${no}`),e.addEventListener("webglcontextlost",j,!1),e.addEventListener("webglcontextrestored",ot,!1),e.addEventListener("webglcontextcreationerror",ft,!1),C===null){const D="webgl2";if(C=Ce(D,M),C===null)throw Ce(D)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(M){throw console.error("THREE.WebGLRenderer: "+M.message),M}let It,Bt,At,ie,Lt,A,x,z,$,tt,K,yt,rt,dt,Wt,nt,pt,Ct,Pt,mt,kt,Dt,ee,L;function ut(){It=new vp(C),It.init(),Dt=new ig(C,It),Bt=new fp(C,It,t,Dt),At=new tg(C),Bt.reverseDepthBuffer&&At.buffers.depth.setReversed(!0),ie=new yp(C),Lt=new Bm,A=new ng(C,It,At,Lt,Bt,Dt,ie),x=new pp(S),z=new _p(S),$=new wu(C),ee=new hp(C,$),tt=new xp(C,$,ie,ee),K=new Ep(C,tt,$,ie),Pt=new Sp(C,Bt,A),nt=new dp(Lt),yt=new zm(S,x,z,It,Bt,ee,nt),rt=new ug(S,Lt),dt=new Hm,Wt=new Ym(It),Ct=new lp(S,x,z,At,K,f,c),pt=new jm(S,K,Bt),L=new fg(C,ie,Bt,At),mt=new up(C,It,ie),kt=new Mp(C,It,ie),ie.programs=yt.programs,S.capabilities=Bt,S.extensions=It,S.properties=Lt,S.renderLists=dt,S.shadowMap=pt,S.state=At,S.info=ie}ut();const W=new lg(S,C);this.xr=W,this.getContext=function(){return C},this.getContextAttributes=function(){return C.getContextAttributes()},this.forceContextLoss=function(){const M=It.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=It.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return J},this.setPixelRatio=function(M){M!==void 0&&(J=M,this.setSize(Z,H,!1))},this.getSize=function(M){return M.set(Z,H)},this.setSize=function(M,D,B=!0){if(W.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}Z=M,H=D,e.width=Math.floor(M*J),e.height=Math.floor(D*J),B===!0&&(e.style.width=M+"px",e.style.height=D+"px"),this.setViewport(0,0,M,D)},this.getDrawingBufferSize=function(M){return M.set(Z*J,H*J).floor()},this.setDrawingBufferSize=function(M,D,B){Z=M,H=D,J=B,e.width=Math.floor(M*B),e.height=Math.floor(D*B),this.setViewport(0,0,M,D)},this.getCurrentViewport=function(M){return M.copy(g)},this.getViewport=function(M){return M.copy(ht)},this.setViewport=function(M,D,B,G){M.isVector4?ht.set(M.x,M.y,M.z,M.w):ht.set(M,D,B,G),At.viewport(g.copy(ht).multiplyScalar(J).round())},this.getScissor=function(M){return M.copy(gt)},this.setScissor=function(M,D,B,G){M.isVector4?gt.set(M.x,M.y,M.z,M.w):gt.set(M,D,B,G),At.scissor(y.copy(gt).multiplyScalar(J).round())},this.getScissorTest=function(){return Gt},this.setScissorTest=function(M){At.setScissorTest(Gt=M)},this.setOpaqueSort=function(M){V=M},this.setTransparentSort=function(M){lt=M},this.getClearColor=function(M){return M.copy(Ct.getClearColor())},this.setClearColor=function(){Ct.setClearColor.apply(Ct,arguments)},this.getClearAlpha=function(){return Ct.getClearAlpha()},this.setClearAlpha=function(){Ct.setClearAlpha.apply(Ct,arguments)},this.clear=function(M=!0,D=!0,B=!0){let G=0;if(M){let I=!1;if(w!==null){const it=w.texture.format;I=it===co||it===oo||it===ao}if(I){const it=w.texture.type,ct=it===En||it===ri||it===hs||it===Bi||it===so||it===ro,vt=Ct.getClearColor(),xt=Ct.getClearAlpha(),wt=vt.r,Rt=vt.g,St=vt.b;ct?(p[0]=wt,p[1]=Rt,p[2]=St,p[3]=xt,C.clearBufferuiv(C.COLOR,0,p)):(_[0]=wt,_[1]=Rt,_[2]=St,_[3]=xt,C.clearBufferiv(C.COLOR,0,_))}else G|=C.COLOR_BUFFER_BIT}D&&(G|=C.DEPTH_BUFFER_BIT,C.clearDepth(this.capabilities.reverseDepthBuffer?0:1)),B&&(G|=C.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),C.clear(G)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",j,!1),e.removeEventListener("webglcontextrestored",ot,!1),e.removeEventListener("webglcontextcreationerror",ft,!1),dt.dispose(),Wt.dispose(),Lt.dispose(),x.dispose(),z.dispose(),K.dispose(),ee.dispose(),L.dispose(),yt.dispose(),W.dispose(),W.removeEventListener("sessionstart",wo),W.removeEventListener("sessionend",Ro),Wn.stop()};function j(M){M.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),E=!0}function ot(){console.log("THREE.WebGLRenderer: Context Restored."),E=!1;const M=ie.autoReset,D=pt.enabled,B=pt.autoUpdate,G=pt.needsUpdate,I=pt.type;ut(),ie.autoReset=M,pt.enabled=D,pt.autoUpdate=B,pt.needsUpdate=G,pt.type=I}function ft(M){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function Vt(M){const D=M.target;D.removeEventListener("dispose",Vt),le(D)}function le(M){Pe(M),Lt.remove(M)}function Pe(M){const D=Lt.get(M).programs;D!==void 0&&(D.forEach(function(B){yt.releaseProgram(B)}),M.isShaderMaterial&&yt.releaseShaderCache(M))}this.renderBufferDirect=function(M,D,B,G,I,it){D===null&&(D=bt);const ct=I.isMesh&&I.matrixWorld.determinant()<0,vt=ah(M,D,B,G,I);At.setMaterial(G,ct);let xt=B.index,wt=1;if(G.wireframe===!0){if(xt=tt.getWireframeAttribute(B),xt===void 0)return;wt=2}const Rt=B.drawRange,St=B.attributes.position;let Jt=Rt.start*wt,se=(Rt.start+Rt.count)*wt;it!==null&&(Jt=Math.max(Jt,it.start*wt),se=Math.min(se,(it.start+it.count)*wt)),xt!==null?(Jt=Math.max(Jt,0),se=Math.min(se,xt.count)):St!=null&&(Jt=Math.max(Jt,0),se=Math.min(se,St.count));const ae=se-Jt;if(ae<0||ae===1/0)return;ee.setup(I,G,vt,B,xt);let Ie,Kt=mt;if(xt!==null&&(Ie=$.get(xt),Kt=kt,Kt.setIndex(Ie)),I.isMesh)G.wireframe===!0?(At.setLineWidth(G.wireframeLinewidth*zt()),Kt.setMode(C.LINES)):Kt.setMode(C.TRIANGLES);else if(I.isLine){let Et=G.linewidth;Et===void 0&&(Et=1),At.setLineWidth(Et*zt()),I.isLineSegments?Kt.setMode(C.LINES):I.isLineLoop?Kt.setMode(C.LINE_LOOP):Kt.setMode(C.LINE_STRIP)}else I.isPoints?Kt.setMode(C.POINTS):I.isSprite&&Kt.setMode(C.TRIANGLES);if(I.isBatchedMesh)if(I._multiDrawInstances!==null)Kt.renderMultiDrawInstances(I._multiDrawStarts,I._multiDrawCounts,I._multiDrawCount,I._multiDrawInstances);else if(It.get("WEBGL_multi_draw"))Kt.renderMultiDraw(I._multiDrawStarts,I._multiDrawCounts,I._multiDrawCount);else{const Et=I._multiDrawStarts,Me=I._multiDrawCounts,$t=I._multiDrawCount,Xe=xt?$.get(xt).bytesPerElement:1,oi=Lt.get(G).currentProgram.getUniforms();for(let Ue=0;Ue<$t;Ue++)oi.setValue(C,"_gl_DrawID",Ue),Kt.render(Et[Ue]/Xe,Me[Ue])}else if(I.isInstancedMesh)Kt.renderInstances(Jt,ae,I.count);else if(B.isInstancedBufferGeometry){const Et=B._maxInstanceCount!==void 0?B._maxInstanceCount:1/0,Me=Math.min(B.instanceCount,Et);Kt.renderInstances(Jt,ae,Me)}else Kt.render(Jt,ae)};function qt(M,D,B){M.transparent===!0&&M.side===je&&M.forceSinglePass===!1?(M.side=De,M.needsUpdate=!0,gs(M,D,B),M.side=Bn,M.needsUpdate=!0,gs(M,D,B),M.side=je):gs(M,D,B)}this.compile=function(M,D,B=null){B===null&&(B=M),m=Wt.get(B),m.init(D),T.push(m),B.traverseVisible(function(I){I.isLight&&I.layers.test(D.layers)&&(m.pushLight(I),I.castShadow&&m.pushShadow(I))}),M!==B&&M.traverseVisible(function(I){I.isLight&&I.layers.test(D.layers)&&(m.pushLight(I),I.castShadow&&m.pushShadow(I))}),m.setupLights();const G=new Set;return M.traverse(function(I){if(!(I.isMesh||I.isPoints||I.isLine||I.isSprite))return;const it=I.material;if(it)if(Array.isArray(it))for(let ct=0;ct<it.length;ct++){const vt=it[ct];qt(vt,B,I),G.add(vt)}else qt(it,B,I),G.add(it)}),T.pop(),m=null,G},this.compileAsync=function(M,D,B=null){const G=this.compile(M,D,B);return new Promise(I=>{function it(){if(G.forEach(function(ct){Lt.get(ct).currentProgram.isReady()&&G.delete(ct)}),G.size===0){I(M);return}setTimeout(it,10)}It.get("KHR_parallel_shader_compile")!==null?it():setTimeout(it,10)})};let Le=null;function dn(M){Le&&Le(M)}function wo(){Wn.stop()}function Ro(){Wn.start()}const Wn=new Ll;Wn.setAnimationLoop(dn),typeof self<"u"&&Wn.setContext(self),this.setAnimationLoop=function(M){Le=M,W.setAnimationLoop(M),M===null?Wn.stop():Wn.start()},W.addEventListener("sessionstart",wo),W.addEventListener("sessionend",Ro),this.render=function(M,D){if(D!==void 0&&D.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(E===!0)return;if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),D.parent===null&&D.matrixWorldAutoUpdate===!0&&D.updateMatrixWorld(),W.enabled===!0&&W.isPresenting===!0&&(W.cameraAutoUpdate===!0&&W.updateCamera(D),D=W.getCamera()),M.isScene===!0&&M.onBeforeRender(S,M,D,w),m=Wt.get(M,T.length),m.init(D),T.push(m),Q.multiplyMatrices(D.projectionMatrix,D.matrixWorldInverse),Xt.setFromProjectionMatrix(Q),X=this.localClippingEnabled,N=nt.init(this.clippingPlanes,X),v=dt.get(M,d.length),v.init(),d.push(v),W.enabled===!0&&W.isPresenting===!0){const it=S.xr.getDepthSensingMesh();it!==null&&pr(it,D,-1/0,S.sortObjects)}pr(M,D,0,S.sortObjects),v.finish(),S.sortObjects===!0&&v.sort(V,lt),Yt=W.enabled===!1||W.isPresenting===!1||W.hasDepthSensing()===!1,Yt&&Ct.addToRenderList(v,M),this.info.render.frame++,N===!0&&nt.beginShadows();const B=m.state.shadowsArray;pt.render(B,M,D),N===!0&&nt.endShadows(),this.info.autoReset===!0&&this.info.reset();const G=v.opaque,I=v.transmissive;if(m.setupLights(),D.isArrayCamera){const it=D.cameras;if(I.length>0)for(let ct=0,vt=it.length;ct<vt;ct++){const xt=it[ct];Po(G,I,M,xt)}Yt&&Ct.render(M);for(let ct=0,vt=it.length;ct<vt;ct++){const xt=it[ct];Co(v,M,xt,xt.viewport)}}else I.length>0&&Po(G,I,M,D),Yt&&Ct.render(M),Co(v,M,D);w!==null&&(A.updateMultisampleRenderTarget(w),A.updateRenderTargetMipmap(w)),M.isScene===!0&&M.onAfterRender(S,M,D),ee.resetDefaultState(),U=-1,Y=null,T.pop(),T.length>0?(m=T[T.length-1],N===!0&&nt.setGlobalState(S.clippingPlanes,m.state.camera)):m=null,d.pop(),d.length>0?v=d[d.length-1]:v=null};function pr(M,D,B,G){if(M.visible===!1)return;if(M.layers.test(D.layers)){if(M.isGroup)B=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(D);else if(M.isLight)m.pushLight(M),M.castShadow&&m.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||Xt.intersectsSprite(M)){G&&Mt.setFromMatrixPosition(M.matrixWorld).applyMatrix4(Q);const ct=K.update(M),vt=M.material;vt.visible&&v.push(M,ct,vt,B,Mt.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||Xt.intersectsObject(M))){const ct=K.update(M),vt=M.material;if(G&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),Mt.copy(M.boundingSphere.center)):(ct.boundingSphere===null&&ct.computeBoundingSphere(),Mt.copy(ct.boundingSphere.center)),Mt.applyMatrix4(M.matrixWorld).applyMatrix4(Q)),Array.isArray(vt)){const xt=ct.groups;for(let wt=0,Rt=xt.length;wt<Rt;wt++){const St=xt[wt],Jt=vt[St.materialIndex];Jt&&Jt.visible&&v.push(M,ct,Jt,B,Mt.z,St)}}else vt.visible&&v.push(M,ct,vt,B,Mt.z,null)}}const it=M.children;for(let ct=0,vt=it.length;ct<vt;ct++)pr(it[ct],D,B,G)}function Co(M,D,B,G){const I=M.opaque,it=M.transmissive,ct=M.transparent;m.setupLightsView(B),N===!0&&nt.setGlobalState(S.clippingPlanes,B),G&&At.viewport(g.copy(G)),I.length>0&&ms(I,D,B),it.length>0&&ms(it,D,B),ct.length>0&&ms(ct,D,B),At.buffers.depth.setTest(!0),At.buffers.depth.setMask(!0),At.buffers.color.setMask(!0),At.setPolygonOffset(!1)}function Po(M,D,B,G){if((B.isScene===!0?B.overrideMaterial:null)!==null)return;m.state.transmissionRenderTarget[G.id]===void 0&&(m.state.transmissionRenderTarget[G.id]=new ai(1,1,{generateMipmaps:!0,type:It.has("EXT_color_buffer_half_float")||It.has("EXT_color_buffer_float")?fs:En,minFilter:si,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Zt.workingColorSpace}));const it=m.state.transmissionRenderTarget[G.id],ct=G.viewport||g;it.setSize(ct.z,ct.w);const vt=S.getRenderTarget();S.setRenderTarget(it),S.getClearColor(F),k=S.getClearAlpha(),k<1&&S.setClearColor(16777215,.5),S.clear(),Yt&&Ct.render(B);const xt=S.toneMapping;S.toneMapping=On;const wt=G.viewport;if(G.viewport!==void 0&&(G.viewport=void 0),m.setupLightsView(G),N===!0&&nt.setGlobalState(S.clippingPlanes,G),ms(M,B,G),A.updateMultisampleRenderTarget(it),A.updateRenderTargetMipmap(it),It.has("WEBGL_multisampled_render_to_texture")===!1){let Rt=!1;for(let St=0,Jt=D.length;St<Jt;St++){const se=D[St],ae=se.object,Ie=se.geometry,Kt=se.material,Et=se.group;if(Kt.side===je&&ae.layers.test(G.layers)){const Me=Kt.side;Kt.side=De,Kt.needsUpdate=!0,Lo(ae,B,G,Ie,Kt,Et),Kt.side=Me,Kt.needsUpdate=!0,Rt=!0}}Rt===!0&&(A.updateMultisampleRenderTarget(it),A.updateRenderTargetMipmap(it))}S.setRenderTarget(vt),S.setClearColor(F,k),wt!==void 0&&(G.viewport=wt),S.toneMapping=xt}function ms(M,D,B){const G=D.isScene===!0?D.overrideMaterial:null;for(let I=0,it=M.length;I<it;I++){const ct=M[I],vt=ct.object,xt=ct.geometry,wt=G===null?ct.material:G,Rt=ct.group;vt.layers.test(B.layers)&&Lo(vt,D,B,xt,wt,Rt)}}function Lo(M,D,B,G,I,it){M.onBeforeRender(S,D,B,G,I,it),M.modelViewMatrix.multiplyMatrices(B.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),I.onBeforeRender(S,D,B,G,M,it),I.transparent===!0&&I.side===je&&I.forceSinglePass===!1?(I.side=De,I.needsUpdate=!0,S.renderBufferDirect(B,D,G,I,M,it),I.side=Bn,I.needsUpdate=!0,S.renderBufferDirect(B,D,G,I,M,it),I.side=je):S.renderBufferDirect(B,D,G,I,M,it),M.onAfterRender(S,D,B,G,I,it)}function gs(M,D,B){D.isScene!==!0&&(D=bt);const G=Lt.get(M),I=m.state.lights,it=m.state.shadowsArray,ct=I.state.version,vt=yt.getParameters(M,I.state,it,D,B),xt=yt.getProgramCacheKey(vt);let wt=G.programs;G.environment=M.isMeshStandardMaterial?D.environment:null,G.fog=D.fog,G.envMap=(M.isMeshStandardMaterial?z:x).get(M.envMap||G.environment),G.envMapRotation=G.environment!==null&&M.envMap===null?D.environmentRotation:M.envMapRotation,wt===void 0&&(M.addEventListener("dispose",Vt),wt=new Map,G.programs=wt);let Rt=wt.get(xt);if(Rt!==void 0){if(G.currentProgram===Rt&&G.lightsStateVersion===ct)return Io(M,vt),Rt}else vt.uniforms=yt.getUniforms(M),M.onBeforeCompile(vt,S),Rt=yt.acquireProgram(vt,xt),wt.set(xt,Rt),G.uniforms=vt.uniforms;const St=G.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(St.clippingPlanes=nt.uniform),Io(M,vt),G.needsLights=ch(M),G.lightsStateVersion=ct,G.needsLights&&(St.ambientLightColor.value=I.state.ambient,St.lightProbe.value=I.state.probe,St.directionalLights.value=I.state.directional,St.directionalLightShadows.value=I.state.directionalShadow,St.spotLights.value=I.state.spot,St.spotLightShadows.value=I.state.spotShadow,St.rectAreaLights.value=I.state.rectArea,St.ltc_1.value=I.state.rectAreaLTC1,St.ltc_2.value=I.state.rectAreaLTC2,St.pointLights.value=I.state.point,St.pointLightShadows.value=I.state.pointShadow,St.hemisphereLights.value=I.state.hemi,St.directionalShadowMap.value=I.state.directionalShadowMap,St.directionalShadowMatrix.value=I.state.directionalShadowMatrix,St.spotShadowMap.value=I.state.spotShadowMap,St.spotLightMatrix.value=I.state.spotLightMatrix,St.spotLightMap.value=I.state.spotLightMap,St.pointShadowMap.value=I.state.pointShadowMap,St.pointShadowMatrix.value=I.state.pointShadowMatrix),G.currentProgram=Rt,G.uniformsList=null,Rt}function Do(M){if(M.uniformsList===null){const D=M.currentProgram.getUniforms();M.uniformsList=Js.seqWithValue(D.seq,M.uniforms)}return M.uniformsList}function Io(M,D){const B=Lt.get(M);B.outputColorSpace=D.outputColorSpace,B.batching=D.batching,B.batchingColor=D.batchingColor,B.instancing=D.instancing,B.instancingColor=D.instancingColor,B.instancingMorph=D.instancingMorph,B.skinning=D.skinning,B.morphTargets=D.morphTargets,B.morphNormals=D.morphNormals,B.morphColors=D.morphColors,B.morphTargetsCount=D.morphTargetsCount,B.numClippingPlanes=D.numClippingPlanes,B.numIntersection=D.numClipIntersection,B.vertexAlphas=D.vertexAlphas,B.vertexTangents=D.vertexTangents,B.toneMapping=D.toneMapping}function ah(M,D,B,G,I){D.isScene!==!0&&(D=bt),A.resetTextureUnits();const it=D.fog,ct=G.isMeshStandardMaterial?D.environment:null,vt=w===null?S.outputColorSpace:w.isXRRenderTarget===!0?w.texture.colorSpace:Gn,xt=(G.isMeshStandardMaterial?z:x).get(G.envMap||ct),wt=G.vertexColors===!0&&!!B.attributes.color&&B.attributes.color.itemSize===4,Rt=!!B.attributes.tangent&&(!!G.normalMap||G.anisotropy>0),St=!!B.morphAttributes.position,Jt=!!B.morphAttributes.normal,se=!!B.morphAttributes.color;let ae=On;G.toneMapped&&(w===null||w.isXRRenderTarget===!0)&&(ae=S.toneMapping);const Ie=B.morphAttributes.position||B.morphAttributes.normal||B.morphAttributes.color,Kt=Ie!==void 0?Ie.length:0,Et=Lt.get(G),Me=m.state.lights;if(N===!0&&(X===!0||M!==Y)){const Be=M===Y&&G.id===U;nt.setState(G,M,Be)}let $t=!1;G.version===Et.__version?(Et.needsLights&&Et.lightsStateVersion!==Me.state.version||Et.outputColorSpace!==vt||I.isBatchedMesh&&Et.batching===!1||!I.isBatchedMesh&&Et.batching===!0||I.isBatchedMesh&&Et.batchingColor===!0&&I.colorTexture===null||I.isBatchedMesh&&Et.batchingColor===!1&&I.colorTexture!==null||I.isInstancedMesh&&Et.instancing===!1||!I.isInstancedMesh&&Et.instancing===!0||I.isSkinnedMesh&&Et.skinning===!1||!I.isSkinnedMesh&&Et.skinning===!0||I.isInstancedMesh&&Et.instancingColor===!0&&I.instanceColor===null||I.isInstancedMesh&&Et.instancingColor===!1&&I.instanceColor!==null||I.isInstancedMesh&&Et.instancingMorph===!0&&I.morphTexture===null||I.isInstancedMesh&&Et.instancingMorph===!1&&I.morphTexture!==null||Et.envMap!==xt||G.fog===!0&&Et.fog!==it||Et.numClippingPlanes!==void 0&&(Et.numClippingPlanes!==nt.numPlanes||Et.numIntersection!==nt.numIntersection)||Et.vertexAlphas!==wt||Et.vertexTangents!==Rt||Et.morphTargets!==St||Et.morphNormals!==Jt||Et.morphColors!==se||Et.toneMapping!==ae||Et.morphTargetsCount!==Kt)&&($t=!0):($t=!0,Et.__version=G.version);let Xe=Et.currentProgram;$t===!0&&(Xe=gs(G,D,I));let oi=!1,Ue=!1,mr=!1;const ce=Xe.getUniforms(),Tn=Et.uniforms;if(At.useProgram(Xe.program)&&(oi=!0,Ue=!0,mr=!0),G.id!==U&&(U=G.id,Ue=!0),oi||Y!==M){Bt.reverseDepthBuffer?(et.copy(M.projectionMatrix),eu(et),nu(et),ce.setValue(C,"projectionMatrix",et)):ce.setValue(C,"projectionMatrix",M.projectionMatrix),ce.setValue(C,"viewMatrix",M.matrixWorldInverse);const Be=ce.map.cameraPosition;Be!==void 0&&Be.setValue(C,_t.setFromMatrixPosition(M.matrixWorld)),Bt.logarithmicDepthBuffer&&ce.setValue(C,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(G.isMeshPhongMaterial||G.isMeshToonMaterial||G.isMeshLambertMaterial||G.isMeshBasicMaterial||G.isMeshStandardMaterial||G.isShaderMaterial)&&ce.setValue(C,"isOrthographic",M.isOrthographicCamera===!0),Y!==M&&(Y=M,Ue=!0,mr=!0)}if(I.isSkinnedMesh){ce.setOptional(C,I,"bindMatrix"),ce.setOptional(C,I,"bindMatrixInverse");const Be=I.skeleton;Be&&(Be.boneTexture===null&&Be.computeBoneTexture(),ce.setValue(C,"boneTexture",Be.boneTexture,A))}I.isBatchedMesh&&(ce.setOptional(C,I,"batchingTexture"),ce.setValue(C,"batchingTexture",I._matricesTexture,A),ce.setOptional(C,I,"batchingIdTexture"),ce.setValue(C,"batchingIdTexture",I._indirectTexture,A),ce.setOptional(C,I,"batchingColorTexture"),I._colorsTexture!==null&&ce.setValue(C,"batchingColorTexture",I._colorsTexture,A));const gr=B.morphAttributes;if((gr.position!==void 0||gr.normal!==void 0||gr.color!==void 0)&&Pt.update(I,B,Xe),(Ue||Et.receiveShadow!==I.receiveShadow)&&(Et.receiveShadow=I.receiveShadow,ce.setValue(C,"receiveShadow",I.receiveShadow)),G.isMeshGouraudMaterial&&G.envMap!==null&&(Tn.envMap.value=xt,Tn.flipEnvMap.value=xt.isCubeTexture&&xt.isRenderTargetTexture===!1?-1:1),G.isMeshStandardMaterial&&G.envMap===null&&D.environment!==null&&(Tn.envMapIntensity.value=D.environmentIntensity),Ue&&(ce.setValue(C,"toneMappingExposure",S.toneMappingExposure),Et.needsLights&&oh(Tn,mr),it&&G.fog===!0&&rt.refreshFogUniforms(Tn,it),rt.refreshMaterialUniforms(Tn,G,J,H,m.state.transmissionRenderTarget[M.id]),Js.upload(C,Do(Et),Tn,A)),G.isShaderMaterial&&G.uniformsNeedUpdate===!0&&(Js.upload(C,Do(Et),Tn,A),G.uniformsNeedUpdate=!1),G.isSpriteMaterial&&ce.setValue(C,"center",I.center),ce.setValue(C,"modelViewMatrix",I.modelViewMatrix),ce.setValue(C,"normalMatrix",I.normalMatrix),ce.setValue(C,"modelMatrix",I.matrixWorld),G.isShaderMaterial||G.isRawShaderMaterial){const Be=G.uniformsGroups;for(let _r=0,lh=Be.length;_r<lh;_r++){const Uo=Be[_r];L.update(Uo,Xe),L.bind(Uo,Xe)}}return Xe}function oh(M,D){M.ambientLightColor.needsUpdate=D,M.lightProbe.needsUpdate=D,M.directionalLights.needsUpdate=D,M.directionalLightShadows.needsUpdate=D,M.pointLights.needsUpdate=D,M.pointLightShadows.needsUpdate=D,M.spotLights.needsUpdate=D,M.spotLightShadows.needsUpdate=D,M.rectAreaLights.needsUpdate=D,M.hemisphereLights.needsUpdate=D}function ch(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return P},this.getActiveMipmapLevel=function(){return b},this.getRenderTarget=function(){return w},this.setRenderTargetTextures=function(M,D,B){Lt.get(M.texture).__webglTexture=D,Lt.get(M.depthTexture).__webglTexture=B;const G=Lt.get(M);G.__hasExternalTextures=!0,G.__autoAllocateDepthBuffer=B===void 0,G.__autoAllocateDepthBuffer||It.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),G.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(M,D){const B=Lt.get(M);B.__webglFramebuffer=D,B.__useDefaultFramebuffer=D===void 0},this.setRenderTarget=function(M,D=0,B=0){w=M,P=D,b=B;let G=!0,I=null,it=!1,ct=!1;if(M){const xt=Lt.get(M);if(xt.__useDefaultFramebuffer!==void 0)At.bindFramebuffer(C.FRAMEBUFFER,null),G=!1;else if(xt.__webglFramebuffer===void 0)A.setupRenderTarget(M);else if(xt.__hasExternalTextures)A.rebindTextures(M,Lt.get(M.texture).__webglTexture,Lt.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){const St=M.depthTexture;if(xt.__boundDepthTexture!==St){if(St!==null&&Lt.has(St)&&(M.width!==St.image.width||M.height!==St.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");A.setupDepthRenderbuffer(M)}}const wt=M.texture;(wt.isData3DTexture||wt.isDataArrayTexture||wt.isCompressedArrayTexture)&&(ct=!0);const Rt=Lt.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(Rt[D])?I=Rt[D][B]:I=Rt[D],it=!0):M.samples>0&&A.useMultisampledRTT(M)===!1?I=Lt.get(M).__webglMultisampledFramebuffer:Array.isArray(Rt)?I=Rt[B]:I=Rt,g.copy(M.viewport),y.copy(M.scissor),O=M.scissorTest}else g.copy(ht).multiplyScalar(J).floor(),y.copy(gt).multiplyScalar(J).floor(),O=Gt;if(At.bindFramebuffer(C.FRAMEBUFFER,I)&&G&&At.drawBuffers(M,I),At.viewport(g),At.scissor(y),At.setScissorTest(O),it){const xt=Lt.get(M.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_CUBE_MAP_POSITIVE_X+D,xt.__webglTexture,B)}else if(ct){const xt=Lt.get(M.texture),wt=D||0;C.framebufferTextureLayer(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,xt.__webglTexture,B||0,wt)}U=-1},this.readRenderTargetPixels=function(M,D,B,G,I,it,ct){if(!(M&&M.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let vt=Lt.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&ct!==void 0&&(vt=vt[ct]),vt){At.bindFramebuffer(C.FRAMEBUFFER,vt);try{const xt=M.texture,wt=xt.format,Rt=xt.type;if(!Bt.textureFormatReadable(wt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Bt.textureTypeReadable(Rt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}D>=0&&D<=M.width-G&&B>=0&&B<=M.height-I&&C.readPixels(D,B,G,I,Dt.convert(wt),Dt.convert(Rt),it)}finally{const xt=w!==null?Lt.get(w).__webglFramebuffer:null;At.bindFramebuffer(C.FRAMEBUFFER,xt)}}},this.readRenderTargetPixelsAsync=async function(M,D,B,G,I,it,ct){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let vt=Lt.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&ct!==void 0&&(vt=vt[ct]),vt){const xt=M.texture,wt=xt.format,Rt=xt.type;if(!Bt.textureFormatReadable(wt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Bt.textureTypeReadable(Rt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(D>=0&&D<=M.width-G&&B>=0&&B<=M.height-I){At.bindFramebuffer(C.FRAMEBUFFER,vt);const St=C.createBuffer();C.bindBuffer(C.PIXEL_PACK_BUFFER,St),C.bufferData(C.PIXEL_PACK_BUFFER,it.byteLength,C.STREAM_READ),C.readPixels(D,B,G,I,Dt.convert(wt),Dt.convert(Rt),0);const Jt=w!==null?Lt.get(w).__webglFramebuffer:null;At.bindFramebuffer(C.FRAMEBUFFER,Jt);const se=C.fenceSync(C.SYNC_GPU_COMMANDS_COMPLETE,0);return C.flush(),await tu(C,se,4),C.bindBuffer(C.PIXEL_PACK_BUFFER,St),C.getBufferSubData(C.PIXEL_PACK_BUFFER,0,it),C.deleteBuffer(St),C.deleteSync(se),it}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(M,D=null,B=0){M.isTexture!==!0&&(Zs("WebGLRenderer: copyFramebufferToTexture function signature has changed."),D=arguments[0]||null,M=arguments[1]);const G=Math.pow(2,-B),I=Math.floor(M.image.width*G),it=Math.floor(M.image.height*G),ct=D!==null?D.x:0,vt=D!==null?D.y:0;A.setTexture2D(M,0),C.copyTexSubImage2D(C.TEXTURE_2D,B,0,0,ct,vt,I,it),At.unbindTexture()},this.copyTextureToTexture=function(M,D,B=null,G=null,I=0){M.isTexture!==!0&&(Zs("WebGLRenderer: copyTextureToTexture function signature has changed."),G=arguments[0]||null,M=arguments[1],D=arguments[2],I=arguments[3]||0,B=null);let it,ct,vt,xt,wt,Rt;B!==null?(it=B.max.x-B.min.x,ct=B.max.y-B.min.y,vt=B.min.x,xt=B.min.y):(it=M.image.width,ct=M.image.height,vt=0,xt=0),G!==null?(wt=G.x,Rt=G.y):(wt=0,Rt=0);const St=Dt.convert(D.format),Jt=Dt.convert(D.type);A.setTexture2D(D,0),C.pixelStorei(C.UNPACK_FLIP_Y_WEBGL,D.flipY),C.pixelStorei(C.UNPACK_PREMULTIPLY_ALPHA_WEBGL,D.premultiplyAlpha),C.pixelStorei(C.UNPACK_ALIGNMENT,D.unpackAlignment);const se=C.getParameter(C.UNPACK_ROW_LENGTH),ae=C.getParameter(C.UNPACK_IMAGE_HEIGHT),Ie=C.getParameter(C.UNPACK_SKIP_PIXELS),Kt=C.getParameter(C.UNPACK_SKIP_ROWS),Et=C.getParameter(C.UNPACK_SKIP_IMAGES),Me=M.isCompressedTexture?M.mipmaps[I]:M.image;C.pixelStorei(C.UNPACK_ROW_LENGTH,Me.width),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,Me.height),C.pixelStorei(C.UNPACK_SKIP_PIXELS,vt),C.pixelStorei(C.UNPACK_SKIP_ROWS,xt),M.isDataTexture?C.texSubImage2D(C.TEXTURE_2D,I,wt,Rt,it,ct,St,Jt,Me.data):M.isCompressedTexture?C.compressedTexSubImage2D(C.TEXTURE_2D,I,wt,Rt,Me.width,Me.height,St,Me.data):C.texSubImage2D(C.TEXTURE_2D,I,wt,Rt,it,ct,St,Jt,Me),C.pixelStorei(C.UNPACK_ROW_LENGTH,se),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,ae),C.pixelStorei(C.UNPACK_SKIP_PIXELS,Ie),C.pixelStorei(C.UNPACK_SKIP_ROWS,Kt),C.pixelStorei(C.UNPACK_SKIP_IMAGES,Et),I===0&&D.generateMipmaps&&C.generateMipmap(C.TEXTURE_2D),At.unbindTexture()},this.copyTextureToTexture3D=function(M,D,B=null,G=null,I=0){M.isTexture!==!0&&(Zs("WebGLRenderer: copyTextureToTexture3D function signature has changed."),B=arguments[0]||null,G=arguments[1]||null,M=arguments[2],D=arguments[3],I=arguments[4]||0);let it,ct,vt,xt,wt,Rt,St,Jt,se;const ae=M.isCompressedTexture?M.mipmaps[I]:M.image;B!==null?(it=B.max.x-B.min.x,ct=B.max.y-B.min.y,vt=B.max.z-B.min.z,xt=B.min.x,wt=B.min.y,Rt=B.min.z):(it=ae.width,ct=ae.height,vt=ae.depth,xt=0,wt=0,Rt=0),G!==null?(St=G.x,Jt=G.y,se=G.z):(St=0,Jt=0,se=0);const Ie=Dt.convert(D.format),Kt=Dt.convert(D.type);let Et;if(D.isData3DTexture)A.setTexture3D(D,0),Et=C.TEXTURE_3D;else if(D.isDataArrayTexture||D.isCompressedArrayTexture)A.setTexture2DArray(D,0),Et=C.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}C.pixelStorei(C.UNPACK_FLIP_Y_WEBGL,D.flipY),C.pixelStorei(C.UNPACK_PREMULTIPLY_ALPHA_WEBGL,D.premultiplyAlpha),C.pixelStorei(C.UNPACK_ALIGNMENT,D.unpackAlignment);const Me=C.getParameter(C.UNPACK_ROW_LENGTH),$t=C.getParameter(C.UNPACK_IMAGE_HEIGHT),Xe=C.getParameter(C.UNPACK_SKIP_PIXELS),oi=C.getParameter(C.UNPACK_SKIP_ROWS),Ue=C.getParameter(C.UNPACK_SKIP_IMAGES);C.pixelStorei(C.UNPACK_ROW_LENGTH,ae.width),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,ae.height),C.pixelStorei(C.UNPACK_SKIP_PIXELS,xt),C.pixelStorei(C.UNPACK_SKIP_ROWS,wt),C.pixelStorei(C.UNPACK_SKIP_IMAGES,Rt),M.isDataTexture||M.isData3DTexture?C.texSubImage3D(Et,I,St,Jt,se,it,ct,vt,Ie,Kt,ae.data):D.isCompressedArrayTexture?C.compressedTexSubImage3D(Et,I,St,Jt,se,it,ct,vt,Ie,ae.data):C.texSubImage3D(Et,I,St,Jt,se,it,ct,vt,Ie,Kt,ae),C.pixelStorei(C.UNPACK_ROW_LENGTH,Me),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,$t),C.pixelStorei(C.UNPACK_SKIP_PIXELS,Xe),C.pixelStorei(C.UNPACK_SKIP_ROWS,oi),C.pixelStorei(C.UNPACK_SKIP_IMAGES,Ue),I===0&&D.generateMipmaps&&C.generateMipmap(Et),At.unbindTexture()},this.initRenderTarget=function(M){Lt.get(M).__webglFramebuffer===void 0&&A.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?A.setTextureCube(M,0):M.isData3DTexture?A.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?A.setTexture2DArray(M,0):A.setTexture2D(M,0),At.unbindTexture()},this.resetState=function(){P=0,b=0,w=null,At.reset(),ee.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return yn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=t===lo?"display-p3":"srgb",e.unpackColorSpace=Zt.workingColorSpace===cr?"display-p3":"srgb"}}class mo{constructor(t,e=1,n=1e3){this.isFog=!0,this.name="",this.color=new Ft(t),this.near=e,this.far=n}clone(){return new mo(this.color,this.near,this.far)}toJSON(){return{type:"Fog",name:this.name,color:this.color.getHex(),near:this.near,far:this.far}}}class pg extends xe{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new un,this.environmentIntensity=1,this.environmentRotation=new un,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(t,e){return super.copy(t,e),t.background!==null&&(this.background=t.background.clone()),t.environment!==null&&(this.environment=t.environment.clone()),t.fog!==null&&(this.fog=t.fog.clone()),this.backgroundBlurriness=t.backgroundBlurriness,this.backgroundIntensity=t.backgroundIntensity,this.backgroundRotation.copy(t.backgroundRotation),this.environmentIntensity=t.environmentIntensity,this.environmentRotation.copy(t.environmentRotation),t.overrideMaterial!==null&&(this.overrideMaterial=t.overrideMaterial.clone()),this.matrixAutoUpdate=t.matrixAutoUpdate,this}toJSON(t){const e=super.toJSON(t);return this.fog!==null&&(e.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(e.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(e.object.backgroundIntensity=this.backgroundIntensity),e.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(e.object.environmentIntensity=this.environmentIntensity),e.object.environmentRotation=this.environmentRotation.toArray(),e}}class mg{constructor(t,e){this.isInterleavedBuffer=!0,this.array=t,this.stride=e,this.count=t!==void 0?t.length/e:0,this.usage=$a,this.updateRanges=[],this.version=0,this.uuid=Fn()}onUploadCallback(){}set needsUpdate(t){t===!0&&this.version++}setUsage(t){return this.usage=t,this}addUpdateRange(t,e){this.updateRanges.push({start:t,count:e})}clearUpdateRanges(){this.updateRanges.length=0}copy(t){return this.array=new t.array.constructor(t.array),this.count=t.count,this.stride=t.stride,this.usage=t.usage,this}copyAt(t,e,n){t*=this.stride,n*=e.stride;for(let s=0,r=this.stride;s<r;s++)this.array[t+s]=e.array[n+s];return this}set(t,e=0){return this.array.set(t,e),this}clone(t){t.arrayBuffers===void 0&&(t.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=Fn()),t.arrayBuffers[this.array.buffer._uuid]===void 0&&(t.arrayBuffers[this.array.buffer._uuid]=this.array.slice(0).buffer);const e=new this.array.constructor(t.arrayBuffers[this.array.buffer._uuid]),n=new this.constructor(e,this.stride);return n.setUsage(this.usage),n}onUpload(t){return this.onUploadCallback=t,this}toJSON(t){return t.arrayBuffers===void 0&&(t.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=Fn()),t.arrayBuffers[this.array.buffer._uuid]===void 0&&(t.arrayBuffers[this.array.buffer._uuid]=Array.from(new Uint32Array(this.array.buffer))),{uuid:this.uuid,buffer:this.array.buffer._uuid,type:this.array.constructor.name,stride:this.stride}}}const be=new R;class ar{constructor(t,e,n,s=!1){this.isInterleavedBufferAttribute=!0,this.name="",this.data=t,this.itemSize=e,this.offset=n,this.normalized=s}get count(){return this.data.count}get array(){return this.data.array}set needsUpdate(t){this.data.needsUpdate=t}applyMatrix4(t){for(let e=0,n=this.data.count;e<n;e++)be.fromBufferAttribute(this,e),be.applyMatrix4(t),this.setXYZ(e,be.x,be.y,be.z);return this}applyNormalMatrix(t){for(let e=0,n=this.count;e<n;e++)be.fromBufferAttribute(this,e),be.applyNormalMatrix(t),this.setXYZ(e,be.x,be.y,be.z);return this}transformDirection(t){for(let e=0,n=this.count;e<n;e++)be.fromBufferAttribute(this,e),be.transformDirection(t),this.setXYZ(e,be.x,be.y,be.z);return this}getComponent(t,e){let n=this.array[t*this.data.stride+this.offset+e];return this.normalized&&(n=cn(n,this.array)),n}setComponent(t,e,n){return this.normalized&&(n=Qt(n,this.array)),this.data.array[t*this.data.stride+this.offset+e]=n,this}setX(t,e){return this.normalized&&(e=Qt(e,this.array)),this.data.array[t*this.data.stride+this.offset]=e,this}setY(t,e){return this.normalized&&(e=Qt(e,this.array)),this.data.array[t*this.data.stride+this.offset+1]=e,this}setZ(t,e){return this.normalized&&(e=Qt(e,this.array)),this.data.array[t*this.data.stride+this.offset+2]=e,this}setW(t,e){return this.normalized&&(e=Qt(e,this.array)),this.data.array[t*this.data.stride+this.offset+3]=e,this}getX(t){let e=this.data.array[t*this.data.stride+this.offset];return this.normalized&&(e=cn(e,this.array)),e}getY(t){let e=this.data.array[t*this.data.stride+this.offset+1];return this.normalized&&(e=cn(e,this.array)),e}getZ(t){let e=this.data.array[t*this.data.stride+this.offset+2];return this.normalized&&(e=cn(e,this.array)),e}getW(t){let e=this.data.array[t*this.data.stride+this.offset+3];return this.normalized&&(e=cn(e,this.array)),e}setXY(t,e,n){return t=t*this.data.stride+this.offset,this.normalized&&(e=Qt(e,this.array),n=Qt(n,this.array)),this.data.array[t+0]=e,this.data.array[t+1]=n,this}setXYZ(t,e,n,s){return t=t*this.data.stride+this.offset,this.normalized&&(e=Qt(e,this.array),n=Qt(n,this.array),s=Qt(s,this.array)),this.data.array[t+0]=e,this.data.array[t+1]=n,this.data.array[t+2]=s,this}setXYZW(t,e,n,s,r){return t=t*this.data.stride+this.offset,this.normalized&&(e=Qt(e,this.array),n=Qt(n,this.array),s=Qt(s,this.array),r=Qt(r,this.array)),this.data.array[t+0]=e,this.data.array[t+1]=n,this.data.array[t+2]=s,this.data.array[t+3]=r,this}clone(t){if(t===void 0){console.log("THREE.InterleavedBufferAttribute.clone(): Cloning an interleaved buffer attribute will de-interleave buffer data.");const e=[];for(let n=0;n<this.count;n++){const s=n*this.data.stride+this.offset;for(let r=0;r<this.itemSize;r++)e.push(this.data.array[s+r])}return new sn(new this.array.constructor(e),this.itemSize,this.normalized)}else return t.interleavedBuffers===void 0&&(t.interleavedBuffers={}),t.interleavedBuffers[this.data.uuid]===void 0&&(t.interleavedBuffers[this.data.uuid]=this.data.clone(t)),new ar(t.interleavedBuffers[this.data.uuid],this.itemSize,this.offset,this.normalized)}toJSON(t){if(t===void 0){console.log("THREE.InterleavedBufferAttribute.toJSON(): Serializing an interleaved buffer attribute will de-interleave buffer data.");const e=[];for(let n=0;n<this.count;n++){const s=n*this.data.stride+this.offset;for(let r=0;r<this.itemSize;r++)e.push(this.data.array[s+r])}return{itemSize:this.itemSize,type:this.array.constructor.name,array:e,normalized:this.normalized}}else return t.interleavedBuffers===void 0&&(t.interleavedBuffers={}),t.interleavedBuffers[this.data.uuid]===void 0&&(t.interleavedBuffers[this.data.uuid]=this.data.toJSON(t)),{isInterleavedBufferAttribute:!0,itemSize:this.itemSize,data:this.data.uuid,offset:this.offset,normalized:this.normalized}}}class go extends Vi{constructor(t){super(),this.isSpriteMaterial=!0,this.type="SpriteMaterial",this.color=new Ft(16777215),this.map=null,this.alphaMap=null,this.rotation=0,this.sizeAttenuation=!0,this.transparent=!0,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.color.copy(t.color),this.map=t.map,this.alphaMap=t.alphaMap,this.rotation=t.rotation,this.sizeAttenuation=t.sizeAttenuation,this.fog=t.fog,this}}let Si;const Ji=new R,Ei=new R,Ti=new R,bi=new at,ji=new at,zl=new ne,zs=new R,Qi=new R,Bs=new R,Cc=new at,$r=new at,Pc=new at;class Bl extends xe{constructor(t=new go){if(super(),this.isSprite=!0,this.type="Sprite",Si===void 0){Si=new ze;const e=new Float32Array([-.5,-.5,0,0,0,.5,-.5,0,1,0,.5,.5,0,1,1,-.5,.5,0,0,1]),n=new mg(e,5);Si.setIndex([0,1,2,0,2,3]),Si.setAttribute("position",new ar(n,3,0,!1)),Si.setAttribute("uv",new ar(n,2,3,!1))}this.geometry=Si,this.material=t,this.center=new at(.5,.5)}raycast(t,e){t.camera===null&&console.error('THREE.Sprite: "Raycaster.camera" needs to be set in order to raycast against sprites.'),Ei.setFromMatrixScale(this.matrixWorld),zl.copy(t.camera.matrixWorld),this.modelViewMatrix.multiplyMatrices(t.camera.matrixWorldInverse,this.matrixWorld),Ti.setFromMatrixPosition(this.modelViewMatrix),t.camera.isPerspectiveCamera&&this.material.sizeAttenuation===!1&&Ei.multiplyScalar(-Ti.z);const n=this.material.rotation;let s,r;n!==0&&(r=Math.cos(n),s=Math.sin(n));const a=this.center;ks(zs.set(-.5,-.5,0),Ti,a,Ei,s,r),ks(Qi.set(.5,-.5,0),Ti,a,Ei,s,r),ks(Bs.set(.5,.5,0),Ti,a,Ei,s,r),Cc.set(0,0),$r.set(1,0),Pc.set(1,1);let o=t.ray.intersectTriangle(zs,Qi,Bs,!1,Ji);if(o===null&&(ks(Qi.set(-.5,.5,0),Ti,a,Ei,s,r),$r.set(0,1),o=t.ray.intersectTriangle(zs,Bs,Qi,!1,Ji),o===null))return;const c=t.ray.origin.distanceTo(Ji);c<t.near||c>t.far||e.push({distance:c,point:Ji.clone(),uv:Ge.getInterpolation(Ji,zs,Qi,Bs,Cc,$r,Pc,new at),face:null,object:this})}copy(t,e){return super.copy(t,e),t.center!==void 0&&this.center.copy(t.center),this.material=t.material,this}}function ks(i,t,e,n,s,r){bi.subVectors(i,e).addScalar(.5).multiply(n),s!==void 0?(ji.x=r*bi.x-s*bi.y,ji.y=s*bi.x+r*bi.y):ji.copy(bi),i.copy(t),i.x+=ji.x,i.y+=ji.y,i.applyMatrix4(zl)}class _o extends Re{constructor(t,e,n,s,r,a,o,c,l){super(t,e,n,s,r,a,o,c,l),this.isCanvasTexture=!0,this.needsUpdate=!0}}class fn{constructor(){this.type="Curve",this.arcLengthDivisions=200}getPoint(){return console.warn("THREE.Curve: .getPoint() not implemented."),null}getPointAt(t,e){const n=this.getUtoTmapping(t);return this.getPoint(n,e)}getPoints(t=5){const e=[];for(let n=0;n<=t;n++)e.push(this.getPoint(n/t));return e}getSpacedPoints(t=5){const e=[];for(let n=0;n<=t;n++)e.push(this.getPointAt(n/t));return e}getLength(){const t=this.getLengths();return t[t.length-1]}getLengths(t=this.arcLengthDivisions){if(this.cacheArcLengths&&this.cacheArcLengths.length===t+1&&!this.needsUpdate)return this.cacheArcLengths;this.needsUpdate=!1;const e=[];let n,s=this.getPoint(0),r=0;e.push(0);for(let a=1;a<=t;a++)n=this.getPoint(a/t),r+=n.distanceTo(s),e.push(r),s=n;return this.cacheArcLengths=e,e}updateArcLengths(){this.needsUpdate=!0,this.getLengths()}getUtoTmapping(t,e){const n=this.getLengths();let s=0;const r=n.length;let a;e?a=e:a=t*n[r-1];let o=0,c=r-1,l;for(;o<=c;)if(s=Math.floor(o+(c-o)/2),l=n[s]-a,l<0)o=s+1;else if(l>0)c=s-1;else{c=s;break}if(s=c,n[s]===a)return s/(r-1);const h=n[s],f=n[s+1]-h,p=(a-h)/f;return(s+p)/(r-1)}getTangent(t,e){let s=t-1e-4,r=t+1e-4;s<0&&(s=0),r>1&&(r=1);const a=this.getPoint(s),o=this.getPoint(r),c=e||(a.isVector2?new at:new R);return c.copy(o).sub(a).normalize(),c}getTangentAt(t,e){const n=this.getUtoTmapping(t);return this.getTangent(n,e)}computeFrenetFrames(t,e){const n=new R,s=[],r=[],a=[],o=new R,c=new ne;for(let p=0;p<=t;p++){const _=p/t;s[p]=this.getTangentAt(_,new R)}r[0]=new R,a[0]=new R;let l=Number.MAX_VALUE;const h=Math.abs(s[0].x),u=Math.abs(s[0].y),f=Math.abs(s[0].z);h<=l&&(l=h,n.set(1,0,0)),u<=l&&(l=u,n.set(0,1,0)),f<=l&&n.set(0,0,1),o.crossVectors(s[0],n).normalize(),r[0].crossVectors(s[0],o),a[0].crossVectors(s[0],r[0]);for(let p=1;p<=t;p++){if(r[p]=r[p-1].clone(),a[p]=a[p-1].clone(),o.crossVectors(s[p-1],s[p]),o.length()>Number.EPSILON){o.normalize();const _=Math.acos(ve(s[p-1].dot(s[p]),-1,1));r[p].applyMatrix4(c.makeRotationAxis(o,_))}a[p].crossVectors(s[p],r[p])}if(e===!0){let p=Math.acos(ve(r[0].dot(r[t]),-1,1));p/=t,s[0].dot(o.crossVectors(r[0],r[t]))>0&&(p=-p);for(let _=1;_<=t;_++)r[_].applyMatrix4(c.makeRotationAxis(s[_],p*_)),a[_].crossVectors(s[_],r[_])}return{tangents:s,normals:r,binormals:a}}clone(){return new this.constructor().copy(this)}copy(t){return this.arcLengthDivisions=t.arcLengthDivisions,this}toJSON(){const t={metadata:{version:4.6,type:"Curve",generator:"Curve.toJSON"}};return t.arcLengthDivisions=this.arcLengthDivisions,t.type=this.type,t}fromJSON(t){return this.arcLengthDivisions=t.arcLengthDivisions,this}}class vo extends fn{constructor(t=0,e=0,n=1,s=1,r=0,a=Math.PI*2,o=!1,c=0){super(),this.isEllipseCurve=!0,this.type="EllipseCurve",this.aX=t,this.aY=e,this.xRadius=n,this.yRadius=s,this.aStartAngle=r,this.aEndAngle=a,this.aClockwise=o,this.aRotation=c}getPoint(t,e=new at){const n=e,s=Math.PI*2;let r=this.aEndAngle-this.aStartAngle;const a=Math.abs(r)<Number.EPSILON;for(;r<0;)r+=s;for(;r>s;)r-=s;r<Number.EPSILON&&(a?r=0:r=s),this.aClockwise===!0&&!a&&(r===s?r=-s:r=r-s);const o=this.aStartAngle+t*r;let c=this.aX+this.xRadius*Math.cos(o),l=this.aY+this.yRadius*Math.sin(o);if(this.aRotation!==0){const h=Math.cos(this.aRotation),u=Math.sin(this.aRotation),f=c-this.aX,p=l-this.aY;c=f*h-p*u+this.aX,l=f*u+p*h+this.aY}return n.set(c,l)}copy(t){return super.copy(t),this.aX=t.aX,this.aY=t.aY,this.xRadius=t.xRadius,this.yRadius=t.yRadius,this.aStartAngle=t.aStartAngle,this.aEndAngle=t.aEndAngle,this.aClockwise=t.aClockwise,this.aRotation=t.aRotation,this}toJSON(){const t=super.toJSON();return t.aX=this.aX,t.aY=this.aY,t.xRadius=this.xRadius,t.yRadius=this.yRadius,t.aStartAngle=this.aStartAngle,t.aEndAngle=this.aEndAngle,t.aClockwise=this.aClockwise,t.aRotation=this.aRotation,t}fromJSON(t){return super.fromJSON(t),this.aX=t.aX,this.aY=t.aY,this.xRadius=t.xRadius,this.yRadius=t.yRadius,this.aStartAngle=t.aStartAngle,this.aEndAngle=t.aEndAngle,this.aClockwise=t.aClockwise,this.aRotation=t.aRotation,this}}class gg extends vo{constructor(t,e,n,s,r,a){super(t,e,n,n,s,r,a),this.isArcCurve=!0,this.type="ArcCurve"}}function xo(){let i=0,t=0,e=0,n=0;function s(r,a,o,c){i=r,t=o,e=-3*r+3*a-2*o-c,n=2*r-2*a+o+c}return{initCatmullRom:function(r,a,o,c,l){s(a,o,l*(o-r),l*(c-a))},initNonuniformCatmullRom:function(r,a,o,c,l,h,u){let f=(a-r)/l-(o-r)/(l+h)+(o-a)/h,p=(o-a)/h-(c-a)/(h+u)+(c-o)/u;f*=h,p*=h,s(a,o,f,p)},calc:function(r){const a=r*r,o=a*r;return i+t*r+e*a+n*o}}}const Hs=new R,Zr=new xo,Jr=new xo,jr=new xo;class _g extends fn{constructor(t=[],e=!1,n="centripetal",s=.5){super(),this.isCatmullRomCurve3=!0,this.type="CatmullRomCurve3",this.points=t,this.closed=e,this.curveType=n,this.tension=s}getPoint(t,e=new R){const n=e,s=this.points,r=s.length,a=(r-(this.closed?0:1))*t;let o=Math.floor(a),c=a-o;this.closed?o+=o>0?0:(Math.floor(Math.abs(o)/r)+1)*r:c===0&&o===r-1&&(o=r-2,c=1);let l,h;this.closed||o>0?l=s[(o-1)%r]:(Hs.subVectors(s[0],s[1]).add(s[0]),l=Hs);const u=s[o%r],f=s[(o+1)%r];if(this.closed||o+2<r?h=s[(o+2)%r]:(Hs.subVectors(s[r-1],s[r-2]).add(s[r-1]),h=Hs),this.curveType==="centripetal"||this.curveType==="chordal"){const p=this.curveType==="chordal"?.5:.25;let _=Math.pow(l.distanceToSquared(u),p),v=Math.pow(u.distanceToSquared(f),p),m=Math.pow(f.distanceToSquared(h),p);v<1e-4&&(v=1),_<1e-4&&(_=v),m<1e-4&&(m=v),Zr.initNonuniformCatmullRom(l.x,u.x,f.x,h.x,_,v,m),Jr.initNonuniformCatmullRom(l.y,u.y,f.y,h.y,_,v,m),jr.initNonuniformCatmullRom(l.z,u.z,f.z,h.z,_,v,m)}else this.curveType==="catmullrom"&&(Zr.initCatmullRom(l.x,u.x,f.x,h.x,this.tension),Jr.initCatmullRom(l.y,u.y,f.y,h.y,this.tension),jr.initCatmullRom(l.z,u.z,f.z,h.z,this.tension));return n.set(Zr.calc(c),Jr.calc(c),jr.calc(c)),n}copy(t){super.copy(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){const s=t.points[e];this.points.push(s.clone())}return this.closed=t.closed,this.curveType=t.curveType,this.tension=t.tension,this}toJSON(){const t=super.toJSON();t.points=[];for(let e=0,n=this.points.length;e<n;e++){const s=this.points[e];t.points.push(s.toArray())}return t.closed=this.closed,t.curveType=this.curveType,t.tension=this.tension,t}fromJSON(t){super.fromJSON(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){const s=t.points[e];this.points.push(new R().fromArray(s))}return this.closed=t.closed,this.curveType=t.curveType,this.tension=t.tension,this}}function Lc(i,t,e,n,s){const r=(n-t)*.5,a=(s-e)*.5,o=i*i,c=i*o;return(2*e-2*n+r+a)*c+(-3*e+3*n-2*r-a)*o+r*i+e}function vg(i,t){const e=1-i;return e*e*t}function xg(i,t){return 2*(1-i)*i*t}function Mg(i,t){return i*i*t}function as(i,t,e,n){return vg(i,t)+xg(i,e)+Mg(i,n)}function yg(i,t){const e=1-i;return e*e*e*t}function Sg(i,t){const e=1-i;return 3*e*e*i*t}function Eg(i,t){return 3*(1-i)*i*i*t}function Tg(i,t){return i*i*i*t}function os(i,t,e,n,s){return yg(i,t)+Sg(i,e)+Eg(i,n)+Tg(i,s)}class kl extends fn{constructor(t=new at,e=new at,n=new at,s=new at){super(),this.isCubicBezierCurve=!0,this.type="CubicBezierCurve",this.v0=t,this.v1=e,this.v2=n,this.v3=s}getPoint(t,e=new at){const n=e,s=this.v0,r=this.v1,a=this.v2,o=this.v3;return n.set(os(t,s.x,r.x,a.x,o.x),os(t,s.y,r.y,a.y,o.y)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this.v3.copy(t.v3),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t.v3=this.v3.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this.v3.fromArray(t.v3),this}}class bg extends fn{constructor(t=new R,e=new R,n=new R,s=new R){super(),this.isCubicBezierCurve3=!0,this.type="CubicBezierCurve3",this.v0=t,this.v1=e,this.v2=n,this.v3=s}getPoint(t,e=new R){const n=e,s=this.v0,r=this.v1,a=this.v2,o=this.v3;return n.set(os(t,s.x,r.x,a.x,o.x),os(t,s.y,r.y,a.y,o.y),os(t,s.z,r.z,a.z,o.z)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this.v3.copy(t.v3),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t.v3=this.v3.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this.v3.fromArray(t.v3),this}}class Hl extends fn{constructor(t=new at,e=new at){super(),this.isLineCurve=!0,this.type="LineCurve",this.v1=t,this.v2=e}getPoint(t,e=new at){const n=e;return t===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(t).add(this.v1)),n}getPointAt(t,e){return this.getPoint(t,e)}getTangent(t,e=new at){return e.subVectors(this.v2,this.v1).normalize()}getTangentAt(t,e){return this.getTangent(t,e)}copy(t){return super.copy(t),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class Ag extends fn{constructor(t=new R,e=new R){super(),this.isLineCurve3=!0,this.type="LineCurve3",this.v1=t,this.v2=e}getPoint(t,e=new R){const n=e;return t===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(t).add(this.v1)),n}getPointAt(t,e){return this.getPoint(t,e)}getTangent(t,e=new R){return e.subVectors(this.v2,this.v1).normalize()}getTangentAt(t,e){return this.getTangent(t,e)}copy(t){return super.copy(t),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class Gl extends fn{constructor(t=new at,e=new at,n=new at){super(),this.isQuadraticBezierCurve=!0,this.type="QuadraticBezierCurve",this.v0=t,this.v1=e,this.v2=n}getPoint(t,e=new at){const n=e,s=this.v0,r=this.v1,a=this.v2;return n.set(as(t,s.x,r.x,a.x),as(t,s.y,r.y,a.y)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class wg extends fn{constructor(t=new R,e=new R,n=new R){super(),this.isQuadraticBezierCurve3=!0,this.type="QuadraticBezierCurve3",this.v0=t,this.v1=e,this.v2=n}getPoint(t,e=new R){const n=e,s=this.v0,r=this.v1,a=this.v2;return n.set(as(t,s.x,r.x,a.x),as(t,s.y,r.y,a.y),as(t,s.z,r.z,a.z)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class Vl extends fn{constructor(t=[]){super(),this.isSplineCurve=!0,this.type="SplineCurve",this.points=t}getPoint(t,e=new at){const n=e,s=this.points,r=(s.length-1)*t,a=Math.floor(r),o=r-a,c=s[a===0?a:a-1],l=s[a],h=s[a>s.length-2?s.length-1:a+1],u=s[a>s.length-3?s.length-1:a+2];return n.set(Lc(o,c.x,l.x,h.x,u.x),Lc(o,c.y,l.y,h.y,u.y)),n}copy(t){super.copy(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){const s=t.points[e];this.points.push(s.clone())}return this}toJSON(){const t=super.toJSON();t.points=[];for(let e=0,n=this.points.length;e<n;e++){const s=this.points[e];t.points.push(s.toArray())}return t}fromJSON(t){super.fromJSON(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){const s=t.points[e];this.points.push(new at().fromArray(s))}return this}}var Dc=Object.freeze({__proto__:null,ArcCurve:gg,CatmullRomCurve3:_g,CubicBezierCurve:kl,CubicBezierCurve3:bg,EllipseCurve:vo,LineCurve:Hl,LineCurve3:Ag,QuadraticBezierCurve:Gl,QuadraticBezierCurve3:wg,SplineCurve:Vl});class Rg extends fn{constructor(){super(),this.type="CurvePath",this.curves=[],this.autoClose=!1}add(t){this.curves.push(t)}closePath(){const t=this.curves[0].getPoint(0),e=this.curves[this.curves.length-1].getPoint(1);if(!t.equals(e)){const n=t.isVector2===!0?"LineCurve":"LineCurve3";this.curves.push(new Dc[n](e,t))}return this}getPoint(t,e){const n=t*this.getLength(),s=this.getCurveLengths();let r=0;for(;r<s.length;){if(s[r]>=n){const a=s[r]-n,o=this.curves[r],c=o.getLength(),l=c===0?0:1-a/c;return o.getPointAt(l,e)}r++}return null}getLength(){const t=this.getCurveLengths();return t[t.length-1]}updateArcLengths(){this.needsUpdate=!0,this.cacheLengths=null,this.getCurveLengths()}getCurveLengths(){if(this.cacheLengths&&this.cacheLengths.length===this.curves.length)return this.cacheLengths;const t=[];let e=0;for(let n=0,s=this.curves.length;n<s;n++)e+=this.curves[n].getLength(),t.push(e);return this.cacheLengths=t,t}getSpacedPoints(t=40){const e=[];for(let n=0;n<=t;n++)e.push(this.getPoint(n/t));return this.autoClose&&e.push(e[0]),e}getPoints(t=12){const e=[];let n;for(let s=0,r=this.curves;s<r.length;s++){const a=r[s],o=a.isEllipseCurve?t*2:a.isLineCurve||a.isLineCurve3?1:a.isSplineCurve?t*a.points.length:t,c=a.getPoints(o);for(let l=0;l<c.length;l++){const h=c[l];n&&n.equals(h)||(e.push(h),n=h)}}return this.autoClose&&e.length>1&&!e[e.length-1].equals(e[0])&&e.push(e[0]),e}copy(t){super.copy(t),this.curves=[];for(let e=0,n=t.curves.length;e<n;e++){const s=t.curves[e];this.curves.push(s.clone())}return this.autoClose=t.autoClose,this}toJSON(){const t=super.toJSON();t.autoClose=this.autoClose,t.curves=[];for(let e=0,n=this.curves.length;e<n;e++){const s=this.curves[e];t.curves.push(s.toJSON())}return t}fromJSON(t){super.fromJSON(t),this.autoClose=t.autoClose,this.curves=[];for(let e=0,n=t.curves.length;e<n;e++){const s=t.curves[e];this.curves.push(new Dc[s.type]().fromJSON(s))}return this}}class Cg extends Rg{constructor(t){super(),this.type="Path",this.currentPoint=new at,t&&this.setFromPoints(t)}setFromPoints(t){this.moveTo(t[0].x,t[0].y);for(let e=1,n=t.length;e<n;e++)this.lineTo(t[e].x,t[e].y);return this}moveTo(t,e){return this.currentPoint.set(t,e),this}lineTo(t,e){const n=new Hl(this.currentPoint.clone(),new at(t,e));return this.curves.push(n),this.currentPoint.set(t,e),this}quadraticCurveTo(t,e,n,s){const r=new Gl(this.currentPoint.clone(),new at(t,e),new at(n,s));return this.curves.push(r),this.currentPoint.set(n,s),this}bezierCurveTo(t,e,n,s,r,a){const o=new kl(this.currentPoint.clone(),new at(t,e),new at(n,s),new at(r,a));return this.curves.push(o),this.currentPoint.set(r,a),this}splineThru(t){const e=[this.currentPoint.clone()].concat(t),n=new Vl(e);return this.curves.push(n),this.currentPoint.copy(t[t.length-1]),this}arc(t,e,n,s,r,a){const o=this.currentPoint.x,c=this.currentPoint.y;return this.absarc(t+o,e+c,n,s,r,a),this}absarc(t,e,n,s,r,a){return this.absellipse(t,e,n,n,s,r,a),this}ellipse(t,e,n,s,r,a,o,c){const l=this.currentPoint.x,h=this.currentPoint.y;return this.absellipse(t+l,e+h,n,s,r,a,o,c),this}absellipse(t,e,n,s,r,a,o,c){const l=new vo(t,e,n,s,r,a,o,c);if(this.curves.length>0){const u=l.getPoint(0);u.equals(this.currentPoint)||this.lineTo(u.x,u.y)}this.curves.push(l);const h=l.getPoint(1);return this.currentPoint.copy(h),this}copy(t){return super.copy(t),this.currentPoint.copy(t.currentPoint),this}toJSON(){const t=super.toJSON();return t.currentPoint=this.currentPoint.toArray(),t}fromJSON(t){return super.fromJSON(t),this.currentPoint.fromArray(t.currentPoint),this}}class Mo extends ze{constructor(t=[new at(0,-.5),new at(.5,0),new at(0,.5)],e=12,n=0,s=Math.PI*2){super(),this.type="LatheGeometry",this.parameters={points:t,segments:e,phiStart:n,phiLength:s},e=Math.floor(e),s=ve(s,0,Math.PI*2);const r=[],a=[],o=[],c=[],l=[],h=1/e,u=new R,f=new at,p=new R,_=new R,v=new R;let m=0,d=0;for(let T=0;T<=t.length-1;T++)switch(T){case 0:m=t[T+1].x-t[T].x,d=t[T+1].y-t[T].y,p.x=d*1,p.y=-m,p.z=d*0,v.copy(p),p.normalize(),c.push(p.x,p.y,p.z);break;case t.length-1:c.push(v.x,v.y,v.z);break;default:m=t[T+1].x-t[T].x,d=t[T+1].y-t[T].y,p.x=d*1,p.y=-m,p.z=d*0,_.copy(p),p.x+=v.x,p.y+=v.y,p.z+=v.z,p.normalize(),c.push(p.x,p.y,p.z),v.copy(_)}for(let T=0;T<=e;T++){const S=n+T*h*s,E=Math.sin(S),P=Math.cos(S);for(let b=0;b<=t.length-1;b++){u.x=t[b].x*E,u.y=t[b].y,u.z=t[b].x*P,a.push(u.x,u.y,u.z),f.x=T/e,f.y=b/(t.length-1),o.push(f.x,f.y);const w=c[3*b+0]*E,U=c[3*b+1],Y=c[3*b+0]*P;l.push(w,U,Y)}}for(let T=0;T<e;T++)for(let S=0;S<t.length-1;S++){const E=S+T*t.length,P=E,b=E+t.length,w=E+t.length+1,U=E+1;r.push(P,b,U),r.push(w,U,b)}this.setIndex(r),this.setAttribute("position",new oe(a,3)),this.setAttribute("uv",new oe(o,2)),this.setAttribute("normal",new oe(l,3))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new Mo(t.points,t.segments,t.phiStart,t.phiLength)}}class yo extends Mo{constructor(t=1,e=1,n=4,s=8){const r=new Cg;r.absarc(0,-e/2,t,Math.PI*1.5,0),r.absarc(0,e/2,t,0,Math.PI*.5),super(r.getPoints(n),s),this.type="CapsuleGeometry",this.parameters={radius:t,length:e,capSegments:n,radialSegments:s}}static fromJSON(t){return new yo(t.radius,t.length,t.capSegments,t.radialSegments)}}class So extends ze{constructor(t=1,e=32,n=0,s=Math.PI*2){super(),this.type="CircleGeometry",this.parameters={radius:t,segments:e,thetaStart:n,thetaLength:s},e=Math.max(3,e);const r=[],a=[],o=[],c=[],l=new R,h=new at;a.push(0,0,0),o.push(0,0,1),c.push(.5,.5);for(let u=0,f=3;u<=e;u++,f+=3){const p=n+u/e*s;l.x=t*Math.cos(p),l.y=t*Math.sin(p),a.push(l.x,l.y,l.z),o.push(0,0,1),h.x=(a[f]/t+1)/2,h.y=(a[f+1]/t+1)/2,c.push(h.x,h.y)}for(let u=1;u<=e;u++)r.push(u,u+1,0);this.setIndex(r),this.setAttribute("position",new oe(a,3)),this.setAttribute("normal",new oe(o,3)),this.setAttribute("uv",new oe(c,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new So(t.radius,t.segments,t.thetaStart,t.thetaLength)}}class $e extends ze{constructor(t=1,e=1,n=1,s=32,r=1,a=!1,o=0,c=Math.PI*2){super(),this.type="CylinderGeometry",this.parameters={radiusTop:t,radiusBottom:e,height:n,radialSegments:s,heightSegments:r,openEnded:a,thetaStart:o,thetaLength:c};const l=this;s=Math.floor(s),r=Math.floor(r);const h=[],u=[],f=[],p=[];let _=0;const v=[],m=n/2;let d=0;T(),a===!1&&(t>0&&S(!0),e>0&&S(!1)),this.setIndex(h),this.setAttribute("position",new oe(u,3)),this.setAttribute("normal",new oe(f,3)),this.setAttribute("uv",new oe(p,2));function T(){const E=new R,P=new R;let b=0;const w=(e-t)/n;for(let U=0;U<=r;U++){const Y=[],g=U/r,y=g*(e-t)+t;for(let O=0;O<=s;O++){const F=O/s,k=F*c+o,Z=Math.sin(k),H=Math.cos(k);P.x=y*Z,P.y=-g*n+m,P.z=y*H,u.push(P.x,P.y,P.z),E.set(Z,w,H).normalize(),f.push(E.x,E.y,E.z),p.push(F,1-g),Y.push(_++)}v.push(Y)}for(let U=0;U<s;U++)for(let Y=0;Y<r;Y++){const g=v[Y][U],y=v[Y+1][U],O=v[Y+1][U+1],F=v[Y][U+1];t>0&&(h.push(g,y,F),b+=3),e>0&&(h.push(y,O,F),b+=3)}l.addGroup(d,b,0),d+=b}function S(E){const P=_,b=new at,w=new R;let U=0;const Y=E===!0?t:e,g=E===!0?1:-1;for(let O=1;O<=s;O++)u.push(0,m*g,0),f.push(0,g,0),p.push(.5,.5),_++;const y=_;for(let O=0;O<=s;O++){const k=O/s*c+o,Z=Math.cos(k),H=Math.sin(k);w.x=Y*H,w.y=m*g,w.z=Y*Z,u.push(w.x,w.y,w.z),f.push(0,g,0),b.x=Z*.5+.5,b.y=H*.5*g+.5,p.push(b.x,b.y),_++}for(let O=0;O<s;O++){const F=P+O,k=y+O;E===!0?h.push(k,k+1,F):h.push(k+1,k,F),U+=3}l.addGroup(d,U,E===!0?1:2),d+=U}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new $e(t.radiusTop,t.radiusBottom,t.height,t.radialSegments,t.heightSegments,t.openEnded,t.thetaStart,t.thetaLength)}}class Eo extends ze{constructor(t=.5,e=1,n=32,s=1,r=0,a=Math.PI*2){super(),this.type="RingGeometry",this.parameters={innerRadius:t,outerRadius:e,thetaSegments:n,phiSegments:s,thetaStart:r,thetaLength:a},n=Math.max(3,n),s=Math.max(1,s);const o=[],c=[],l=[],h=[];let u=t;const f=(e-t)/s,p=new R,_=new at;for(let v=0;v<=s;v++){for(let m=0;m<=n;m++){const d=r+m/n*a;p.x=u*Math.cos(d),p.y=u*Math.sin(d),c.push(p.x,p.y,p.z),l.push(0,0,1),_.x=(p.x/e+1)/2,_.y=(p.y/e+1)/2,h.push(_.x,_.y)}u+=f}for(let v=0;v<s;v++){const m=v*(n+1);for(let d=0;d<n;d++){const T=d+m,S=T,E=T+n+1,P=T+n+2,b=T+1;o.push(S,E,b),o.push(E,P,b)}}this.setIndex(o),this.setAttribute("position",new oe(c,3)),this.setAttribute("normal",new oe(l,3)),this.setAttribute("uv",new oe(h,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new Eo(t.innerRadius,t.outerRadius,t.thetaSegments,t.phiSegments,t.thetaStart,t.thetaLength)}}class Vn extends ze{constructor(t=1,e=32,n=16,s=0,r=Math.PI*2,a=0,o=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:t,widthSegments:e,heightSegments:n,phiStart:s,phiLength:r,thetaStart:a,thetaLength:o},e=Math.max(3,Math.floor(e)),n=Math.max(2,Math.floor(n));const c=Math.min(a+o,Math.PI);let l=0;const h=[],u=new R,f=new R,p=[],_=[],v=[],m=[];for(let d=0;d<=n;d++){const T=[],S=d/n;let E=0;d===0&&a===0?E=.5/e:d===n&&c===Math.PI&&(E=-.5/e);for(let P=0;P<=e;P++){const b=P/e;u.x=-t*Math.cos(s+b*r)*Math.sin(a+S*o),u.y=t*Math.cos(a+S*o),u.z=t*Math.sin(s+b*r)*Math.sin(a+S*o),_.push(u.x,u.y,u.z),f.copy(u).normalize(),v.push(f.x,f.y,f.z),m.push(b+E,1-S),T.push(l++)}h.push(T)}for(let d=0;d<n;d++)for(let T=0;T<e;T++){const S=h[d][T+1],E=h[d][T],P=h[d+1][T],b=h[d+1][T+1];(d!==0||a>0)&&p.push(S,E,b),(d!==n-1||c<Math.PI)&&p.push(E,P,b)}this.setIndex(p),this.setAttribute("position",new oe(_,3)),this.setAttribute("normal",new oe(v,3)),this.setAttribute("uv",new oe(m,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new Vn(t.radius,t.widthSegments,t.heightSegments,t.phiStart,t.phiLength,t.thetaStart,t.thetaLength)}}class ue extends Vi{constructor(t){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new Ft(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Ft(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=xl,this.normalScale=new at(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new un,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.defines={STANDARD:""},this.color.copy(t.color),this.roughness=t.roughness,this.metalness=t.metalness,this.map=t.map,this.lightMap=t.lightMap,this.lightMapIntensity=t.lightMapIntensity,this.aoMap=t.aoMap,this.aoMapIntensity=t.aoMapIntensity,this.emissive.copy(t.emissive),this.emissiveMap=t.emissiveMap,this.emissiveIntensity=t.emissiveIntensity,this.bumpMap=t.bumpMap,this.bumpScale=t.bumpScale,this.normalMap=t.normalMap,this.normalMapType=t.normalMapType,this.normalScale.copy(t.normalScale),this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this.roughnessMap=t.roughnessMap,this.metalnessMap=t.metalnessMap,this.alphaMap=t.alphaMap,this.envMap=t.envMap,this.envMapRotation.copy(t.envMapRotation),this.envMapIntensity=t.envMapIntensity,this.wireframe=t.wireframe,this.wireframeLinewidth=t.wireframeLinewidth,this.wireframeLinecap=t.wireframeLinecap,this.wireframeLinejoin=t.wireframeLinejoin,this.flatShading=t.flatShading,this.fog=t.fog,this}}class Qr extends ue{constructor(t){super(),this.isMeshPhysicalMaterial=!0,this.defines={STANDARD:"",PHYSICAL:""},this.type="MeshPhysicalMaterial",this.anisotropyRotation=0,this.anisotropyMap=null,this.clearcoatMap=null,this.clearcoatRoughness=0,this.clearcoatRoughnessMap=null,this.clearcoatNormalScale=new at(1,1),this.clearcoatNormalMap=null,this.ior=1.5,Object.defineProperty(this,"reflectivity",{get:function(){return ve(2.5*(this.ior-1)/(this.ior+1),0,1)},set:function(e){this.ior=(1+.4*e)/(1-.4*e)}}),this.iridescenceMap=null,this.iridescenceIOR=1.3,this.iridescenceThicknessRange=[100,400],this.iridescenceThicknessMap=null,this.sheenColor=new Ft(0),this.sheenColorMap=null,this.sheenRoughness=1,this.sheenRoughnessMap=null,this.transmissionMap=null,this.thickness=0,this.thicknessMap=null,this.attenuationDistance=1/0,this.attenuationColor=new Ft(1,1,1),this.specularIntensity=1,this.specularIntensityMap=null,this.specularColor=new Ft(1,1,1),this.specularColorMap=null,this._anisotropy=0,this._clearcoat=0,this._dispersion=0,this._iridescence=0,this._sheen=0,this._transmission=0,this.setValues(t)}get anisotropy(){return this._anisotropy}set anisotropy(t){this._anisotropy>0!=t>0&&this.version++,this._anisotropy=t}get clearcoat(){return this._clearcoat}set clearcoat(t){this._clearcoat>0!=t>0&&this.version++,this._clearcoat=t}get iridescence(){return this._iridescence}set iridescence(t){this._iridescence>0!=t>0&&this.version++,this._iridescence=t}get dispersion(){return this._dispersion}set dispersion(t){this._dispersion>0!=t>0&&this.version++,this._dispersion=t}get sheen(){return this._sheen}set sheen(t){this._sheen>0!=t>0&&this.version++,this._sheen=t}get transmission(){return this._transmission}set transmission(t){this._transmission>0!=t>0&&this.version++,this._transmission=t}copy(t){return super.copy(t),this.defines={STANDARD:"",PHYSICAL:""},this.anisotropy=t.anisotropy,this.anisotropyRotation=t.anisotropyRotation,this.anisotropyMap=t.anisotropyMap,this.clearcoat=t.clearcoat,this.clearcoatMap=t.clearcoatMap,this.clearcoatRoughness=t.clearcoatRoughness,this.clearcoatRoughnessMap=t.clearcoatRoughnessMap,this.clearcoatNormalMap=t.clearcoatNormalMap,this.clearcoatNormalScale.copy(t.clearcoatNormalScale),this.dispersion=t.dispersion,this.ior=t.ior,this.iridescence=t.iridescence,this.iridescenceMap=t.iridescenceMap,this.iridescenceIOR=t.iridescenceIOR,this.iridescenceThicknessRange=[...t.iridescenceThicknessRange],this.iridescenceThicknessMap=t.iridescenceThicknessMap,this.sheen=t.sheen,this.sheenColor.copy(t.sheenColor),this.sheenColorMap=t.sheenColorMap,this.sheenRoughness=t.sheenRoughness,this.sheenRoughnessMap=t.sheenRoughnessMap,this.transmission=t.transmission,this.transmissionMap=t.transmissionMap,this.thickness=t.thickness,this.thicknessMap=t.thicknessMap,this.attenuationDistance=t.attenuationDistance,this.attenuationColor.copy(t.attenuationColor),this.specularIntensity=t.specularIntensity,this.specularIntensityMap=t.specularIntensityMap,this.specularColor.copy(t.specularColor),this.specularColorMap=t.specularColorMap,this}}class To extends xe{constructor(t,e=1){super(),this.isLight=!0,this.type="Light",this.color=new Ft(t),this.intensity=e}dispose(){}copy(t,e){return super.copy(t,e),this.color.copy(t.color),this.intensity=t.intensity,this}toJSON(t){const e=super.toJSON(t);return e.object.color=this.color.getHex(),e.object.intensity=this.intensity,this.groundColor!==void 0&&(e.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(e.object.distance=this.distance),this.angle!==void 0&&(e.object.angle=this.angle),this.decay!==void 0&&(e.object.decay=this.decay),this.penumbra!==void 0&&(e.object.penumbra=this.penumbra),this.shadow!==void 0&&(e.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(e.object.target=this.target.uuid),e}}class Pg extends To{constructor(t,e,n){super(t,n),this.isHemisphereLight=!0,this.type="HemisphereLight",this.position.copy(xe.DEFAULT_UP),this.updateMatrix(),this.groundColor=new Ft(e)}copy(t,e){return super.copy(t,e),this.groundColor.copy(t.groundColor),this}}const ta=new ne,Ic=new R,Uc=new R;class Wl{constructor(t){this.camera=t,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new at(512,512),this.map=null,this.mapPass=null,this.matrix=new ne,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new fo,this._frameExtents=new at(1,1),this._viewportCount=1,this._viewports=[new te(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(t){const e=this.camera,n=this.matrix;Ic.setFromMatrixPosition(t.matrixWorld),e.position.copy(Ic),Uc.setFromMatrixPosition(t.target.matrixWorld),e.lookAt(Uc),e.updateMatrixWorld(),ta.multiplyMatrices(e.projectionMatrix,e.matrixWorldInverse),this._frustum.setFromProjectionMatrix(ta),n.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),n.multiply(ta)}getViewport(t){return this._viewports[t]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(t){return this.camera=t.camera.clone(),this.intensity=t.intensity,this.bias=t.bias,this.radius=t.radius,this.mapSize.copy(t.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const t={};return this.intensity!==1&&(t.intensity=this.intensity),this.bias!==0&&(t.bias=this.bias),this.normalBias!==0&&(t.normalBias=this.normalBias),this.radius!==1&&(t.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(t.mapSize=this.mapSize.toArray()),t.camera=this.camera.toJSON(!1).object,delete t.camera.matrix,t}}const Nc=new ne,ts=new R,ea=new R;class Lg extends Wl{constructor(){super(new Fe(90,1,.5,500)),this.isPointLightShadow=!0,this._frameExtents=new at(4,2),this._viewportCount=6,this._viewports=[new te(2,1,1,1),new te(0,1,1,1),new te(3,1,1,1),new te(1,1,1,1),new te(3,0,1,1),new te(1,0,1,1)],this._cubeDirections=[new R(1,0,0),new R(-1,0,0),new R(0,0,1),new R(0,0,-1),new R(0,1,0),new R(0,-1,0)],this._cubeUps=[new R(0,1,0),new R(0,1,0),new R(0,1,0),new R(0,1,0),new R(0,0,1),new R(0,0,-1)]}updateMatrices(t,e=0){const n=this.camera,s=this.matrix,r=t.distance||n.far;r!==n.far&&(n.far=r,n.updateProjectionMatrix()),ts.setFromMatrixPosition(t.matrixWorld),n.position.copy(ts),ea.copy(n.position),ea.add(this._cubeDirections[e]),n.up.copy(this._cubeUps[e]),n.lookAt(ea),n.updateMatrixWorld(),s.makeTranslation(-ts.x,-ts.y,-ts.z),Nc.multiplyMatrices(n.projectionMatrix,n.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Nc)}}class rs extends To{constructor(t,e,n=0,s=2){super(t,e),this.isPointLight=!0,this.type="PointLight",this.distance=n,this.decay=s,this.shadow=new Lg}get power(){return this.intensity*4*Math.PI}set power(t){this.intensity=t/(4*Math.PI)}dispose(){this.shadow.dispose()}copy(t,e){return super.copy(t,e),this.distance=t.distance,this.decay=t.decay,this.shadow=t.shadow.clone(),this}}class Dg extends Wl{constructor(){super(new Dl(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class Ig extends To{constructor(t,e){super(t,e),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(xe.DEFAULT_UP),this.updateMatrix(),this.target=new xe,this.shadow=new Dg}dispose(){this.shadow.dispose()}copy(t){return super.copy(t),this.target=t.target.clone(),this.shadow=t.shadow.clone(),this}}class Ug{constructor(t=!0){this.autoStart=t,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=Oc(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let t=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const e=Oc();t=(e-this.oldTime)/1e3,this.oldTime=e,this.elapsedTime+=t}return t}}function Oc(){return performance.now()}const Fc=new ne;class Ng{constructor(t,e,n=0,s=1/0){this.ray=new Tl(t,e),this.near=n,this.far=s,this.camera=null,this.layers=new uo,this.params={Mesh:{},Line:{threshold:1},LOD:{},Points:{threshold:1},Sprite:{}}}set(t,e){this.ray.set(t,e)}setFromCamera(t,e){e.isPerspectiveCamera?(this.ray.origin.setFromMatrixPosition(e.matrixWorld),this.ray.direction.set(t.x,t.y,.5).unproject(e).sub(this.ray.origin).normalize(),this.camera=e):e.isOrthographicCamera?(this.ray.origin.set(t.x,t.y,(e.near+e.far)/(e.near-e.far)).unproject(e),this.ray.direction.set(0,0,-1).transformDirection(e.matrixWorld),this.camera=e):console.error("THREE.Raycaster: Unsupported camera type: "+e.type)}setFromXRController(t){return Fc.identity().extractRotation(t.matrixWorld),this.ray.origin.setFromMatrixPosition(t.matrixWorld),this.ray.direction.set(0,0,-1).applyMatrix4(Fc),this}intersectObject(t,e=!0,n=[]){return ja(t,this,n,e),n.sort(zc),n}intersectObjects(t,e=!0,n=[]){for(let s=0,r=t.length;s<r;s++)ja(t[s],this,n,e);return n.sort(zc),n}}function zc(i,t){return i.distance-t.distance}function ja(i,t,e,n){let s=!0;if(i.layers.test(t.layers)&&i.raycast(t,e)===!1&&(s=!1),s===!0&&n===!0){const r=i.children;for(let a=0,o=r.length;a<o;a++)ja(r[a],t,e,!0)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:no}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=no);function us(i,t,e,n,s,r){Bc(i,i.x+t,i.z,n,s,r),Bc(i,i.x,i.z+e,n,s,r)}function Xl(i,t,e,n,s,r,a,o){let c=0,l=1;const h=e-i,u=n-t,f=(p,_)=>{if(p===0)return _>=0;const v=_/p;if(p<0){if(v>l)return!1;v>c&&(c=v)}else{if(v<c)return!1;v<l&&(l=v)}return!0};return f(-h,i-s)&&f(h,a-i)&&f(-u,t-r)&&f(u,o-t)?c<=l:!1}function Qa(i,t,e,n,s,r,a){let o=0,c=1;const l=n-i,h=s-t,u=r-e,f=(p,_)=>{if(p===0)return _>=0;const v=_/p;if(p<0){if(v>c)return!1;v>o&&(o=v)}else{if(v<o)return!1;v<c&&(c=v)}return!0};return f(-l,i-a.min.x)&&f(l,a.max.x-i)&&f(-h,t-a.min.y)&&f(h,a.max.y-t)&&f(-u,e-a.min.z)&&f(u,a.max.z-e)&&o<=c?o:1/0}function Li(i,t,e,n=1.4,s=1.1){const r=(i.y||0)+n,a=(t.y||0)+s;for(const o of e)if(Qa(i.x,r,i.z,t.x,a,t.z,o)<1/0)return!1;return!0}function Bc(i,t,e,n,s,r){if(!(t<r.minX||t>r.maxX||e<r.minZ||e>r.maxZ)){for(const a of n)if(t>a.min.x-s&&t<a.max.x+s&&e>a.min.z-s&&e<a.max.z+s){if(i.x>a.min.x-s&&i.x<a.max.x+s&&i.z>a.min.z-s&&i.z<a.max.z+s)continue;return}i.x=t,i.z=e}}const kc=Math.SQRT2;class Og{constructor(t,e,n=1,s=.65){this.bounds=t,this.cell=n,this.w=Math.ceil((t.maxX-t.minX)/n),this.h=Math.ceil((t.maxZ-t.minZ)/n);const r=this.w*this.h;this.blocked=new Uint8Array(r);for(let a=0;a<this.h;a++)for(let o=0;o<this.w;o++){const c=t.minX+(o+.5)*n,l=t.minZ+(a+.5)*n;for(const h of e)if(c>h.min.x-s&&c<h.max.x+s&&l>h.min.z-s&&l<h.max.z+s){this.blocked[a*this.w+o]=1;break}}this._g=new Float64Array(r),this._f=new Float64Array(r),this._parent=new Int32Array(r),this._seen=new Int32Array(r),this._closed=new Int32Array(r),this._stamp=0,this._heap=[]}_gx(t){return Math.max(0,Math.min(this.w-1,Math.floor((t-this.bounds.minX)/this.cell)))}_gz(t){return Math.max(0,Math.min(this.h-1,Math.floor((t-this.bounds.minZ)/this.cell)))}_wx(t){return this.bounds.minX+(t+.5)*this.cell}_wz(t){return this.bounds.minZ+(t+.5)*this.cell}blockedAt(t,e){return!!this.blocked[this._gz(e)*this.w+this._gx(t)]}nearestOpen(t,e){const n=this._gx(t),s=this._gz(e);if(!this.blocked[s*this.w+n])return{x:t,z:e};for(let r=1;r<=14;r++)for(let a=-r;a<=r;a++)for(let o=-r;o<=r;o++){if(Math.max(Math.abs(o),Math.abs(a))!==r)continue;const c=n+o,l=s+a;if(!(c<0||l<0||c>=this.w||l>=this.h)&&!this.blocked[l*this.w+c])return{x:this._wx(c),z:this._wz(l)}}return{x:t,z:e}}isClear(t,e,n,s){const r=Math.hypot(n-t,s-e),a=Math.max(1,Math.ceil(r/(this.cell*.5)));for(let o=0;o<=a;o++){const c=o/a;if(this.blockedAt(t+(n-t)*c,e+(s-e)*c))return!1}return!0}_push(t){const e=this._heap,n=this._f;e.push(t);let s=e.length-1;for(;s>0;){const r=s-1>>1;if(n[e[r]]<=n[e[s]])break;[e[r],e[s]]=[e[s],e[r]],s=r}}_pop(){const t=this._heap,e=this._f,n=t[0],s=t.pop();if(t.length){t[0]=s;let r=0;for(;;){const a=r*2+1,o=a+1;let c=r;if(a<t.length&&e[t[a]]<e[t[c]]&&(c=a),o<t.length&&e[t[o]]<e[t[c]]&&(c=o),c===r)break;[t[r],t[c]]=[t[c],t[r]],r=c}}return n}findPath(t,e,n,s){const r=this.w,a=this.h;let o=this._gx(t),c=this._gz(e),l=this._gx(n),h=this._gz(s);if(this.blocked[c*r+o]){const g=this.nearestOpen(t,e);o=this._gx(g.x),c=this._gz(g.z)}if(this.blocked[h*r+l]){const g=this.nearestOpen(n,s);l=this._gx(g.x),h=this._gz(g.z)}const u=c*r+o,f=h*r+l;if(this.blocked[u]||this.blocked[f])return null;if(u===f)return[{x:this._wx(l),z:this._wz(h)}];const p=++this._stamp,_=this._g,v=this._f,m=this._parent,d=this._seen,T=this._closed;this._heap.length=0;const S=g=>{const y=Math.abs(g%r-l),O=Math.abs((g/r|0)-h);return Math.min(y,O)*kc+Math.abs(y-O)};_[u]=0,v[u]=S(u),m[u]=-1,d[u]=p,this._push(u);let E=!1,P=4e4;for(;this._heap.length&&P-- >0;){const g=this._pop();if(T[g]===p)continue;if(T[g]=p,g===f){E=!0;break}const y=g%r,O=g/r|0;for(let F=-1;F<=1;F++)for(let k=-1;k<=1;k++){if(k===0&&F===0)continue;const Z=y+k,H=O+F;if(Z<0||H<0||Z>=r||H>=a)continue;const J=H*r+Z;if(this.blocked[J]||T[J]===p||k!==0&&F!==0&&(this.blocked[O*r+Z]||this.blocked[H*r+y]))continue;const V=_[g]+(k!==0&&F!==0?kc:1);(d[J]!==p||V<_[J])&&(d[J]=p,_[J]=V,v[J]=V+S(J),m[J]=g,this._push(J))}}if(!E)return null;const b=[];for(let g=f;g!==-1;g=m[g])b.push(g);b.reverse();const w=[];for(let g=0;g<b.length;g++){if(g>0&&g<b.length-1){const y=b[g-1],O=b[g],F=b[g+1],k=O%r-y%r,Z=(O/r|0)-(y/r|0),H=F%r-O%r,J=(F/r|0)-(O/r|0);if(k===H&&Z===J)continue}w.push({x:this._wx(b[g]%r),z:this._wz(b[g]/r|0)})}const U=[];let Y=0;for(;Y<w.length-1;){let g=w.length-1;for(;g>Y+1&&!this.isClear(w[Y].x,w[Y].z,w[g].x,w[g].z);)g--;U.push(w[g]),Y=g}return U.length?U:[w[w.length-1]]}}function Ci(i,t,e,n,s,r,a,o,c){const l=s*r;let h,u;if(i.isClear(e.x,e.z,n.x,n.z))t._navPath=null,h=n.x,u=n.z;else{const d=t._navPath&&Math.hypot(n.x-t._navGoalX,n.z-t._navGoalZ)>2;if((!t._navPath||d)&&(t._navPath=i.findPath(e.x,e.z,n.x,n.z),t._navGoalX=n.x,t._navGoalZ=n.z,!t._navPath))return null;const T=t._navPath;for(;T.length>1&&Math.hypot(T[0].x-e.x,T[0].z-e.z)<.8;)T.shift();h=T[0].x,u=T[0].z}const f=h-e.x,p=u-e.z,_=Math.hypot(f,p);if(_<1e-4)return null;const v=e.x,m=e.z;return us(e,f/_*Math.min(l,_),p/_*Math.min(l,_),a,o,c),Math.hypot(e.x-v,e.z-m)<l*.25?(t._navStuck=(t._navStuck||0)+r,t._navStuck>.5&&(t._navPath=null,t._navStuck=0)):t._navStuck=0,{x:f/_,z:p/_}}const we=1.4,q=we;function Fg(i="house"){const t=Vg[i];if(!t)throw new Error(`unknown world: ${i}`);return t()}function hr(i,t,e=1,n=1){const s=document.createElement("canvas");s.width=s.height=i,t(s.getContext("2d"),i);const r=new _o(s);return r.wrapS=r.wrapT=tr,r.repeat.set(e,n),r.colorSpace=He,r.anisotropy=4,r}function zg(){return hr(512,(i,t)=>{i.fillStyle="#7a5028",i.fillRect(0,0,t,t);const e=6;for(let n=0;n<e;n++){const s=n/e*t,r=t/e,a=18-Math.abs(n*73%37-18);i.fillStyle=`rgb(${112+a},${74+a*.7},${38+a*.4})`,i.fillRect(0,s,t,r),i.strokeStyle="rgba(60,35,12,0.25)",i.lineWidth=1.5;for(let c=0;c<7;c++){i.beginPath();const l=s+(c+.5)*(r/7)+Math.sin(n*5+c)*2;i.moveTo(0,l);for(let h=0;h<=t;h+=32)i.lineTo(h,l+Math.sin(h*.02+n*9+c*3)*2.5);i.stroke()}i.fillStyle="rgba(35,18,5,0.85)",i.fillRect(0,s,t,3);const o=n*197%t;i.fillRect(o,s,3,r)}},17,11)}function Bg(){return hr(512,(i,t)=>{const e=t/2,n=t/2;i.fillStyle="#6e1c18",i.fillRect(0,0,t,t);const s=[[t*.485,"#caa24a",t*.02],[t*.44,"#2a2f55",t*.012],[t*.3,"#caa24a",t*.014],[t*.2,"#d8cfae",t*.01],[t*.09,"#2a2f55",t*.05]];for(const[r,a,o]of s)i.strokeStyle=a,i.lineWidth=o,i.beginPath(),i.arc(e,n,r,0,Math.PI*2),i.stroke();for(let r=0;r<4e3;r++){const a=Math.random()*t,o=Math.random()*t;i.fillStyle=`rgba(0,0,0,${Math.random()*.08})`,i.fillRect(a,o,2,1)}})}function kg(){return hr(256,(i,t)=>{i.fillStyle="#cfc5ae",i.fillRect(0,0,t,t),i.fillStyle="rgba(176,164,138,0.5)";for(let e=0;e<t;e+=32)i.fillRect(e,0,14,t);for(let e=0;e<600;e++)i.fillStyle=`rgba(110,100,80,${Math.random()*.05})`,i.fillRect(Math.random()*t,Math.random()*t,2,2)},14,1.4)}function Hg(i){return hr(128,(t,e)=>{t.fillStyle=i,t.fillRect(0,0,e,e);for(let n=0;n<e;n+=3)t.fillStyle=`rgba(255,255,255,${n%6?.03:.05})`,t.fillRect(0,n,e,1);for(let n=0;n<e;n+=3)t.fillStyle="rgba(0,0,0,0.045)",t.fillRect(n,0,1,e)},5,5)}function Gg(){const i={minX:-6.5*q,maxX:153.5*q,minZ:-45*q,maxZ:45*q},t=new pg;t.background=new Ft(2305088),t.fog=new mo(2305088,30,110),t.add(new Pg(4608906,5784626,1.3));const e=new Ig(16757865,1.75);e.position.set(-84,64,25),e.castShadow=!0,e.shadow.mapSize.set(2048,2048),e.shadow.camera.left=-45,e.shadow.camera.right=240,e.shadow.camera.top=85,e.shadow.camera.bottom=-85,e.shadow.camera.far=460,e.shadow.bias=-4e-4,t.add(e);const n=[],s=[],r=(N,X,et,Q,_t,Mt,{y:bt,obstacle:Yt=!0,cover:zt=!1,rough:C=.85}={})=>{(X>=3||bt!==void 0&&bt>3)&&(N*=q,X*=q,et*=q),Q*=q,_t*=q,bt=bt!==void 0?bt*q:X/2;const It=new Ot(new ge(N,X,et),new ue({color:Mt,roughness:C}));if(It.position.set(Q,bt,_t),It.castShadow=!0,It.receiveShadow=!0,t.add(It),Yt&&n.push(new ln(new R(Q-N/2,0,_t-et/2),new R(Q+N/2,X,_t+et/2))),zt){const Bt=N/2+1.4,At=et/2+1.4;s.push(new R(Q+Bt,0,_t),new R(Q-Bt,0,_t),new R(Q,0,_t+At),new R(Q,0,_t-At))}return It},a=new Ot(new In(165*q,95*q),new ue({map:zg(),roughness:.62}));a.rotation.x=-Math.PI/2,a.position.set(73.5*q,0,0),a.receiveShadow=!0,t.add(a);const o=new Ot(new So(11*q,48),new ue({map:Bg(),roughness:.95}));o.rotation.x=-Math.PI/2,o.position.set(28*q,.02,0),o.scale.x=1.4,o.receiveShadow=!0,t.add(o);const c=new Ot(new In(61*q,45*q),new ue({color:11117721,roughness:.7}));c.rotation.x=-Math.PI/2,c.position.set(123.5*q,.015,-23*q),c.receiveShadow=!0,t.add(c);const l=new ue({map:kg(),roughness:.92}),h=new ue({color:15262418,roughness:.6}),u=(N,X,et,Q)=>{N*=q,X*=q,et*=q,Q*=q;const _t=12*q,Mt=new Ot(new ge(N,_t,X),l);Mt.position.set(et,_t/2,Q),Mt.castShadow=!0,Mt.receiveShadow=!0,t.add(Mt),n.push(new ln(new R(et-N/2,0,Q-X/2),new R(et+N/2,_t,Q+X/2)));const bt=new Ot(new ge(N+.16,.8,X+.16),h);bt.position.set(et,.4,Q),bt.receiveShadow=!0,t.add(bt)};u(1,92,-7.5,0),u(163,1,73.5,-46),u(89.5,1,35.75,46),u(66,1,121.5,46),u(1,92,154.5,0),u(1,60.5,76,-15.75),u(1,24.5,76,34.25),u(1,18,93,-37),u(1,40,93,0),u(1,18,93,37),u(61.5,1,124.25,0);const f=new ue({color:4165439,roughness:.5}),p=new Ot(new $e(1.6*q,1.1*q,9.5*q,14),f);p.position.set(-4.5*q,2.6*q,-9*q),p.rotation.z=1.15,p.rotation.y=.5,p.castShadow=!0,t.add(p);const _=new Ot(new ge(1.6*q,.22,10.5*q),f);_.position.set(-3.8*q,2.9*q,-8.6*q),_.rotation.y=.5,_.castShadow=!0,t.add(_);const v=new Ot(new ge(.18,2*q,1.4*q),f);v.position.set(-7.2*q,4.2*q,-11.4*q),v.castShadow=!0,t.add(v),n.push(new ln(new R(-7*q,0,-11*q),new R(-2*q,4*q,-7*q))),s.push(new R(-.5*q,0,-9*q),new R(-4.5*q,0,-5.5*q)),r(1.3,1.3,1.3,1.5,7.5,8014370,{cover:!0}),r(16,9,12,13,-15,11569746,{rough:.9}),r(9,4.2,8,18,-2,4871786,{cover:!0}),r(9,8.5,2.2,18,1.6,4871786),r(2.2,5.6,8,13.9,-2,4871786),r(2.2,5.6,8,22.1,-2,4871786),r(4.5,6.5,4.5,27,11,10098706,{cover:!0,rough:.35}),r(4,5,4,31.5,14,1718938,{cover:!0,rough:.35}),r(7,4.2,2.6,44,9,7216152,{cover:!0}),r(12,5.5,8,33,-22,12735546,{rough:.6}),r(5,7,5,60,-6,14208942,{cover:!0,rough:.7}),r(3.2,4.6,3.2,56,18,7031334,{cover:!0,rough:.7}),r(3.4,.5,.4,56,16.6,9075274,{y:4.85,obstacle:!1}),r(3.4,.5,.4,56,19.4,9075274,{y:4.85,obstacle:!1}),r(.4,.5,3.4,54.6,18,9075274,{y:4.85,obstacle:!1}),r(.4,.5,3.4,57.4,18,9075274,{y:4.85,obstacle:!1});const m=new ue({map:Hg("#3e4a5c"),roughness:.95}),d=(N,X,et,Q,_t,Mt)=>{N*=q,X*=q,et*=q,Q*=q,_t*=q,Mt*=q;const bt=new Ot(new ge(N,X,et),m);bt.position.set(Q,_t,Mt),bt.castShadow=bt.receiveShadow=!0,t.add(bt),n.push(new ln(new R(Q-N/2,0,Mt-et/2),new R(Q+N/2,_t+X/2,Mt+et/2)))};d(30,4.5,8,26,2.25,-41.5),d(30,10,2.2,26,5,-44.6),d(2.8,7.2,9,10.9,3.6,-41.5),d(2.8,7.2,9,41.1,3.6,-41.5),r(15,.8,10.5,28,3,2823945,{y:6.2,obstacle:!1});for(const[N,X]of[[21.8,-1.3],[34.2,-1.3],[21.8,7.3],[34.2,7.3]])r(1,5.8,1,N,X,2823945,{cover:!0});r(8,3.4,6,43,27,4082268,{cover:!0});const T=[10098706,1718938,10122770];[[11,-10,1.5],[15,6.5,1.7],[19.5,-17,1.4],[17.5,21,1.55],[34.5,-7,1.6],[39,9,1.35],[42,-21,1.8],[47,18,1.5],[51,-9,1.45],[24.5,-29,1.6],[54,25,1.4],[57,-24,1.5]].forEach(([N,X,et],Q)=>r(et,et,et,N,X,T[Q%3],{cover:!0,rough:.35})),r(3.2,.5,2.2,19,14,7216152,{obstacle:!1}),r(3,.45,2.1,36,-15,1858090,{obstacle:!1}),r(3.4,1.1,2.4,47,-18,1858090,{cover:!0}),r(1,9.5,12,74.2,0,2823945);for(let N=0;N<5;N++)r(.5,3,1.7,72.5,-6+N*3,N%2?1858090:7216152,{cover:!0});r(3.4,1.05,.9,44.5,-1.5,9075274,{cover:!0}),r(1.35,1.35,1.35,43.5,3.5,8014370,{cover:!0}),r(.9,1.05,3.4,62.5,-13,9075274,{cover:!0}),r(.9,1.05,3.4,63,0,9075274,{cover:!0}),r(.9,1.05,3.4,62.5,13,9075274,{cover:!0}),r(1.35,1.4,1.35,65,-6.5,8014370,{cover:!0}),r(1.35,1.4,1.35,65.2,7,8014370,{cover:!0}),r(1.8,.5,7,90.5,-5,2823945,{y:5,obstacle:!1}),r(1,5,1,90.5,-7.8,2823945,{cover:!0}),r(1,5,1,90.5,-2.2,2823945,{cover:!0}),r(1.4,1.4,1.4,81,-9,10098706,{cover:!0,rough:.35}),r(1.5,1.5,1.5,87.5,6,1718938,{cover:!0,rough:.35}),r(1.3,1.3,1.3,82.5,21,10122770,{cover:!0,rough:.35}),r(3,.45,2.1,85.5,-25,1858090,{obstacle:!1}),r(4,14.5,4.5,149,-39,13617597),r(9,.7,6,120,-23,2823945,{y:6.5,obstacle:!1});for(const[N,X]of[[116.3,-25.2],[123.7,-25.2],[116.3,-20.8],[123.7,-20.8]])r(.9,6.4,.9,N,X,2823945,{cover:!0});r(2.4,3.8,2.4,106.5,-15,2823945,{cover:!0}),r(1.5,1.5,1.5,115,-9,1718938,{cover:!0,rough:.35}),r(1.6,2.3,1.6,129,-8,5906456,{cover:!0}),r(1.3,1.4,1.3,138,-33,8014370,{cover:!0}),r(10,.65,5,126,23,2823945,{y:6.2,obstacle:!1});for(const[N,X]of[[121.7,21],[130.3,21],[121.7,25],[130.3,25]])r(.8,6.2,.8,N,X,2823945,{cover:!0});for(let N=0;N<3;N++)r(.5,3,1.7,112,33+N*3,N%2?7216152:1858090,{cover:!0});r(2.8,.42,2,118,15,7216152,{obstacle:!1}),r(1.6,1.6,1.6,136,12,10122770,{cover:!0,rough:.35}),r(1.3,1.3,1.3,103,26,10098706,{cover:!0,rough:.35});const S=new Ot(new $e(1.1*q,1.4*q,.4,16),new ue({color:3812380,roughness:.5}));S.position.set(50*q,.2,-36*q),S.castShadow=!0,t.add(S);const E=new Ot(new $e(.22,.22,12*q,10),new ue({color:3812380,roughness:.5}));E.position.set(50*q,6.2*q,-36*q),E.castShadow=!0,t.add(E);const P=new Ot(new $e(1.9*q,2.6*q,3.2*q,16,1,!0),new ue({color:15916206,roughness:.9,emissive:16767392,emissiveIntensity:.55,side:je}));P.position.set(50*q,12.2*q,-36*q),t.add(P);const b=new rs(16763018,130,64,1.8);b.position.set(50*q,11*q,-36*q),t.add(b);const w={alive:!0,pos:new R(50*q,0,-36*q),bulbY:11*q,radius:34,light:b,shade:P};n.push(new ln(new R(48.9*q,0,-36.6*q),new R(50.9*q,12*q,-35.4*q)));const U=new rs(16763018,52,45,1.8);U.position.set(126*q,12,30*q),t.add(U);const Y=new rs(13623551,38,42,1.8);Y.position.set(122*q,12,-24*q),t.add(Y);const g=new en({color:16757865}),y=new Ot(new In(11*q,7*q),g);y.position.set(-6.9*q,7*q,-9*q),y.rotation.y=Math.PI/2,t.add(y);for(const[N,X,et,Q]of[[12,.7,3.4,-9],[12,.7,10.6,-9],[.7,8,7,-14.6],[.7,8,7,-3.4],[.7,8,7,-9]]){const _t=new Ot(new ge(.6,X*q,(N===.7?.7:N)*q),new ue({color:4864044,roughness:.6}));_t.position.set(-6.8*q,et*q,Q*q),t.add(_t)}for(const[N,X]of[[14,3494026],[36,9069621],[58,4880970]]){const et=new Ot(new ge(5.4*q,4.2*q,.3),new ue({color:2824716,roughness:.5}));et.position.set(N*q,7.4*q,-45.3*q),t.add(et);const Q=new Ot(new In(4.4*q,3.2*q),new ue({color:X,roughness:.9}));Q.position.set(N*q,7.4*q,-45.1*q),t.add(Q)}const O={x:84.5*q,z:42.5*q,r:4.5*q},F=new Ot(new $e(O.r,O.r,.12,36),new en({color:4652906,transparent:!0,opacity:.3}));F.position.set(O.x,.07,O.z),t.add(F);const k=new rs(6981375,26,42);k.position.set(84.5*q,5,45*q),t.add(k),r(1.4,1.4,1.4,79,37,10098706,{cover:!0,rough:.35}),r(1.4,1.4,1.4,90,37,1718938,{cover:!0,rough:.35}),r(3.2,1.05,.9,84.5,37.5,9075274,{cover:!0}),r(.9,1.05,3,77.5,40.5,9075274,{cover:!0}),r(.9,1.05,3,91.5,40.5,9075274,{cover:!0});const Z=new ue({color:3107631,roughness:.4}),H=[];for(let[N,X]of[[89.5,-8],[132,-36],[126,13]]){N*=q,X*=q;const et=new Ot(new ge(1.5,1,1.1),Z);et.position.set(N,.8,X),et.castShadow=!0,t.add(et);const Q=new Ot(new $e(1.7,1.7,.1,24),new en({color:7012234,transparent:!0,opacity:.3}));Q.position.set(N,.05,X),t.add(Q),H.push({x:N,z:X,crate:et,ring:Q,taken:!1})}const J=new hn,V=new ue({color:6052410,roughness:.5}),lt=new Ot(new ge(1.7,1.15,.95),V);lt.position.y=.58,lt.castShadow=!0,J.add(lt);const ht=new Ot(new ge(.06,2.4,.06),V);ht.position.set(.62,2.2,0),J.add(ht);const gt=new Ot(new Vn(.15,8,8),new en({color:16728112}));gt.position.set(-.55,1.25,.3),J.add(gt),J.position.set(136*q,0,28*q),t.add(J),r(3,1.05,.9,136,25.5,9075274,{cover:!0}),r(.9,1.05,2.4,133.6,27.4,9075274,{cover:!0});const Gt={pos:new R(136*q,0,28*q),alive:!0,hp:30,group:J,lamp:gt},Xt=new Og(i,n);return{scene:t,obstacles:n,coverPoints:s,bounds:i,nav:Xt,exit:O,exitGlow:F,supplies:H,radio:Gt,lamp:w,map:{x:103,height:162},fogCfg:{near:30,far:110}}}const Vg={house:Gg};class Wg{constructor(t){this.keys={},this.pressed={},this.mouseDX=0,this.mouseDY=0,this.firing=!1,this.aiming=!1,this._rmbDownAt=0,this._rmbTurningOff=!1,this.locked=!1,this.debugLock=!1,this._dom=t,window.addEventListener("keydown",e=>{(e.code==="Tab"||e.code==="Space")&&e.preventDefault(),this.keys[e.code]||(this.pressed[e.code]=!0),this.keys[e.code]=!0}),window.addEventListener("keyup",e=>{this.keys[e.code]=!1}),window.addEventListener("mousemove",e=>{this.locked&&(this.mouseDX+=e.movementX,this.mouseDY+=e.movementY)}),window.addEventListener("mousedown",e=>{e.button===0&&(this.firing=!0),e.button===2&&(this.aiming?this._rmbTurningOff=!0:(this.aiming=!0,this._rmbDownAt=performance.now(),this._rmbTurningOff=!1))}),window.addEventListener("mouseup",e=>{e.button===0&&(this.firing=!1),e.button===2&&(this._rmbTurningOff?this.aiming=!1:performance.now()-this._rmbDownAt>350&&(this.aiming=!1))}),window.addEventListener("contextmenu",e=>e.preventDefault()),document.addEventListener("pointerlockchange",()=>{this.locked=document.pointerLockElement===this._dom,this.locked||(this.firing=!1,this.aiming=!1)})}isDown(t){return!!this.keys[t]}consume(t){return this.pressed[t]?(this.pressed[t]=!1,!0):!1}requestLock(){this._dom.requestPointerLock()}endFrame(){this.mouseDX=0,this.mouseDY=0,this.pressed={}}}function ql(i,t={}){const e=(t.rifleLength??.9)+.5,n=t.bulky??!1,s=t.marking??"none",r=n?1.18:1,a=new hn,o=new Qr({color:i,roughness:.3,metalness:0,clearcoat:.55,clearcoatRoughness:.3}),c=new Qr({color:new Ft(i).multiplyScalar(.78),roughness:.42,metalness:0,clearcoat:.35,clearcoatRoughness:.4}),l=[o,c],h=(P,b,w,U,Y,g=0,y=0,O=0,F=o)=>{const k=new Ot(b,F);return k.position.set(w,U,Y),k.rotation.set(g,y,O),k.castShadow=!0,P.add(k),k},u=(P,b,w)=>new ge(P,b,w),f=(P,b)=>new yo(P,b,3,10),p=P=>new Vn(P,12,9),_=P=>{const b=new hn;b.position.set(P*.155*r,1.06,0),h(b,f(.11*r,.3),0,-.22,0);const w=new hn;return w.position.set(0,-.46,0),h(w,f(.085,.28),0,-.18,.005),h(w,u(.2,.15,.34),0,-.45,.06,void 0,void 0,void 0,c),b.add(w),a.add(b),{hip:b,knee:w}},v=_(-1),m=_(1),d=new hn;a.add(d),h(d,u(.34*r,.24,.26),0,1.18,0),h(d,u(.29*r,.26,.23),0,1.4,.01);const T=h(d,u(.42*r,.34,.28),0,1.61,.02);T.rotation.x=.05,h(d,u(.46*r,.3,.34),0,1.57,.02,.05,0,0,c),h(d,u(.18,.1,.06),-.1*r,1.62,.2,0,0,0,c),h(d,u(.18,.1,.06),.1*r,1.5,.2,0,0,0,c),h(d,p(.105*r),-.255*r,1.74,.01),h(d,p(.105*r),.255*r,1.74,.01),h(d,new $e(.065,.075,.12,10),0,1.8,.02),h(d,p(.145),0,1.93,.03).scale.set(.92,1.04,.95),h(d,p(.185),0,1.99,.03,0,0,0,c).scale.set(1.06*r,.74,1.12),h(d,new $e(.2,.215,.04,14),0,1.925,.03,0,0,0,c);const E=new hn;if(E.position.set(.16*r,1.6,.14),E.rotation.y=-.14,d.add(E),h(E,u(.08,.14,.3),.01,-.04,-.08,0,0,-.08),h(E,u(.1,.15,.46),0,0,.24),h(E,new $e(.038,.038,e*.8,8),0,.02,.49+e*.4,Math.PI/2),h(E,u(.08,.2,.12),0,-.15,.18),h(E,f(.085*r,.24),.16*r,-.02,-.04,1.2,0,-.55),h(E,f(.08*r,.28),-.14*r,.02,.16,1.3,0,.6),h(E,p(.075),.03,-.07,.1),h(E,p(.075),-.03,-.01,.38),s==="cross"){const P=new Qr({color:16777215,roughness:.35,clearcoat:.4});l.push(P),h(d,u(.18,.06,.03),0,1.62,.21*r,.05,0,0,P),h(d,u(.06,.18,.03),0,1.62,.21*r,.05,0,0,P)}else if(s==="leader"){h(d,u(.26,.34,.14),0,1.56,-.24*r,0,0,0,c);const P=h(d,u(.025,.6,.025),.09,1.98,-.26*r);P.castShadow=!1}return a.userData.animate=(P,b)=>{const w=Math.sin(P),U=Math.sin(P+Math.PI);v.hip.rotation.x=-.22*(1-b)+w*.5*b,m.hip.rotation.x=.26*(1-b)+U*.5*b,v.knee.rotation.x=.1*(1-b)+(.12+Math.max(0,-w)*.75)*b,m.knee.rotation.x=.32*(1-b)+(.12+Math.max(0,-U)*.75)*b,d.position.y=Math.abs(Math.cos(P))*.04*b,d.rotation.z=Math.sin(P)*.025*b},a.userData.animate(0,0),a.userData.muzzleOffset=new R(.16*r,1.62,.14+.49+e*.8),a.userData.rifle=E,a.userData.rifleHomeY=E.position.y,a.userData.fadeMats=l,a}class Xg{constructor(){this.ctx=null,this.master=null}resume(){this.ctx||(this.ctx=new(window.AudioContext||window.webkitAudioContext),this.master=this.ctx.createGain(),this.master.gain.value=.32,this.master.connect(this.ctx.destination),this._startAmbient()),this.ctx.state==="suspended"&&this.ctx.resume()}_noiseBuffer(t){const e=Math.floor(this.ctx.sampleRate*t),n=this.ctx.createBuffer(1,e,this.ctx.sampleRate),s=n.getChannelData(0);for(let r=0;r<e;r++)s[r]=Math.random()*2-1;return n}_env(t,e,n,s){const r=t.gain;r.setValueAtTime(1e-4,e),r.exponentialRampToValueAtTime(n,e+.005),r.exponentialRampToValueAtTime(1e-4,e+s)}gunshot(t=0){if(!this.ctx)return;const e=this.ctx.currentTime,n=Math.max(.05,1-t/60),s=this.ctx.createBufferSource();s.buffer=this._noiseBuffer(.14);const r=this.ctx.createBiquadFilter();r.type="lowpass",r.frequency.value=5200-t*60;const a=this.ctx.createGain();this._env(a,e,.9*n,.13),s.connect(r).connect(a).connect(this.master),s.start(e);const o=this.ctx.createOscillator();o.type="sine",o.frequency.setValueAtTime(140,e),o.frequency.exponentialRampToValueAtTime(45,e+.09);const c=this.ctx.createGain();this._env(c,e,.7*n,.1),o.connect(c).connect(this.master),o.start(e),o.stop(e+.12)}footstep(){if(!this.ctx)return;const t=this.ctx.currentTime,e=this.ctx.createBufferSource();e.buffer=this._noiseBuffer(.05);const n=this.ctx.createBiquadFilter();n.type="bandpass",n.frequency.value=260+Math.random()*120;const s=this.ctx.createGain();this._env(s,t,.18,.05),e.connect(n).connect(s).connect(this.master),e.start(t)}kill(){if(!this.ctx)return;const t=this.ctx.currentTime,e=this.ctx.createOscillator();e.type="square",e.frequency.setValueAtTime(520,t),e.frequency.exponentialRampToValueAtTime(190,t+.08);const n=this.ctx.createGain();this._env(n,t,.25,.1),e.connect(n).connect(this.master),e.start(t),e.stop(t+.12)}takedown(){if(!this.ctx)return;const t=this.ctx.currentTime,e=this.ctx.createOscillator();e.type="sine",e.frequency.setValueAtTime(170,t),e.frequency.exponentialRampToValueAtTime(70,t+.09);const n=this.ctx.createGain();this._env(n,t,.22,.12),e.connect(n).connect(this.master),e.start(t),e.stop(t+.14)}reload(){if(this.ctx)for(const[t,e]of[[0,900],[.22,1300]]){const n=this.ctx.currentTime+t,s=this.ctx.createOscillator();s.type="square",s.frequency.value=e;const r=this.ctx.createGain();this._env(r,n,.12,.03),s.connect(r).connect(this.master),s.start(n),s.stop(n+.05)}}dry(){if(!this.ctx)return;const t=this.ctx.currentTime,e=this.ctx.createOscillator();e.type="square",e.frequency.value=1600;const n=this.ctx.createGain();this._env(n,t,.08,.025),e.connect(n).connect(this.master),e.start(t),e.stop(t+.04)}pickup(){this.ctx&&[660,990].forEach((t,e)=>{const n=this.ctx.currentTime+e*.09,s=this.ctx.createOscillator();s.type="triangle",s.frequency.value=t;const r=this.ctx.createGain();this._env(r,n,.22,.16),s.connect(r).connect(this.master),s.start(n),s.stop(n+.25)})}objective(){this.ctx&&[523,659,880].forEach((t,e)=>{const n=this.ctx.currentTime+e*.11,s=this.ctx.createOscillator();s.type="triangle",s.frequency.value=t;const r=this.ctx.createGain();this._env(r,n,.26,.3),s.connect(r).connect(this.master),s.start(n),s.stop(n+.5)})}boom(t=0){if(!this.ctx)return;const e=this.ctx.currentTime,n=Math.max(.15,1-t/80),s=this.ctx.createBufferSource();s.buffer=this._noiseBuffer(.5);const r=this.ctx.createBiquadFilter();r.type="lowpass",r.frequency.value=380;const a=this.ctx.createGain();this._env(a,e,1.1*n,.45),s.connect(r).connect(a).connect(this.master),s.start(e);const o=this.ctx.createOscillator();o.type="sine",o.frequency.setValueAtTime(70,e),o.frequency.exponentialRampToValueAtTime(26,e+.3);const c=this.ctx.createGain();this._env(c,e,.9*n,.4),o.connect(c).connect(this.master),o.start(e),o.stop(e+.45)}glass(){this.ctx&&[2600,3400,2100].forEach((t,e)=>{const n=this.ctx.currentTime+e*.04,s=this.ctx.createOscillator();s.type="square",s.frequency.value=t;const r=this.ctx.createGain();this._env(r,n,.1,.05),s.connect(r).connect(this.master),s.start(n),s.stop(n+.07)})}alarm(){if(this.ctx)for(let t=0;t<4;t++){const e=this.ctx.currentTime+t*.42,n=this.ctx.createOscillator();n.type="sawtooth",n.frequency.setValueAtTime(t%2?620:470,e);const s=this.ctx.createGain();this._env(s,e,.16,.36),n.connect(s).connect(this.master),n.start(e),n.stop(e+.4)}}sting(t){if(!this.ctx)return;const e=t?[523,659,784,1047]:[392,311,262],n=t?.13:.24;e.forEach((s,r)=>{const a=this.ctx.currentTime+r*n,o=this.ctx.createOscillator();o.type="triangle",o.frequency.value=s;const c=this.ctx.createGain();this._env(c,a,.3,t?.4:.6),o.connect(c).connect(this.master),o.start(a),o.stop(a+.8)})}_startAmbient(){const t=this.ctx.createBufferSource();t.buffer=this._noiseBuffer(4),t.loop=!0;const e=this.ctx.createBiquadFilter();e.type="lowpass",e.frequency.value=280;const n=this.ctx.createGain();n.gain.value=.05,t.connect(e).connect(n).connect(this.master),t.start()}}const ye=new Xg,na=new Map;function qg(i,t){const e=t+"|"+i;if(na.has(e))return na.get(e);const n=document.createElement("canvas");n.width=512,n.height=96;const s=n.getContext("2d");s.font='bold 44px "Courier New", monospace',s.textAlign="center",s.textBaseline="middle",s.lineWidth=9,s.strokeStyle="rgba(0,0,0,0.9)",s.strokeText(i,256,50),s.fillStyle=t,s.fillText(i,256,50);const r=new go({map:new _o(n),depthTest:!1});return na.set(e,r),r}class Yg{constructor(){this.live=[]}say(t,e,n="#eaffea"){const s=performance.now();if(t.userData.lastBark&&s-t.userData.lastBark<3200)return;t.userData.lastBark=s;const r=new Bl(qg(e,n));r.scale.set(Math.min(8.5,1.6+e.length*.34),1.15,1),r.position.set(0,3.7,0),t.add(r),this.live.push({sp:r,fig:t,t:0})}update(t){for(let e=this.live.length-1;e>=0;e--){const n=this.live[e];n.t+=t,n.sp.position.y=3.7+n.t*.45,n.t>1.7&&(n.fig.remove(n.sp),this.live.splice(e,1))}}}const Sn=new Yg,cs=i=>i[Math.floor(Math.random()*i.length)],Kg=.0022,$g=3.2,Zg=2,Te={FOLLOW:"follow",HOLD:"hold",MOVE:"move",ATTACK:"attack"};class Jg{constructor(t,e,n,s,r){this.cls=e,this.obstacles=n,this.nav=s,this.bounds=r,this.figure=ql(3120693,{rifleLength:e.rifleLength,bulky:e.bulky,marking:e.marking}),t.add(this.figure),this.position=new R,this.yaw=0,this.pitch=.25,this.maxHealth=e.hp,this.health=e.hp,this.alive=!0,this.downed=!1,this.crashDowned=!1,this.fireCooldown=0,this.abilityCd=0,this.mag=e.mag,this.reserve=e.reserve,this.reloading=0,this.dryCd=0,this.lastHitFrom=new R,this.lastHitAt=-1e9,this.suppressing=!1,this.zoomed=!1,this.aiming=!1,this.crouched=!1,this.peeking=!1,this.coverNear=!1,this.inCover=!1,this.coverBox=null,this.coverSide=null,this.canLean=0,this.sprinting=!1,this.order=Te.FOLLOW,this.orderPoint=new R,this.target=null,this._walkPhase=0,this._animAmp=0,this._animPrev=new R,this._f=new R,this._r=new R,this._t=new R}forwardVector(){return this._f.set(Math.sin(this.yaw),0,Math.cos(this.yaw))}muzzleWorldPosition(){return this.figure.localToWorld(this.figure.userData.muzzleOffset.clone())}fireInterval(){return this.suppressing?this.cls.fireInterval*.5:this.cls.fireInterval}spread(){let t=this.suppressing?this.cls.spread*2.5:this.cls.spread;return this.crouched&&(t*=.6),this.aiming&&(t*=.55),this.sprinting&&(t*=2.4),t}startReload(){this.reloading>0||this.mag>=this.cls.mag||this.reserve<=0||(this.reloading=this.cls.reload,ye.reload(),Sn.say(this.figure,"Reloading!","#9fd8ff"))}update(t,e){if(!this.alive)return;if(this.fireCooldown-=t,this.abilityCd=Math.max(0,this.abilityCd-t),this.dryCd=Math.max(0,this.dryCd-t),this.reloading>0&&(this.reloading-=t,this.reloading<=0)){const a=Math.min(this.cls.mag-this.mag,this.reserve);this.mag+=a,this.reserve-=a,this.reloading=0}e.isActive?this._controlPlayer(e.input,t):this._controlAI(t,e),this.figure.position.copy(this.position),this.figure.rotation.y=this.yaw;const n=this.crouched?this.peeking?.9:.66:1;this.figure.scale.y+=(n-this.figure.scale.y)*Math.min(1,t*14);const s=this.figure.userData.rifle;if(s){const a=Math.min(1,t*10),o=this.figure.userData.rifleHomeY;s.rotation.y+=((this.aiming?.02:-.14)-s.rotation.y)*a,s.position.y+=((this.aiming?o+.16:o)-s.position.y)*a,s.rotation.x+=((this.aiming?-.06:0)-s.rotation.x)*a}const r=this.position.distanceTo(this._animPrev);this._animPrev.copy(this.position),this._walkPhase+=r*2.6,this._animAmp+=((r>.004?1:0)-this._animAmp)*Math.min(1,t*9),this.figure.userData.animate(this._walkPhase,this._animAmp)}_findCoverFace(t=2.4){let e=null;for(const n of this.obstacles){if(n.max.y<.7)continue;const s=Math.max(n.min.x-this.position.x,0,this.position.x-n.max.x),r=Math.max(n.min.z-this.position.z,0,this.position.z-n.max.z),a=Math.hypot(s,r);if(a>t||e&&a>=e.dist)continue;let o;s>=r?o=this.position.x>n.max.x?"px":"nx":o=this.position.z>n.max.z?"pz":"nz";const c=n.max.y>1.45,l=o==="px"||o==="nx"?[this.position.z,n.min.z,n.max.z]:[this.position.x,n.min.x,n.max.x],h=l[0]-l[1]<1.7||l[2]-l[0]<1.7;e={box:n,side:o,dist:a,tall:c,nearEdge:h}}return e}toggleCover(){if(this.inCover){this.inCover=!1,this.coverBox=null,this.crouched=!1;return}const t=this._findCoverFace();t?(this.inCover=!0,this.coverBox=t.box,this.coverSide=t.side,this.crouched=!0):this.crouched=!this.crouched}_controlPlayer(t,e){const n=this.inCover?null:this._findCoverFace();this.coverNear=!!(n&&(!n.tall||n.nearEdge)),this.peeking=!1,this.canLean=0;const s=Kg*(this.zoomed?.4:this.aiming?.65:1);this.yaw-=t.mouseDX*s,this.pitch+=t.mouseDY*s,this.pitch=Math.max(-.2,Math.min(.9,this.pitch));const r=this.forwardVector();this._r.set(r.z,0,-r.x);let a=0,o=0;t.isDown("KeyW")&&(a+=r.x,o+=r.z),t.isDown("KeyS")&&(a-=r.x,o-=r.z),t.isDown("KeyD")&&(a+=this._r.x,o+=this._r.z),t.isDown("KeyA")&&(a-=this._r.x,o-=this._r.z);const c=Math.hypot(a,o);if(this.inCover&&this.coverBox){const l=this.coverBox,h=this.coverSide==="px"?[1,0]:this.coverSide==="nx"?[-1,0]:this.coverSide==="pz"?[0,1]:[0,-1],u=l.max.y>1.45,f=h[0]!==0,p=f?l.min.z:l.min.x,_=f?l.max.z:l.max.x,v=f?this.position.z:this.position.x;u&&(v-p<1.7?this.canLean=-1:_-v<1.7&&(this.canLean=1));const m=u&&this.aiming&&this.canLean!==0;if(this.peeking=this.aiming&&(!u||m),c>0){const d=a/c,T=o/c;if(d*h[0]+T*h[1]>.75||t.isDown("ShiftLeft"))this.inCover=!1,this.coverBox=null,this.crouched=!1;else{const S=-h[1],E=h[0],P=d*S+T*E,b=this.cls.speed*.5*e*P;us(this.position,S*b,E*b,this.obstacles,.6,this.bounds)}}if(this.inCover){this.sprinting=!1;const d=Math.min(1,e*12);let T=p-.2,S=_+.2,E=0;if(m?(E=((this.canLean<0?p-.95:_+.95)-v)*Math.min(1,e*8),T=p-1.15,S=_+1.15):u&&(v<p+.25||v>_-.25)&&(E=(Math.max(p+.35,Math.min(_-.35,v))-v)*Math.min(1,e*10)),f){const P=(h[0]>0?l.max.x:l.min.x)+h[0]*.62;this.position.x+=(P-this.position.x)*d,this.position.z=Math.max(T,Math.min(S,this.position.z+E))}else{const P=(h[1]>0?l.max.z:l.min.z)+h[1]*.62;this.position.z+=(P-this.position.z)*d,this.position.x=Math.max(T,Math.min(S,this.position.x+E))}return}}if(this.sprinting=c>0&&t.isDown("ShiftLeft")&&!this.crouched,c>0){let l=this.cls.speed;this.sprinting&&(l*=1.65),this.crouched&&(l*=.55),this.aiming&&(l*=.55),this.suppressing&&(l*=.5);const h=l*e/c;us(this.position,a*h,o*h,this.obstacles,.6,this.bounds)}else this.sprinting=!1}tryFireAt(t,e){return!this.alive||this.fireCooldown>0||this.reloading>0?!1:this.mag<=0?(this.reserve>0?this.startReload():this.dryCd<=0&&(ye.dry(),this.dryCd=.35),!1):(e.fire(this.muzzleWorldPosition(),this._aimDir(t),"player",this.cls.damage),this.mag--,this.fireCooldown=this.fireInterval(),this.mag===0&&this.reserve>0&&this.startReload(),!0)}_controlAI(t,e){this.peeking=!1,this.coverNear=!1,this.canLean=0;let n=this.order===Te.ATTACK&&this._targetAlive()?this.target:this._nearestEnemy(e.enemies,this.cls.range);n&&!e.free&&n.pos.distanceTo(this.position)>12&&(n=null),n&&e.fireMode==="hold"&&n.pos.distanceTo(this.position)>6&&(n=null);let s=null;if(this.order===Te.FOLLOW?s=e.formationSlot:this.order===Te.MOVE?s=this.orderPoint:this.order===Te.ATTACK&&this._targetAlive()&&(s=this.target.pos),s){this._t.subVectors(s,this.position),this._t.y=0;const r=this._t.length(),a=this.order===Te.ATTACK?this.cls.range*.65:.5;if(this.order===Te.MOVE&&r<.7&&(this.order=Te.HOLD),r>a){let o=this.cls.speed;this.order===Te.FOLLOW&&r>12&&(o*=1.5);const c=Ci(this.nav,this,this.position,s,o,t,this.obstacles,.6,this.bounds);!n&&c&&(this.yaw=Math.atan2(c.x,c.z))}}if(this.order===Te.ATTACK&&!this._targetAlive()&&(this.order=Te.FOLLOW,this.target=null),this.crouched=!!n&&!s,n&&(this._t.subVectors(n.pos,this.position),this._t.y=0,this.yaw=Math.atan2(this._t.x,this._t.z),Li(this.position,n.pos,this.obstacles,1.45,(n.baseY||0)+1.1)&&this.fireCooldown<=0)){const a=n.pos.clone();a.y=(n.baseY||0)+1.1,e.bullets.fire(this.muzzleWorldPosition(),this._aimDir(a,Zg),"player",this.cls.damage),this.fireCooldown=this.cls.fireInterval*$g}}_targetAlive(){return this.target&&this.target.hp>0}_nearestEnemy(t,e){let n=null,s=e;for(const r of t){const a=r.pos.distanceTo(this.position);a<s&&(s=a,n=r)}return n}_aimDir(t,e=1){const n=this._t.copy(t).sub(this.muzzleWorldPosition()).normalize(),s=this.spread()*e;return n.x+=(Math.random()-.5)*s,n.y+=(Math.random()-.5)*s,n.z+=(Math.random()-.5)*s,n.normalize().clone()}takeDamage(t,e){this.alive&&(e&&(this.lastHitFrom.set(e.x,0,e.z),this.lastHitAt=performance.now()),this.health=Math.max(0,this.health-t),this.health===0&&this._die())}heal(t){this.alive&&(this.health=Math.min(this.maxHealth,this.health+t))}_die(){this.alive=!1,this.downed=!0,this.figure.rotation.z=Math.PI/2,this.figure.position.y=.3}revive(t){this.alive=!0,this.downed=!1,this.crashDowned=!1,this.health=Math.round(this.maxHealth*t),this.figure.rotation.z=0,this.figure.position.y=0}}const jg={leader:{key:"leader",name:"LEADER",hp:100,speed:10.4,fireInterval:.14,damage:16,range:60,spread:.04,rifleLength:.9,bulky:!1,mag:24,reserve:96,reload:1.6,marking:"leader",ringColor:8257405,ability:{key:"grenade",name:"FRAG OUT",input:"press",cooldown:3.5}},heavy:{key:"heavy",name:"HEAVY",hp:150,speed:7.5,fireInterval:.07,damage:11,range:48,spread:.1,rifleLength:1.15,bulky:!0,mag:50,reserve:150,reload:2.4,marking:"none",ringColor:16764500,ability:{key:"suppress",name:"DIG IN",input:"toggle"}},sniper:{key:"sniper",name:"SNIPER",hp:75,speed:9.2,fireInterval:1,damage:90,range:125,spread:.004,rifleLength:1.6,bulky:!1,mag:5,reserve:25,reload:2.2,marking:"none",ringColor:7327999,ability:{key:"scope",name:"SCOPE",input:"aim"}},medic:{key:"medic",name:"MEDIC",hp:90,speed:11,fireInterval:.18,damage:13,range:43,spread:.05,rifleLength:.7,bulky:!1,mag:20,reserve:80,reload:1.5,marking:"cross",ringColor:16747146,ability:{key:"revive",name:"REVIVE",input:"press",cooldown:.4}}},Qg=["leader","heavy","sniper","medic"],t0=[{x:-3,z:-1.4},{x:3,z:-1.4},{x:-5.4,z:-3}],e0=4,n0=7;class i0{constructor(t,e,n,s){this.nav=n,this.members=Qg.map((r,a)=>{const o=new Jg(t,jg[r],e,n,s),c=n.nearestOpen((2.5+a*2.7)*we,(-8-a%2*2.6)*we);return o.position.set(c.x,0,c.z),o.yaw=Math.PI/2,o.figure.position.copy(o.position),o.order=Te.FOLLOW,o}),this.activeIndex=0,this.fireMode="free",this.ring=new Ot(new Eo(.7,.95,28),new en({color:8257405,side:je,transparent:!0,opacity:.9})),this.ring.rotation.x=-Math.PI/2,t.add(this.ring),this._slot=new R,this._threat=new R}resupply(t,e){for(const n of this.members)n.alive&&(n.reserve=Math.min(n.cls.reserve,n.reserve+Math.round(n.cls.reserve*t)),n.heal(e))}get active(){return this.members[this.activeIndex]}get alive(){return this.members.some(t=>t.alive)}setActive(t){if(t<0||t>=this.members.length||!this.members[t].alive)return;const e=this.active;e.aiming=!1,e.zoomed=!1,e.suppressing=!1,this.activeIndex=t,this.ring.material.color.setHex(this.active.cls.ringColor)}cycle(){for(let t=1;t<=this.members.length;t++){const e=(this.activeIndex+t)%this.members.length;if(this.members[e].alive){this.setActive(e);return}}}orderMove(t){const e=[[0,0],[1.8,1.1],[-1.8,1.1]];let n=0;this._eachOther(s=>{const r=e[n++%e.length],a=this.nav.nearestOpen(t.x+r[0],t.z+r[1]);s.order=Te.MOVE,s.orderPoint.set(a.x,0,a.z),s.target=null})}orderAttack(t){this._eachOther(e=>{e.order=Te.ATTACK,e.target=t})}orderHold(){this._eachOther(t=>{t.order=Te.HOLD,t.target=null})}orderFollow(){this._eachOther(t=>{t.order=Te.FOLLOW,t.target=null})}_eachOther(t){for(let e=0;e<this.members.length;e++)e===this.activeIndex||!this.members[e].alive||t(this.members[e])}update(t,e){const n=this.active,s=this._worldSlots(n);let r=0;for(let a=0;a<this.members.length;a++){const o=this.members[a],c=a===this.activeIndex;o.update(t,{isActive:c,input:e.input,enemies:e.enemies,bullets:e.bullets,free:e.free,fireMode:this.fireMode,formationSlot:c?null:s[r++%s.length]})}this._medicHeal(t),n.alive||this.cycle(),this.ring.position.set(this.active.position.x,.07,this.active.position.z),this.ring.visible=this.active.alive}_worldSlots(t){const e=Math.cos(t.yaw),n=Math.sin(t.yaw);return t0.map(s=>{const r=s.x*e+s.z*n,a=-s.x*n+s.z*e,o=this.nav.nearestOpen(t.position.x+r,t.position.z+a);return this._slot.clone().set(o.x,0,o.z)})}reviveNear(t,e=5){let n=null,s=e;for(const r of this.members){if(r===t||!r.downed)continue;const a=r.position.distanceTo(t.position);a<s&&(s=a,n=r)}return n?(n.revive(.5),n):null}takeBulletHits(t){for(let e=t.active.length-1;e>=0;e--){const n=t.active[e];if(n.team==="enemy")for(const s of this.members){if(!s.alive)continue;const r=n.mesh.position.x-s.position.x,a=n.mesh.position.y-(s.position.y+(s.crouched&&!s.peeking?.75:1.1)),o=n.mesh.position.z-s.position.z;if(r*r+a*a+o*o<.9*.9){this._threat.set(s.position.x-n.dir.x*12,0,s.position.z-n.dir.z*12),s.takeDamage(n.damage,this._threat),t.retireBullet(n);break}}}}_medicHeal(t){const e=this.members.find(n=>n.cls.key==="medic"&&n.alive);if(e)for(const n of this.members)n===e||!n.alive||n.position.distanceTo(e.position)<n0&&n.heal(e0*t)}}const s0=85,r0=1.6,a0=new Vn(.11,6,6),Hc=new en({color:16772778}),o0=new en({color:16738869}),c0=new Vn(.07,4,4),l0=new en({color:16762474}),h0=new ge(1,1,1),u0=90;class f0{constructor(t,e,n){this.scene=t,this.obstacles=e,this.bounds=n,this.active=[],this.pool=[],this.sparks=[],this.shards=[],this.resting=[],this.onFire=null}shatter(t,e=13480050){const n=new ue({color:e,roughness:.35});for(let s=0;s<11;s++){const r=new Ot(h0,n),a=.1+Math.random()*.18;r.scale.set(a,a,a*(.6+Math.random())),r.position.set(t.x,.6+Math.random()*1.1,t.z),r.castShadow=!0,this.scene.add(r),this.shards.push({m:r,vx:(Math.random()-.5)*16,vy:3+Math.random()*9,vz:(Math.random()-.5)*16,rx:(Math.random()-.5)*14,rz:(Math.random()-.5)*14,keep:Math.random()<.35})}}burst(t){for(let e=0;e<5;e++){const n=new Ot(c0,l0);n.position.copy(t),this.scene.add(n),this.sparks.push({m:n,vx:(Math.random()-.5)*14,vy:4+Math.random()*8,vz:(Math.random()-.5)*14,life:.22+Math.random()*.1})}}fire(t,e,n="player",s=15){const r=this.pool.pop()||new Ot(a0,Hc);r.material=n==="enemy"?o0:Hc,r.position.copy(t),r.scale.set(1,1,14),r.lookAt(t.x+e.x,t.y+e.y,t.z+e.z),this.scene.add(r),this.onFire&&this.onFire(t,n),this.active.push({mesh:r,vel:e.clone().multiplyScalar(s0),dir:e.clone(),life:r0,team:n,damage:s})}update(t){for(let e=this.shards.length-1;e>=0;e--){const n=this.shards[e];n.vy-=26*t,n.m.position.x+=n.vx*t,n.m.position.y+=n.vy*t,n.m.position.z+=n.vz*t,n.m.rotation.x+=n.rx*t,n.m.rotation.z+=n.rz*t,n.m.position.y<=.06&&(this.shards.splice(e,1),n.keep?(n.m.position.y=.06,this.resting.push(n.m),this.resting.length>u0&&this.scene.remove(this.resting.shift())):this.scene.remove(n.m))}for(let e=this.sparks.length-1;e>=0;e--){const n=this.sparks[e];if(n.life-=t,n.life<=0){this.scene.remove(n.m),this.sparks.splice(e,1);continue}n.vy-=30*t,n.m.position.x+=n.vx*t,n.m.position.y+=n.vy*t,n.m.position.z+=n.vz*t}for(let e=this.active.length-1;e>=0;e--){const n=this.active[e],s=n.mesh.position,r=s.x,a=s.z;s.addScaledVector(n.vel,t),n.life-=t;let o=n.life<=0||s.y<0||s.x<this.bounds.minX-8||s.x>this.bounds.maxX+8||s.z<this.bounds.minZ-8||s.z>this.bounds.maxZ+8;if(!o){for(const c of this.obstacles)if(s.y<=c.max.y&&Xl(r,a,s.x,s.z,c.min.x,c.min.z,c.max.x,c.max.z)){o=!0,this.burst(s);break}}o&&this._retire(e)}}_retire(t){const e=this.active[t];this.scene.remove(e.mesh),this.pool.push(e.mesh),this.active.splice(t,1)}retireBullet(t){const e=this.active.indexOf(t);e!==-1&&this._retire(e)}}const d0={rifle:{hp:40,speed:5.8,damage:13,fireInterval:.8,spread:.07,fig:{}},scout:{hp:25,speed:8.6,damage:8,fireInterval:1,spread:.09,runner:!0,fig:{rifleLength:.45}},gunner:{hp:70,speed:4.2,damage:9,fireInterval:.09,spread:.12,burst:4,burstPause:1.5,fig:{bulky:!0,rifleLength:1.3}},lookout:{hp:30,speed:0,damage:12,fireInterval:1.1,spread:.05,static:!0,sightMult:1.35,cone:-.25,fig:{rifleLength:1.2}}},Gc=38,ia=18,p0=30,m0=2.5,Vc=.95,Wc=1.1,g0=2,_0=20,v0=1.5,x0=29,M0=.2,y0=43,S0=21,E0=33,T0=11,b0=2.4,A0=.5,w0=10,Xc=3,R0=4;function Yl(i,t){const e=document.createElement("canvas");e.width=e.height=64;const n=e.getContext("2d");return n.font="bold 52px monospace",n.textAlign="center",n.textBaseline="middle",n.lineWidth=8,n.strokeStyle="rgba(0,0,0,0.85)",n.strokeText(i,32,34),n.fillStyle=t,n.fillText(i,32,34),new go({map:new _o(e),depthTest:!1})}const sa=Yl("?","#ffd23d"),C0=Yl("!","#ff4030");class P0{constructor(t,e,n,s,r){this.scene=t,this.obstacles=e,this.coverPoints=n,this.nav=s,this.bounds=r,this.list=[],this.dying=[],this.kills=0,this.combatStarted=!1,this.firstSpotted=!1,this.hitFlash=0,this.radio=null,this.lamp=null,this.reserveLayout=null,this.alarmRaised=!1,this._v=new R,this._g=new R}spawnLayout(t){for(const e of t){const n=d0[e.type||"rifle"],s=ql(13480050,n.fig),r=e.baseY?{x:e.x,z:e.z}:this.nav.nearestOpen(e.x,e.z),a=new R(r.x,0,r.z);s.position.copy(a),s.position.y=e.baseY||0,s.rotation.y=e.facing,this.scene.add(s);const o=new Bl(sa);o.scale.set(1.5,1.5,1),o.position.set(0,3.1,0),o.visible=!1,s.add(o),this.list.push({fig:s,pos:a,tell:o,type:e.type||"rifle",hp:n.hp,speed:n.speed,damage:n.damage,fireInterval:n.fireInterval,spread:n.spread,burst:n.burst||0,burstPause:n.burstPause||0,burstLeft:n.burst||0,runner:!!n.runner,static:!!n.static,sightMult:n.sightMult||1,cone:n.cone??M0,baseY:e.baseY||0,fireCd:Math.random()*.5,recheck:0,cover:null,suppressed:0,stagger:0,alerted:!1,aware:0,alertFlash:0,alertedFor:0,callT:0,facing:e.facing,home:{x:r.x,z:r.z,facing:e.facing},lastKnown:new R,hasIntel:!1,searching:!1,searchT:0,panicT:0,panicFrom:new R,patrol:e.patrol?{a:{x:r.x,z:r.z},b:{...e.patrol},toB:!0}:null})}}raiseAlarm(t){if(this.alarmRaised||(this.alarmRaised=!0,ye.alarm(),!this.reserveLayout))return;const e=this.list.length;this.spawnLayout(this.reserveLayout);const n=t&&t.active.alive?t.active.position:null;for(let s=e;s<this.list.length;s++)this.alert(this.list[s],n),this.list[s].alertFlash=0}alert(t,e){if(e&&(t.lastKnown.set(e.x,0,e.z),t.hasIntel=!0,t.searchT=0),!t.alerted){t.alerted=!0,t.alertFlash=2.2,Math.random()<.65&&Sn.say(t.fig,cs(["INTRUDERS!","CONTACT!","GREENS — HERE!"]),"#ffd23d"),this.firstSpotted=!0,this.combatStarted=!0;for(const n of this.list)!n.alerted&&Math.hypot(n.pos.x-t.pos.x,n.pos.z-t.pos.z)<T0&&this.alert(n,t.hasIntel?t.lastKnown:null)}}hearGunshot(t){this.combatStarted=!0;for(const e of this.list)Math.hypot(e.pos.x-t.x,e.pos.z-t.z)<S0&&this.alert(e,t)}takedown(t,e){const n=this.list.indexOf(t);if(n===-1)return!1;const s=t.pos.x-e.x,r=t.pos.z-e.z,a=Math.hypot(s,r)||1;return this.dying.push({fig:t.fig,t:0,dx:s/a,dz:r/a,tip:Math.random()<.5?1:-1}),t.fig.remove(t.tell),this.list.splice(n,1),this.kills++,this.hearScuffle(t.pos),!0}hearScuffle(t){for(const e of this.list)Math.hypot(e.pos.x-t.x,e.pos.z-t.z)<8&&this.alert(e,t)}hearBlast(t){this.combatStarted=!0;for(const e of this.list){const n=Math.hypot(e.pos.x-t.x,e.pos.z-t.z);n<E0&&this.alert(e,t),n<10&&(e.suppressed=Math.max(e.suppressed,1))}}panicFrom(t,e){for(const n of this.list)Math.hypot(n.pos.x-t.x,n.pos.z-t.z)>e||(n.panicT<=0&&Sn.say(n.fig,"GRENADE!","#ff6a50"),n.panicT=Math.max(n.panicT,.9),n.panicFrom.set(t.x,0,t.z),this.alert(n,t))}applySuppression(t,e,n){for(const s of this.list){const r=s.pos.x-t.x,a=s.pos.z-t.z;r*r+a*a<e*e&&(s.alerted||this.alert(s,t),s.suppressed=Math.max(s.suppressed,n),s.recheck=Math.min(s.recheck,.2))}}update(t,e,n){this.hitFlash=Math.max(0,this.hitFlash-t);for(let s=this.dying.length-1;s>=0;s--){const r=this.dying[s];r.t+=t,r.t<.45?(r.fig.position.x+=r.dx*t*9,r.fig.position.z+=r.dz*t*9,r.fig.position.y=Math.sin(Math.min(1,r.t/.45)*Math.PI)*1.2,r.fig.rotation.z=r.t/.45*(Math.PI/2)*r.tip):(r.fig.rotation.z=Math.PI/2*r.tip,r.fig.position.y=.3,this.dying.splice(s,1))}for(let s=this.list.length-1;s>=0;s--){const r=this.list[s];for(const o of n.active){if(o.team!=="player")continue;const c=o.mesh.position.x-r.pos.x,l=o.mesh.position.y-(r.baseY+Wc),h=o.mesh.position.z-r.pos.z;if(c*c+l*l+h*h<Vc*Vc){r.hp-=o.damage,r.stagger=.35,this.hitFlash=.12;const u=this._nearestSoldier(e,r.pos);this.alert(r,u?u.position:null);const f=o.dir||this._v.set(0,0,0);us(r.pos,f.x*.5,f.z*.5,this.obstacles,.6,this.bounds),r.fig.position.copy(r.pos),n.burst(o.mesh.position),n.retireBullet(o);break}}if(r.hp<=0){this._v.set(r.pos.x,r.baseY,r.pos.z),n.shatter(this._v),this.scene.remove(r.fig),this.list.splice(s,1),this.kills++;continue}if(r.suppressed=Math.max(0,r.suppressed-t),r.stagger=Math.max(0,r.stagger-t),r.alertFlash=Math.max(0,r.alertFlash-t),r.panicT>0&&!r.static){r.panicT-=t;const o=r.pos.x-r.panicFrom.x,c=r.pos.z-r.panicFrom.z,l=Math.hypot(o,c)||1;us(r.pos,o/l*r.speed*1.35*t,c/l*r.speed*1.35*t,this.obstacles,.6,this.bounds),r.fig.position.copy(r.pos),r.facing=Math.atan2(o,c),r.fig.rotation.y=r.facing}else r.alerted?(r.alertedFor+=t,this._fight(r,t,e,n)):(r.alertedFor=0,this._sentry(r,t,e));const a=Math.hypot(r.pos.x-(r._px??r.pos.x),r.pos.z-(r._pz??r.pos.z));if(r._px=r.pos.x,r._pz=r.pos.z,r.walkPhase=(r.walkPhase||0)+a*2.6,r.animAmp=(r.animAmp||0)+((a>.004?1:0)-(r.animAmp||0))*Math.min(1,t*9),r.fig.userData.animate(r.walkPhase,r.animAmp),!r.alerted&&r.aware>.06){r.tell.visible=!0,r.tell.material=sa;const o=1+r.aware*1.4;r.tell.scale.set(o,o,1),r.tell.material.opacity=.45+.55*r.aware}else r.alerted&&r.alertFlash>0?(r.tell.visible=!0,r.tell.material=C0,r.tell.scale.set(2.1,2.1,1)):r.alerted&&r.searching?(r.tell.visible=!0,r.tell.material=sa,r.tell.scale.set(1.7,1.7,1),r.tell.material.opacity=.9):r.tell.visible=!1}}_sentry(t,e,n){if(t.patrol&&!t.static){const l=t.patrol.toB?t.patrol.b:t.patrol.a;if(Math.hypot(l.x-t.pos.x,l.z-t.pos.z)<.8)t.patrol.toB=!t.patrol.toB;else{const h=Ci(this.nav,t,t.pos,l,Xc,e,this.obstacles,.6,this.bounds);t.fig.position.copy(t.pos),h&&(t.facing=Math.atan2(h.x,h.z),t.fig.rotation.y=t.facing)}}else if(!t.static&&Math.hypot(t.home.x-t.pos.x,t.home.z-t.pos.z)>1.2){const l=Ci(this.nav,t,t.pos,t.home,Xc,e,this.obstacles,.6,this.bounds);t.fig.position.copy(t.pos),l&&(t.facing=Math.atan2(l.x,l.z),t.fig.rotation.y=t.facing)}else Math.abs(t.facing-t.home.facing)>.01&&t.aware<.05&&(t.facing=t.home.facing,t.fig.rotation.y=t.facing);let s=x0*t.sightMult;this.lamp&&!this.lamp.alive&&Math.hypot(t.pos.x-this.lamp.pos.x,t.pos.z-this.lamp.pos.z)<this.lamp.radius&&(s*=.6);let r=null,a=s;const o=Math.sin(t.facing),c=Math.cos(t.facing);for(const l of n.members){if(!l.alive)continue;const h=l.position.x-t.pos.x,u=l.position.z-t.pos.z,f=Math.hypot(h,u);if(f>=a||(o*h+c*u)/(f||1)<t.cone)continue;const p=l.crouched&&!l.peeking;Li(t.pos,l.position,this.obstacles,1.5+t.baseY,p?.8:1.25)&&(r=l,a=f)}if(r){const l=r.crouched&&!r.peeking,h=1-a/s;let u=b0*(.15+1.7*h*h);l&&(u*=.5),r.sprinting&&(u*=1.8),a<w0&&!l&&(u=Math.max(u,4.5)),t.aware+=e*Math.max(.15,u),t.aware>=1&&this.alert(t,r.position)}else t.aware=Math.max(0,t.aware-e*A0)}_fight(t,e,n,s){let r=null,a=y0;for(const h of n.members){if(!h.alive)continue;const u=t.pos.distanceTo(h.position);if(u>=a)continue;const f=h.crouched&&!h.peeking;Li(t.pos,h.position,this.obstacles,1.5+t.baseY,f?.75:1.1)&&(r=h,a=u)}const o=this.radio;if(o&&o.alive&&!this.alarmRaised&&t.runner&&!(r&&a<9)){if(Math.hypot(o.pos.x-t.pos.x,o.pos.z-t.pos.z)>2.2){t.callT=0;const f=Ci(this.nav,t,t.pos,o.pos,t.speed*1.1,e,this.obstacles,.6,this.bounds);t.fig.position.copy(t.pos),f&&(t.facing=Math.atan2(f.x,f.z))}else t.callT+=e,t.facing=Math.atan2(o.pos.x-t.pos.x,o.pos.z-t.pos.z),t.callT>v0&&this.raiseAlarm(n);t.searching=!1,t.fig.rotation.y=t.facing;return}if(!r){t.cover=null;let h=!0;if(t.hasIntel&&!t.static&&Math.hypot(t.lastKnown.x-t.pos.x,t.lastKnown.z-t.pos.z)>2.2){const u=Ci(this.nav,t,t.pos,t.lastKnown,t.speed*.8,e,this.obstacles,.6,this.bounds);t.fig.position.copy(t.pos),u&&(h=!1,t.searching=!1,t.facing=Math.atan2(u.x,u.z))}h&&(t.searching||Sn.say(t.fig,cs(["Where did he go?","Come out, green…","I heard something."]),"#cdb072"),t.searching=!0,t.facing+=e*1.4,t.searchT+=e,t.searchT>R0&&(Sn.say(t.fig,cs(["Must have been nothing…","Rats, probably."]),"#9a8a6a"),t.alerted=!1,t.searching=!1,t.searchT=0,t.hasIntel=!1,t.aware=.5,t._navPath=null)),t.fig.rotation.y=t.facing;return}t.searching=!1,t.searchT=0,t.hasIntel=!0,t.lastKnown.set(r.position.x,0,r.position.z),this._v.subVectors(r.position,t.pos),this._v.y=0;const c=this._v.length();t.recheck-=e,!t.static&&(t.recheck<=0||!t.cover)&&(t.cover=this._findCover(t,r),t.recheck=m0),t.cover&&!Li(t.cover,r.position,this.obstacles)&&(t.cover=null);let l=null;if(t.cover)l=t.cover;else if(!t.static&&c>ia+2){const h=ia/c;this._g.set(r.position.x-this._v.x*h,0,r.position.z-this._v.z*h),l=this._g}if(l&&!t.static&&(this._g.subVectors(l,t.pos),this._g.y=0,this._g.length()>.5&&(Ci(this.nav,t,t.pos,l,t.speed,e,this.obstacles,.6,this.bounds),t.fig.position.copy(t.pos))),t.facing=Math.atan2(this._v.x,this._v.z),t.fig.rotation.y=t.facing,t.fireCd-=e,c<Gc*.9&&t.fireCd<=0&&t.suppressed<=0&&t.stagger<=0){const h=t.fig.localToWorld(t.fig.userData.muzzleOffset.clone()),u=r.crouched&&!r.peeking?.75:Wc,f=new R(r.position.x,u,r.position.z).sub(h).normalize();f.x+=(Math.random()-.5)*t.spread,f.y+=(Math.random()-.5)*t.spread,f.z+=(Math.random()-.5)*t.spread,s.fire(h,f.normalize(),"enemy",t.damage),t.burst?(t.burstLeft--,t.fireCd=t.burstLeft>0?t.fireInterval:(t.burstLeft=t.burst,t.burstPause)):t.fireCd=t.fireInterval,this.combatStarted=!0}c<g0&&r.takeDamage(_0*e,t.pos)}_nearestSoldier(t,e){let n=null,s=1/0;for(const r of t.members){if(!r.alive)continue;const a=r.position.distanceTo(e);a<s&&(s=a,n=r)}return n}_findCover(t,e){let n=null,s=1/0;for(const r of this.coverPoints){if(r.distanceTo(t.pos)>p0)continue;const a=r.distanceTo(e.position);if(a>Gc||!Li(r,e.position,this.obstacles))continue;const o=r.distanceTo(t.pos)+Math.abs(a-ia)*.5;o<s&&(s=o,n=r)}return n?n.clone():null}}const qc=32,L0=26,D0=2.2,ra=8.5,I0=130,U0=new Vn(.22,8,8),N0=new ue({color:3095076,roughness:.7}),O0=new Vn(1,16,12);class F0{constructor(t,e,n){this.scene=t,this.obstacles=e,this.bounds=n,this.nades=[],this.flashes=[],this.onBoom=null}throwAt(t,e){const n=e.x-t.x,s=e.z-t.z,r=Math.hypot(n,s)||.001,a=Math.max(.5,r/L0),o=(0-t.y+.5*qc*a*a)/a,c=new Ot(U0,N0);c.castShadow=!0,c.position.copy(t),this.scene.add(c),this.nades.push({mesh:c,vel:new R(n/a,o,s/a),fuse:D0})}update(t,e){for(let n=this.nades.length-1;n>=0;n--){const s=this.nades[n];e.panicFrom(s.mesh.position,13),s.vel.y-=qc*t;const r=s.mesh.position,a=r.x,o=r.z;r.addScaledVector(s.vel,t),s.fuse-=t;let c=s.fuse<=0||r.y<=.2||r.x<this.bounds.minX||r.x>this.bounds.maxX||r.z<this.bounds.minZ||r.z>this.bounds.maxZ;if(!c){for(const l of this.obstacles)if(r.y<=l.max.y&&Xl(a,o,r.x,r.z,l.min.x,l.min.z,l.max.x,l.max.z)){c=!0;break}}c&&(this._explode(r.clone(),e),this.scene.remove(s.mesh),this.nades.splice(n,1))}for(let n=this.flashes.length-1;n>=0;n--){const s=this.flashes[n];s.life-=t;const r=1-s.life/s.max;s.mesh.scale.setScalar(.5+r*ra),s.mesh.material.opacity=Math.max(0,1-r),s.life<=0&&(this.scene.remove(s.mesh),this.flashes.splice(n,1))}}_explode(t,e){for(const s of e.list){const r=s.pos.distanceTo(t);r<ra&&(s.hp-=I0*(1-r/ra))}e.hearBlast(t),this.onBoom&&this.onBoom(t);const n=new Ot(O0,new en({color:16755251,transparent:!0,opacity:.9}));n.position.set(t.x,.6,t.z),this.scene.add(n),this.flashes.push({mesh:n,life:.45,max:.45})}}const Kl=[];let $l;const z0={follow:"FOLLOW",hold:"HOLDING",move:"MOVING",attack:"ATTACK"};function B0(i){const t=document.getElementById("squad");$l=document.getElementById("kills"),i.members.forEach((e,n)=>{const s=document.createElement("div");s.className="card",s.style.setProperty("--ring","#"+e.cls.ringColor.toString(16).padStart(6,"0")),s.innerHTML=`
      <div class="card-top"><span class="key">${n+1}</span><span class="name">${e.cls.name}</span></div>
      <div class="bar"><div class="fill"></div></div>
      <div class="order"></div>`,t.appendChild(s),Kl.push({root:s,fill:s.querySelector(".fill"),order:s.querySelector(".order")})})}function k0(i,t){i.members.forEach((e,n)=>{const s=Kl[n],r=Math.max(0,e.health/e.maxHealth*100);s.fill.style.width=r+"%",s.root.classList.toggle("active",n===i.activeIndex&&e.alive),s.root.classList.toggle("dead",!e.alive),s.order.textContent=e.alive?n===i.activeIndex?"YOU":z0[e.order]||"":"DOWN"}),$l.textContent=t}const rn=[{id:"crash-site",name:"CRASH SITE",world:"house",sector:"THE HOUSE — GROUND FLOOR, DUSK",briefing:"We came down hard through the window and the squad got thrown across the room. You are ALONE at the wreck — Heavy, Sniper and Medic are lying out there between the furniture, and the tan found the crash before you woke up. Get your men on their feet. Recover the supply drops. Their field radio is in the STUDY: while it lives, any tan who marks you will run to call the porch reserve down on your head. Cut it. Then breach the front door and get out.",winText:"ESCAPED THE HOUSE — ONTO THE PORCH",scatter:[{member:1,x:16,z:-32},{member:3,x:24,z:12},{member:2,x:52,z:14}],stages:[{type:"regroup",text:"FIND YOUR SQUAD",toast:"YOUR SQUAD IS OUT THERE — get them on their feet"},{type:"multi",toast:"RECOVER THE SUPPLY DROPS — and CUT THAT RADIO",parts:[{type:"collect",text:"SUPPLIES",items:[{x:89.5,z:-8},{x:132,z:-36},{x:126,z:13}]},{type:"destroy",text:"CUT THE ALARM"}]},{type:"escape",holdSeconds:4,toast:"BREACH THE FRONT DOOR — hold the doormat"}],enemyLayout:[{x:12,z:-26,facing:2.55},{x:32.5,z:9.5,facing:-1.29},{x:49,z:20,facing:2.68},{x:45.5,z:-16.5,facing:-1.8},{x:53,z:-27,facing:-Math.PI/2,type:"scout",patrol:{x:23,z:-22}},{x:69.5,z:18,facing:-Math.PI/2},{x:56,z:18,facing:-2.2,type:"lookout",baseY:6.45},{x:85,z:-13,facing:-1.2},{x:84.5,z:30,facing:Math.PI,type:"scout",patrol:{x:84.5,z:-36}},{x:123,z:-27,facing:-Math.PI/2,type:"gunner"},{x:136,z:-30,facing:-2.55},{x:131,z:25,facing:-1.57,type:"gunner"},{x:122,z:26,facing:-Math.PI/2},{x:118,z:40,facing:-2.4,type:"scout",patrol:{x:98,z:24}},{x:80,z:39,facing:Math.PI,type:"gunner"},{x:89,z:39.5,facing:Math.PI,type:"gunner"},{x:84.5,z:43.5,facing:Math.PI},{x:78,z:43,facing:2.6}],reserve:[{x:82,z:44,facing:Math.PI},{x:87,z:44,facing:Math.PI},{x:84.5,z:42,facing:Math.PI},{x:80.5,z:42.5,facing:2.8}]},{id:"porch",name:"OUT THE DOOR",world:"porch",sector:"THE PORCH & FRONT GARDEN — NIGHT",briefing:"Coming soon.",comingSoon:!0},{id:"street",name:"THE STREET",world:"street",sector:"SIDEWALK & GUTTER — NIGHT",briefing:"Coming soon.",comingSoon:!0},{id:"storm-drain",name:"THE STORM DRAIN",world:"drain",sector:"UNDER THE STREET — DARK",briefing:"Coming soon.",comingSoon:!0},{id:"backyard",name:"THE BACKYARD WAR",world:"backyard",sector:"THE NEIGHBOR'S YARD — DAWN",briefing:"Coming soon.",comingSoon:!0},{id:"toy-store",name:"THE TOY STORE",world:"store",sector:"AISLE 7 — HOME",briefing:"Coming soon.",comingSoon:!0}];for(const i of rn){if(i.scatter)for(const t of i.scatter)t.x*=we,t.z*=we;if(i.enemyLayout)for(const t of i.enemyLayout)t.x*=we,t.z*=we,t.patrol&&(t.patrol.x*=we,t.patrol.z*=we);if(i.reserve)for(const t of i.reserve)t.x*=we,t.z*=we;if(i.stages){for(const t of i.stages)if(t.parts)for(const e of t.parts){if(e.items)for(const n of e.items)n.x*=we,n.z*=we;e.at&&(e.at.x*=we,e.at.z*=we)}}}function H0(i){return rn.find(t=>t.id===i)||null}const G0=3,V0=1.8,W0=2.4,X0=2.2,Yc=1.5,q0=.5,Y0=20;class K0{constructor(t,e,n){this.def=t,this.scene=e,this.world=n,this.state="active",this.stageIdx=0,this.timeAcc=0,this.t=0,this.startKills=0,this.rescueT=new Map,this.smashT=0,this.squad=null,this.onToast=null}begin(t,e){if(this.squad=e,this.startKills=t.kills,this.def.enemyLayout&&t.spawnLayout(this.def.enemyLayout),t.radio=this.world.radio||null,t.lamp=this.world.lamp||null,t.reserveLayout=this.def.reserve||null,this.def.scatter)for(const n of this.def.scatter){const s=e.members[n.member];s.position.set(n.x,0,n.z),s.alive=!1,s.downed=!0,s.crashDowned=!0,s.health=0,s.figure.position.copy(s.position),s.figure.position.y=.3,s.figure.rotation.z=Math.PI/2}this.stage()&&this.onToast&&this.onToast(this.stage().toast||"")}stage(){return this.def.stages[this.stageIdx]}killCount(t){return t.kills-this.startKills}_advance(){this.stageIdx++,ye.objective(),this.stageIdx>=this.def.stages.length?this.state="won":this.onToast&&this.onToast(this.stage().toast||"")}update(t,e,n,s){if(this.state!=="active")return;this.t+=t,this._animateProps();const r=this.stage();if(r.type==="regroup")this._regroup(t,e)&&this._advance();else if(r.type==="multi"){let a=!0;for(const o of r.parts)o.type==="collect"&&!this._collect(e)&&(a=!1),o.type==="destroy"&&!this._destroy(t,e,s)&&(a=!1);a&&this._advance()}else r.type==="escape"&&this._escape(t,r,e,n);e.alive||(this.state="lost")}_regroup(t,e){let n=0;for(const s of e.members){if(!s.crashDowned)continue;n++;let r=!1;for(const o of e.members)if(o.alive&&o.position.distanceTo(s.position)<G0){r=!0;break}const a=this.rescueT.get(s)||0;r?(this.rescueT.set(s,a+t),a+t>=V0&&(s.revive(.6),ye.pickup(),Sn.say(s.figure,cs(["On my feet — thanks!","Ow. Where are they?","Back in it!"]),"#7dff7d"),n--)):a>0&&this.rescueT.set(s,Math.max(0,a-t*2))}return n===0}_collect(t){let e=!0;for(const n of this.world.supplies){if(n.taken)continue;let s=!1;for(const r of t.members)if(r.alive&&Math.hypot(r.position.x-n.x,r.position.z-n.z)<W0){s=!0;break}s?(n.taken=!0,n.crate.visible=!1,n.ring.visible=!1,t.resupply(q0,Y0),ye.pickup()):e=!1}return e}_destroy(t,e,n){const s=this.world.radio;if(!s||!s.alive)return!0;for(let a=n.active.length-1;a>=0;a--){const o=n.active[a];if(o.team!=="player")continue;const c=o.mesh.position.x-s.pos.x,l=o.mesh.position.y-.7,h=o.mesh.position.z-s.pos.z;c*c+l*l+h*h<1.2*1.2&&(s.hp-=o.damage,n.burst(o.mesh.position),n.retireBullet(o))}let r=!1;for(const a of e.members)if(a.alive&&Math.hypot(a.position.x-s.pos.x,a.position.z-s.pos.z)<X0){r=!0;break}return this.smashT=r?this.smashT+t:Math.max(0,this.smashT-t*2),s.hp<=0||this.smashT>=Yc?(s.alive=!1,s.lamp.visible=!1,s.group.rotation.z=1.1,s.group.position.y=.35,ye.kill(),!0):!1}_escape(t,e,n,s){const r=this.world.exit;let a=!1,o=!1;for(const c of n.members)c.alive&&Math.hypot(c.position.x-r.x,c.position.z-r.z)<r.r&&(a=!0);for(const c of s.list)if(Math.hypot(c.pos.x-r.x,c.pos.z-r.z)<r.r+9){o=!0;break}this.timeAcc=a&&!o?this.timeAcc+t:Math.max(0,this.timeAcc-t*.6),this.timeAcc>=e.holdSeconds&&(this.state="won")}_animateProps(){this.world.supplies&&this.world.supplies.forEach((e,n)=>{e.taken||(e.crate.position.y=.8+Math.sin(this.t*2.5+n*2)*.18,e.crate.rotation.y=this.t*.6+n,e.ring.material.opacity=.22+.14*Math.sin(this.t*3+n))});const t=this.world.radio;t&&t.alive&&(t.lamp.visible=Math.sin(this.t*6)>-.2)}statusText(t){const e=this.stage();if(!e)return"";const n=t.firstSpotted?"":"   ·   UNDETECTED";if(e.type==="regroup"){const s=this.def.scatter.length,r=this.squad?this.squad.members.filter(a=>a.crashDowned).length:s;return`FIND YOUR SQUAD   ${s-r} / ${s}${n}`}if(e.type==="multi"){const s=[];for(const r of e.parts)if(r.type==="collect"){const a=this.world.supplies.filter(o=>o.taken).length;s.push(`SUPPLIES ${a} / ${this.world.supplies.length}`)}else r.type==="destroy"&&(this.world.radio.alive?this.smashT>.15?s.push(`CUTTING THE ALARM ${Math.min(100,Math.round(this.smashT/Yc*100))}%`):s.push("CUT THE ALARM"):s.push("ALARM CUT ✓"));return s.join("   ·   ")+n}return e.type==="escape"?this.timeAcc>.05?`BREACHING THE FRONT DOOR   ${this.timeAcc.toFixed(1)} / ${e.holdSeconds}s`:`ESCAPE — reach the front door   (tan: ${t.list.length})`:""}}const We=new dg({antialias:!0});We.setSize(window.innerWidth,window.innerHeight);We.setPixelRatio(Math.min(window.devicePixelRatio,2));We.shadowMap.enabled=!0;We.shadowMap.type=rl;We.toneMapping=ol;We.toneMappingExposure=1.45;We.outputColorSpace=He;document.body.appendChild(We.domElement);const _e=new Fe(70,window.innerWidth/window.innerHeight,.1,500),to=7,Kc=2.2,Zl=new URLSearchParams(location.search).has("smoke"),$c=Zl?"mission:"+rn[0].id:localStorage.getItem("ts_screen")||"menu";let Ni=$c.startsWith("mission:")?H0($c.slice(8)):null;Ni&&Ni.comingSoon&&(Ni=null);const $0=Ni||rn[0],Ze=Fg($0.world),{scene:an,obstacles:Xi,coverPoints:Z0,exitGlow:J0,nav:Jl,bounds:ur}=Ze,jt=new Wg(We.domElement),Tt=new i0(an,Xi,Jl,ur),Je=new f0(an,Xi,ur),fe=new P0(an,Xi,Z0,Jl,ur),fr=new F0(an,Xi,ur);B0(Tt);Je.onFire=(i,t)=>{const e=i.distanceTo(Tt.active.position);ye.gunshot(t==="player"?Math.min(e,4):e),fe.hearGunshot(i)};let ni=0;fr.onBoom=i=>{ye.boom(i.distanceTo(Tt.active.position)),ni=Math.min(1,ni+Math.max(.2,1.1-i.distanceTo(Tt.active.position)/45))};window.game={scene:an,camera:_e,squad:Tt,bullets:Je,enemies:fe,grenades:fr,input:jt,world:Ze};let Hn="menu",Un=null,zn=null;const Ht=i=>document.getElementById(i),jl=Ht("menu"),Ql=Ht("start"),th=Ht("win"),eh=Ht("gameover"),bo=Ht("objective"),eo=Ht("crosshair"),js=Ht("vignette"),aa=Ht("ability"),j0=Ht("scope"),oa=Ht("dmgdir"),es=Ht("takedown"),Gs=Ht("peek"),Ai=Ht("ammoTop"),ca=Ht("healthfill"),Zc=Ht("firemode"),ls=Ht("portraitCv"),la=Ht("weaponCv"),Q0=Ht("portraitName");function t_(i){const t=ls.getContext("2d"),e=ls.width,n=ls.height;t.clearRect(0,0,e,n);const s="#2f9e35",r="#1d6b24";t.fillStyle=s,t.beginPath(),t.moveTo(8,n),t.lineTo(16,56),t.lineTo(e-16,56),t.lineTo(e-8,n),t.closePath(),t.fill(),t.fillStyle=s,t.beginPath(),t.arc(e/2,42,17,0,Math.PI*2),t.fill(),t.fillStyle=r,t.beginPath(),t.arc(e/2,36,21,Math.PI,0),t.fill(),t.fillRect(e/2-23,34,46,5),t.fillStyle="rgba(10,25,10,0.9)",t.fillRect(e/2-9,44,5,3),t.fillRect(e/2+4,44,5,3),t.strokeStyle="#"+i.ringColor.toString(16).padStart(6,"0"),t.lineWidth=3,t.beginPath(),t.arc(e/2,46,19,.35,Math.PI-.35),t.stroke()}function e_(i){const t=la.getContext("2d"),e=la.width,n=la.height,s=16;t.clearRect(0,0,e,n),t.fillStyle="#dff5dc";const r=34+i.rifleLength*38,a=i.key==="heavy"?7:4;t.beginPath(),t.moveTo(6,s-5),t.lineTo(22,s-4),t.lineTo(22,s+6),t.lineTo(6,s+9),t.closePath(),t.fill(),t.fillRect(22,s-6,34,12),t.fillRect(56,s-a/2,r,a),t.fillRect(30,s+6,8,10),t.fillRect(24,s-9,4,4),i.key==="sniper"&&(t.beginPath(),t.arc(44,s-11,5,0,Math.PI*2),t.fill(),t.fillRect(38,s-12,12,3))}let Jc=null;function n_(){const i=Tt.active;i.cls.key!==Jc&&(Jc=i.cls.key,t_(i.cls),e_(i.cls),Q0.textContent=i.cls.name,ls.style.setProperty("--pring","#"+i.cls.ringColor.toString(16).padStart(6,"0")),ls.style.borderColor="#"+i.cls.ringColor.toString(16).padStart(6,"0"));const t=Math.max(0,i.health/i.maxHealth*100);ca.style.width=t+"%",ca.classList.toggle("warn",t<=50&&t>25),ca.classList.toggle("crit",t<=25)}const nh=()=>parseInt(localStorage.getItem("ts_unlocked")||"1",10),dr=i=>localStorage.setItem("ts_screen",i);function Ao(){for(const i of[jl,Ql,th,eh])i.classList.add("hidden")}function ps(){Hn="menu",dr("menu"),document.pointerLockElement&&document.exitPointerLock(),Ao(),bo.classList.add("hidden"),i_(),jl.classList.remove("hidden")}function i_(){const i=nh(),t=Ht("missionList");t.innerHTML="",rn.forEach((e,n)=>{const s=n>=i||e.comingSoon,r=document.createElement("div");r.className="mission"+(s?" locked":""),r.innerHTML=`<div><div class="m-name">${n+1}. ${e.name}</div><div class="m-sector">${e.sector}</div></div><div class="m-tag">${s?"LOCKED":"▶ DEPLOY"}</div>`,s||r.addEventListener("click",()=>{dr("mission:"+e.id),location.reload()}),t.appendChild(r)})}function s_(i){Hn="brief",zn=i,Ao(),Ht("briefName").textContent=i.name,Ht("briefSector").textContent=i.sector,Ht("briefText").textContent=i.briefing,Ql.classList.remove("hidden")}function r_(){if(Hn!=="brief")return;Ao(),ye.resume();const i=Ht("titlecard");i&&(Ht("cardCampaign").textContent="THE LONG WAY HOME",Ht("cardMission").textContent=`Mission ${rn.findIndex(t=>t.id===zn.id)+1} — ${zn.name}`,i.classList.remove("hidden"),i.classList.remove("fade"),setTimeout(()=>i.classList.add("fade"),3200),setTimeout(()=>i.classList.add("hidden"),4600)),Un=new K0(zn,an,Ze),Un.onToast=a_,Un.begin(fe,Tt),window.game.mission=Un,window.game.world=Ze,bo.classList.remove("hidden"),Hn="playing",jt.requestLock()}let jc=null;function a_(i){const t=Ht("toast");!t||!i||(t.textContent=i,t.classList.add("show"),clearTimeout(jc),jc=setTimeout(()=>t.classList.remove("show"),3800))}function o_(){Hn="won",ye.sting(!0),document.pointerLockElement&&document.exitPointerLock();const i=rn.findIndex(e=>e.id===zn.id),t=i>=rn.length-1;localStorage.setItem("ts_unlocked",Math.max(nh(),Math.min(i+2,rn.length))),Ht("winText").textContent=t?"CAMPAIGN COMPLETE — HOME AT LAST":zn.winText||"OBJECTIVE COMPLETE",Ht("nextBtn").classList.toggle("hidden",t),th.classList.remove("hidden")}function c_(){Hn="lost",ye.sting(!1),document.pointerLockElement&&document.exitPointerLock(),eh.classList.remove("hidden")}Ht("deployBtn").addEventListener("click",r_);Ht("briefMenuBtn").addEventListener("click",ps);Ht("winMenuBtn").addEventListener("click",ps);Ht("loseMenuBtn").addEventListener("click",ps);Ht("retryBtn").addEventListener("click",()=>{dr("mission:"+zn.id),location.reload()});Ht("nextBtn").addEventListener("click",()=>{const i=rn.findIndex(e=>e.id===zn.id),t=rn[i+1];t?(dr("mission:"+t.id),location.reload()):ps()});We.domElement.addEventListener("click",()=>{Hn==="playing"&&!jt.locked&&jt.requestLock()});(function(){Ni?s_(Ni):ps(),Zl&&fh(()=>import("./smoke-CFKaZijy.js"),[],import.meta.url).then(t=>t.runSmoke())})();const Qc=new Ng,l_=new at(0,0),h_=new Ln(new R(0,1,0),0),wi=new R;function u_(){Qc.setFromCamera(l_,_e);const i=Qc.ray;let t=null,e=1/0;for(const n of fe.list){const s=n.pos.x,r=(n.baseY||0)+1.1,a=n.pos.z,o=s-i.origin.x,c=r-i.origin.y,l=a-i.origin.z,h=o*i.direction.x+c*i.direction.y+l*i.direction.z;if(h<0||h>e)continue;const u=i.origin.x+i.direction.x*h,f=i.origin.y+i.direction.y*h,p=i.origin.z+i.direction.z*h;Math.hypot(u-s,f-r,p-a)<1.3&&(t=n,e=h)}return t?(wi.set(t.pos.x,1.1,t.pos.z),{enemy:t,point:wi}):i.intersectPlane(h_,wi)?{enemy:null,point:wi}:(i.at(80,wi),{enemy:null,point:wi})}let Vs=70,nn=!1,ha=0,tl=0,el=new R;const f_=new Ug,Qs=new rs(16767392,0,14);an.add(Qs);function ih(){requestAnimationFrame(ih),sh(Math.min(f_.getDelta(),.05))}function sh(i){if(Hn==="playing"&&(jt.locked||jt.debugLock)&&Tt.alive){jt.consume("Digit1")&&Tt.setActive(0),jt.consume("Digit2")&&Tt.setActive(1),jt.consume("Digit3")&&Tt.setActive(2),jt.consume("Digit4")&&Tt.setActive(3),jt.consume("Tab")&&Tt.cycle();const t=u_();eo.classList.toggle("enemy",!!t.enemy),jt.consume("KeyQ")&&(t.enemy?(Tt.orderAttack(t.enemy),is("Engaging!")):(Tt.orderMove(t.point.clone()),is("Moving!"))),jt.consume("KeyF")&&(Tt.orderFollow(),is("On you!")),jt.consume("KeyH")&&(Tt.orderHold(),is("Holding!")),jt.consume("KeyX")&&(Tt.fireMode=Tt.fireMode==="free"?"hold":"free",is(Tt.fireMode==="hold"?"Hold fire!":"Weapons free!"),Zc.textContent="SQUAD ▸ "+(Tt.fireMode==="hold"?"HOLD FIRE":"WEAPONS FREE"),Zc.classList.toggle("hold",Tt.fireMode==="hold")),jt.consume("KeyC")&&Tt.active.toggleCover(),jt.consume("KeyM")&&(nn=!nn),jt.consume("KeyR")&&Tt.active.startReload(),jt.consume("KeyZ")&&(jt.aiming=!jt.aiming),__(t),g_(i),Tt.update(i,{input:jt,enemies:fe.list,bullets:Je,free:fe.combatStarted}),jt.firing&&!nn&&Tt.active.tryFireAt(t.point,Je)&&(Qs.position.copy(Tt.active.muzzleWorldPosition()),Qs.intensity=26,Tt.active.pitch+=.012),Qs.intensity*=Math.pow(1e-4,i),fr.update(i,fe),Je.update(i),Sn.update(i),d_(),fe.update(i,Tt,Je),Tt.takeBulletHits(Je),rh(i),v_(i),k0(Tt,fe.kills),y_(),x_(),M_(),eo.classList.toggle("hit",fe.hitFlash>0),ha+=Tt.active.position.distanceTo(el),el.copy(Tt.active.position);const e=Tt.active.crouched?1.15:1.7;ha>e&&(ha=0,ye.footstep()),fe.kills>tl&&(ye.kill(),tl=fe.kills),J0.material.opacity=.25+.15*Math.sin(performance.now()*.004),js.classList.toggle("show",Tt.active.alive&&Tt.active.health<35),Un.update(i,Tt,fe,Je),bo.textContent=Un.statusText(fe),Un.state==="won"?o_():Un.state==="lost"&&c_()}jt.endFrame(),We.render(an,_e)}window.game.step=(i=1,t=1/60)=>{for(let e=0;e<i;e++)sh(t)};const nl=Xi.filter(i=>i.max.y>=3.5&&(i.max.x-i.min.x)*(i.max.z-i.min.z)>=5);let Jn=to,Ri=0,ns=1,Ws=1;function rh(i=0){if(an.fog&&Ze.fogCfg&&(an.fog.near=nn?9e3:Ze.fogCfg.near,an.fog.far=nn?1e4:Ze.fogCfg.far),nn){_e.position.set(Ze.map.x,Ze.map.height,.01),_e.lookAt(Ze.map.x,0,0);for(const S of fe.list){let E=S.alerted||S.aware>.05;if(!E){for(const P of Tt.members)if(P.alive&&P.position.distanceTo(S.pos)<52&&Li(P.position,S.pos,Xi)){E=!0;break}}S.fig.visible=E}return}for(const S of fe.list)S.fig.visible=!0;const t=Tt.active;Ri+=((t.aiming?1:0)-Ri)*Math.min(1,i*9);const e=to+(3.35-to)*Ri,n=-Math.cos(t.yaw),s=Math.sin(t.yaw),r=t.position.y+(Kc+(2.05-Kc)*Ri)*(t.crouched?.7:1),a=Math.cos(t.pitch),o=Math.sin(t.pitch),c=-Math.sin(t.yaw)*a,l=o,h=-Math.cos(t.yaw)*a,u=t.peeking&&t.coverBox&&t.coverBox.max.y>1.45?1.3:1,f=1.65*Ri*u;if(Ri>.25){const S=E=>{const P=t.position.x+n*f*E,b=t.position.z+s*f*E;let w=e;const U=P+c*e,Y=r+l*e,g=b+h*e;for(const y of nl){const O=Qa(P,r,b,U,Y,g,y);O<1/0&&(w=Math.min(w,O*e))}return w};S(-ns)>S(ns)*1.3+.4&&(ns=-ns)}Ws+=(ns-Ws)*Math.min(1,i*8);const p=t.position.x+n*f*Ws,_=t.position.z+s*f*Ws;let v=e;const m=p+c*e,d=r+l*e,T=_+h*e;for(const S of nl){const E=Qa(p,r,_,m,d,T,S);E<1/0&&(v=Math.min(v,E*e-.35))}v=Math.max(1.4,v),Jn=v<Jn?v:Jn+(v-Jn)*Math.min(1,i*5),_e.position.set(p+c*Jn,r+l*Jn,_+h*Jn),ni>.005&&(_e.position.x+=(Math.random()-.5)*ni*.7,_e.position.y+=(Math.random()-.5)*ni*.5,_e.position.z+=(Math.random()-.5)*ni*.7,ni*=Math.pow(.01,i)),_e.lookAt(p,r,_);for(const S of Tt.members){const E=S.figure.position,P=E.x-_e.position.x,b=E.y+1.4-_e.position.y,w=E.z-_e.position.z,U=Math.sqrt(P*P+b*b+w*w),Y=Math.max(0,Math.min(1,(U-1.4)/1.2));for(const g of S.figure.userData.fadeMats)g.transparent=Y<1,g.opacity=Y}}function is(i){for(let t=0;t<Tt.members.length;t++)if(!(t===Tt.activeIndex||!Tt.members[t].alive)){Sn.say(Tt.members[t].figure,i,"#9fe89f");return}}function d_(){const i=Ze.lamp;if(!(!i||!i.alive))for(const t of Je.active){if(t.team!=="player")continue;const e=t.mesh.position.x-i.pos.x,n=t.mesh.position.y-i.bulbY,s=t.mesh.position.z-i.pos.z;if(e*e+n*n+s*s<3.2*3.2){i.alive=!1,i.light.intensity=0,i.shade.material.emissiveIntensity=0,ye.glass(),Je.burst(t.mesh.position),Je.retireBullet(t);return}}}const p_=3;function m_(){const i=Tt.active;if(!i.alive)return null;let t=null,e=p_;for(const n of fe.list){if(n.alerted&&!n.searching||n.baseY>0)continue;const s=i.position.x-n.pos.x,r=i.position.z-n.pos.z,a=Math.hypot(s,r);if(a>=e)continue;const o=Math.sin(n.facing),c=Math.cos(n.facing);(o*s+c*r)/(a||1)>-.1||(t=n,e=a)}return t}let jn=0;function g_(i){const t=Tt.active;let e=null;for(const a of Tt.members)if(!(a===t||!a.downed)&&a.position.distanceTo(t.position)<2.8){e=a;break}if(e&&!nn){const a=t.cls.key==="medic";jt.isDown("KeyE")?(jn+=i*(a?2.1:1),es.textContent=`REVIVING… ${Math.min(99,Math.round(jn/2.5*100))}%`,jn>=2.5&&(e.revive(a?.65:.35),ye.pickup(),Sn.say(e.figure,cs(["Back in it!","Thanks — I owe you.","On my feet!"]),"#7dff7d"),jn=0)):(jn=Math.max(0,jn-i*2),es.textContent=`E  REVIVE ${e.cls.name}`),es.classList.add("show"),Gs.classList.remove("show");return}jn=0;const n=m_();n&&(es.textContent="E  SILENT TAKEDOWN"),es.classList.toggle("show",!!n&&!nn),n&&jt.consume("KeyE")&&(fe.takedown(n,Tt.active.position),ye.takedown());const s=!nn&&t.alive&&t.inCover&&!t.aiming&&!n,r=!nn&&t.alive&&!t.inCover&&t.coverNear&&!t.aiming&&!n;if(s){const a=t.coverBox&&t.coverBox.max.y>1.45;Gs.textContent=a?t.canLean?"Z  LEAN OUT":"A/D  SLIDE TO A CORNER":"Z  POP OUT"}else r&&(Gs.textContent="C  TAKE COVER");Gs.classList.toggle("show",s||r)}function __(i){const t=Tt.active;if(t.zoomed=!1,!t.alive)return;t.aiming=jt.aiming&&!nn;const e=t.cls.ability;e.key==="scope"&&(t.zoomed=t.aiming),e.key==="suppress"?(jt.consume("Space")&&(t.suppressing=!t.suppressing),t.suppressing&&fe.applySuppression(i.point,12,.7)):(t.suppressing=!1,jt.consume("Space")&&t.abilityCd<=0&&(e.key==="grenade"?(fr.throwAt(t.muzzleWorldPosition(),i.point),t.abilityCd=e.cooldown):e.key==="revive"&&Tt.reviveNear(t)&&(t.abilityCd=e.cooldown)))}function v_(i){const t=Tt.active,e=t.zoomed?28:t.aiming?52:t.sprinting?76:70;Vs+=(e-Vs)*Math.min(1,i*12),Math.abs(_e.fov-Vs)>.01&&(_e.fov=Vs,_e.updateProjectionMatrix()),j0.classList.toggle("show",t.zoomed),eo.classList.toggle("ads",t.aiming&&!t.zoomed)}function x_(){const i=Tt.active;i.reloading>0?(Ai.innerHTML='<span class="reserve">RELOADING…</span>',Ai.classList.add("reloading"),Ai.classList.remove("low")):(Ai.innerHTML=`${i.mag}<span class="reserve"> / ${i.reserve}</span>`,Ai.classList.remove("reloading"),Ai.classList.toggle("low",i.mag<=Math.ceil(i.cls.mag*.25))),n_()}let il=0;function M_(){const i=Tt.active,t=performance.now()-i.lastHitAt;if(t<700){const n=Math.atan2(i.lastHitFrom.x-i.position.x,i.lastHitFrom.z-i.position.z)-i.yaw;oa.style.transform=`translate(-50%, -50%) rotate(${(-n*180/Math.PI).toFixed(1)}deg)`,oa.style.opacity=(1-t/700)*.9,i.lastHitAt!==il&&(il=i.lastHitAt,js.classList.remove("pulse"),js.offsetWidth,js.classList.add("pulse"))}else oa.style.opacity=0}function y_(){const i=Tt.active,t=i.cls.ability;aa.textContent=(t.input==="aim"?"Z":"SPACE")+"  "+t.name;const e=t.key==="suppress"&&i.suppressing||t.key==="scope"&&i.zoomed;aa.classList.toggle("active",e),aa.classList.toggle("cooldown",t.input==="press"&&i.abilityCd>0)}rh();ih();window.addEventListener("resize",()=>{_e.aspect=window.innerWidth/window.innerHeight,_e.updateProjectionMatrix(),We.setSize(window.innerWidth,window.innerHeight)});
